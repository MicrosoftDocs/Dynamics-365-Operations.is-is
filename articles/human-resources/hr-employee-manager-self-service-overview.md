...
**Vinnuliðir sem mér eru úthlutaðir** birtir öll samþykki og verkflæði sem eru úthlutað til starfsmannsins. Þú getur skilgreint verkflæðisliði til að senda tölvupósta til notandans.

**Spurningalistar sem mér var úthlutað** birta alla áætlaða spurningalistar sem er úthlutað beint til starfsmanns eða hóps.

**Fyrirtækjaskrá** gerir starfsmönnum kleift að leita að upplýsingum sem tengjast einstaklingum í fyrirtækinu. Opinberar tengiliðaupplýsingar eru í boði fyrir alla starfsmenn. Fyrirtækjaskráin er takmörkuð við fyrirtækið sem starfsmaðurinn hefur skráð sig inn á.

**Dagatal hóps** sýnir dagatalsupplýsingar hópsins þíns. Fyrir frekari upplýsingar, sjá [Skoða dagatöl hópa og fyrirtækja](hr-employee-self-service-calendar.md).
...
- **Óska eftir endurúthlutun starfskrafts**
- **Óska eftir starfslokum**
- **Biðja um breytingu á launum**

Þú getur stillt þessa valkosti til að fara í gegnum valfrjálst verkflæði yfirferðar og samþykkis.

Kveikir á **Stöðuaðgerðir** virkjar eftirfarandi valkosti:

- **Óska eftir nýrri stöðu**
- **Biðja um breytingu á upplýsingum um stöðu**

Þú getur einnig stillt þessa valkosti til að fara í gegnum valfrjálst verkflæði yfirferðar og samþykkis.
...
- **Vottorð sem eru að renna út fyrir hóp notanda**
- **Auðkennisnúmer sem eru að renna út fyrir hóp notanda**
- **Reynslutími sem er að renna út fyrir hóp notanda**
- **Skoðanir sem eru að renna út fyrir hóp notanda**
- **Próf sem eru að renna út fyrir hóp notanda**
- **Opnar stöður fyrir beinar og/eða útbreiddar skýrslur**
- **Beiðnir um frí í bið vegna hóps míns**
- **Mat á hæfni teymis**
- **Hæfnigreining**
- **Frammistöðubækur hóps**
- **Frammistöðumarkmið hóps**
- **Endurskoðun á frammistöðu hóps**
- **Starfskraftar að hætta**

Þú getur stillt eftirfarandi valkosti fyrir stjórnendur til að gera breytingar eða bæta við leyfisbeiðnum fyrir hönd beinna skýrslna:

- Skírteini
- Námskeið
- Lánshlutir
- Hæfni
- Beiðnir um leyfi og fjarvistir
...
Þú getur annaðhvort gert breytingar eða skoðað, allt eftir stillingum fyrirtækisins.
...
Flipionn **Laun** sýnir árslaun starfsmanns. Auðkenni fyrirtækis birtist undir launafjárhæðinni. Ef starfsmaður hefur fleiri en eina ráðningu og fær greitt frá mörgum lögaðilum mun starfsmaðurinn hafa mörg bótakort. Síðasta hækkun upphæð og prósenta birtist, miðað við fyrirtækið sem unnið er hjá.

Til að skoða bótasögu skaltu velja launamagn til að opna gluggann **Upplýsingar**. Aðeins núverandi og sögulegar fastar og breytilegar jafningaskrár birtast í glugganum **Bætur**. Ef starfsmaður hefur fleiri en eina ráðningu geturðu skipt á milli fyrirtækja til að skoða bótasögu í hverju fyrirtæki.
...
Flipinn **Frammistöðumarkmið** dregur saman frammistöðumarkmið eftir stöðu. Veldu númer fyrir stöðu eða veldu frammistöðumarkmið úr **Upplýsingar** til að sjá öll markmið starfsmanns. Stjórnendur og starfsmenn geta uppfært markmið eftir þörfum yfir markmiðið.

Stjórnendur geta séð öll markmið fyrir lið sitt í gegnum reitinn **Frammistöðumarkmið hóps** í hlutann **Samantekt** í **Hópurinn minn**.
