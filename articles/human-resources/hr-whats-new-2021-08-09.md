---
title: Hvað er nýtt eða breytt í Dynamics 365 Human Resources 9. ágúst 2021.
description: Þessi grein lýsir eiginleikum sem eru annað hvort nýir eða breyttir í Microsoft Dynamics 365 Human Resources fyrir 9. ágúst 2021.
author: marcelbf
ms.date: 08/09/2021
ms.topic: article
ms.prod: ''
...
Þessi útgáfa felur í sér eftirfarandi nýja eiginleika og villuleiðréttingar. Breytingar eiga við um byggingarnúmer 8.1.4393.
...
| --- | --- | --- |
| 558385 | Sjálfgefinn fulltrúi er ekki valinn þegar kveikt er á valkostinum **Sjálfvirkt val á fulltrúum** fyrir sjálfgefna fulltrúa. | Nú er búið að laga þetta vandamál. Margir sjálfgefnir fulltrúar eru sjálfkrafa valdir í gjaldgengum áætlunum þegar kveikt er á valkostinum **Sjálfvirkt val á fulltrúum** á síðunni **Samnýttar færibreytur fyrir mannauð**. |
| 589617 | Á síðunni **Frí** eru stöðurnar **Hægt að kaupa** og **Hægt að selja** auðar þegar aðgangur einskorðast við ákveðið fyrirtæki. | Nú er búið að laga þetta vandamál. Síðan **Frí** sýnir réttu stöðurnar **Hægt að kaupa** og **Hægt að selja** þegar notandi er takmarkaður við ákveðið fyrirtæki. |
