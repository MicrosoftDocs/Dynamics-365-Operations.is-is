...
Fyrir frekari upplýsingar, sjá [Uppfærslur á vettvangi fyrir útgáfu 10.0.12 af fjármála- og rekstraröppum (ágúst 2020)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-10-0-12.md).
