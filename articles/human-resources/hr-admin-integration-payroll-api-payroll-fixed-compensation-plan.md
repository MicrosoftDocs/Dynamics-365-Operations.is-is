...
description: Þessi grein veitir upplýsingar og dæmi um fyrirspurn fyrir eininguna Launagreiðsluáætlun í Dynamics 365 Human Resources.
author: jcart
ms.date: 08/25/2021
ms.topic: article
ms.prod: ''
...
Þessi grein lýsir launaskrá föstum bótaáætlun fyrir Dynamics 365 Human Resources.
...
| **Greiðslutíðni**</br>mshr_payfrequency</br>*Strengur* | Lesa eingöngu | Auðkenni fyrir [greiðslutíðni launa](hr-admin-integration-payroll-api-compensation-pay-frequency.md) fyrir tiltekinn launataxta. |
