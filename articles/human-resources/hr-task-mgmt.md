...
>
> Þessar stillingar eiga einnig við um **Starfsmannastjórnun** vinnurými.
...
| Úthlutað á     | Veldu tiltekinn starfsmann, stöðu eða hóp af stöðum til að úthluta verkefninu til. |
...
Verkefni má merkja sem **Í vinnslu**, **við**, eða **Lokið**. Ef verkefni var úthlutað hópi verður það merkt sem **Lokið** þegar einn í hópnum klárar það.
