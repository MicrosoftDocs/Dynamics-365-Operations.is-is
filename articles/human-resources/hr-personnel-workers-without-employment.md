...
- Mannauðsstjóri
- Ráðningaraðili
- Launa- og fríðindastjóri
- Yfirmaður launamála
- Launastjóri
- Þjálfunarstjóri

Í listanum **Starfsmenn án atvinnu** er hægt að eyða þeim einstaklingum sem eru taldir upp. Aðstoðarmanneskja mannauðsstjóra fær þessi réttindi sjálfkrafa í hendurnar. Þú getur veitt öðrum hlutverkum þessi réttindi með eftirfarandi skrefum:

1. Veljið **Kerfisstjórnun** og veljið svo **Öryggisstillingar**.
...
4. Í **Birta valmyndaratriði** skal velja **HcmWorkersWithoutEmployment**.
   ...
   [![Valeyðublað](./media/hr-personnel-workers-without-employment-select.png)](./media/hr-personnel-workers-without-employment-select.png)
