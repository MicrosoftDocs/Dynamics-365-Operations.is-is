...
description: Þessi grein lýsir fjöldaráðningarverkefnum, sem gera mannauðssérfræðingum kleift að búa til margar stöður og ráða starfsmenn á skilvirkan hátt í þær stöður.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
