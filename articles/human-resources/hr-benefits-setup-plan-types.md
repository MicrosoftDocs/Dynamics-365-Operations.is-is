...
3. Tilgreina gildi fyrir eftirfarandi reiti:
   ...
   | Kóði verksmiðjugerðar | Veljið áætlunargerðarkóða úr í fellilistagildunum. Númeralisti áætlunartegundarinnar sýnir allar áætlunartegundir sem eru studdar í núverandi útgáfu. |
   ...
   | Gerð tengiliðar | Tilgreinir hlutverk persónulegs tengiliðar. Gildin eru auð, háð og rétthafi. Þú getur látið tengiliðategundina vera auðan ef áætlunartegund þeirra þarfnast ekki háðs eða rétthafa miðað við tryggingarvalkostinn. |
...
4. Veldu til að stilla valkosti fyrir lífatburði **Aðgerðir** og veldu síðan **Valkostir fyrir viðburði**. Tilgreina gildi fyrir eftirfarandi reiti:
   ...
   | Kenni gerðar viðburðar | Auðkenni tegundar atburðar í lífinu. |
