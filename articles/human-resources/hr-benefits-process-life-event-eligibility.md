...
2. Í valmyndinni **Keyra viðburðahæfi**, tilgreindu gildi fyrir eftirfarandi reiti:

   | Svæði | Lýsing |
   | --- | --- |
   | **Skráningartímabil** | Innritunartímabilið til að vinna úr viðburðahæfi fyrir. |
