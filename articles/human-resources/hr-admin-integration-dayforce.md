...
- <span data-ttu-id="6cc4d-111">Mannauðsgögn</span><span class="sxs-lookup"><span data-stu-id="6cc4d-111">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="6cc4d-141">Skilgreina gögnin þín</span><span class="sxs-lookup"><span data-stu-id="6cc4d-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="6cc4d-158">Fríðindi</span><span class="sxs-lookup"><span data-stu-id="6cc4d-158">Benefits</span></span>
...
<span data-ttu-id="6cc4d-187">Frekari upplýsingar um hvernig á að skilgreina og stjórna fríðindaáætlun er að finna í eftirfarandi greinum:</span><span class="sxs-lookup"><span data-stu-id="6cc4d-187">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- <span data-ttu-id="6cc4d-228">Úthlutun starfsmanns - Starfsmaður, upphaf úthlutunar, endir úthlutunar, ástæðukóði</span><span class="sxs-lookup"><span data-stu-id="6cc4d-228">Worker assignment – Worker, assignment start, assignment end, reason code</span></span>
...
<span data-ttu-id="6cc4d-258">Tekjukóðar auðkenna með einkvæmum hætti allar gerðir af tekjum sem starfsmaður fær.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-258">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="6cc4d-259">Kóðarnir eru með ýmsar færibreytur sem tengjast tekjum, svo sem bókhaldsreglum, skattalögum, skýrslukröfum og hækkunargetu.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-259">The codes have various parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span>
...
<span data-ttu-id="6cc4d-273">Þegar starfsmannaupplýsingar eru færðar inn skal hafa í huga eftirfarandi gögn og skilgreiningar sem eru notaðar í Dayforce.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-273">When you enter worker information, keep in mind the following data and configurations that are used in Dayforce.</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="6cc4d-296">Samskiptaupplýsingar</span><span class="sxs-lookup"><span data-stu-id="6cc4d-296">Contact information</span></span> 
...
- <span data-ttu-id="6cc4d-344">Gildisdagsetning (krafist)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-344">Effective Date (required)</span></span>
...
- <span data-ttu-id="6cc4d-388">Sýsla (krafist)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-388">County (required)</span></span>
...
| <span data-ttu-id="6cc4d-402">Starfsgerð</span><span class="sxs-lookup"><span data-stu-id="6cc4d-402">Job type</span></span>   | <span data-ttu-id="6cc4d-403">lýsing</span><span class="sxs-lookup"><span data-stu-id="6cc4d-403">Description</span></span> |
|------------|-------------|
...
| <span data-ttu-id="6cc4d-437">DAUÐI</span><span class="sxs-lookup"><span data-stu-id="6cc4d-437">DEATH</span></span>          | <span data-ttu-id="6cc4d-438">Dauði</span><span class="sxs-lookup"><span data-stu-id="6cc4d-438">Death</span></span>            | <span data-ttu-id="6cc4d-439">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-439">Terminate worker</span></span>     |
...
|--------------|-----------------|
| <span data-ttu-id="6cc4d-473">Karl</span><span class="sxs-lookup"><span data-stu-id="6cc4d-473">Male</span></span>         | <span data-ttu-id="6cc4d-474">Karl</span><span class="sxs-lookup"><span data-stu-id="6cc4d-474">Male</span></span>            |
...
- <span data-ttu-id="6cc4d-493">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-493">4OFMTH</span></span>
- <span data-ttu-id="6cc4d-494">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-494">5OFMTH</span></span>
- <span data-ttu-id="6cc4d-495">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-495">1N2OFMTH</span></span>
- <span data-ttu-id="6cc4d-496">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-496">3N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-497">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-497">1N3OFMTH</span></span>
- <span data-ttu-id="6cc4d-498">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-498">1N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-499">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-499">2N3OFMTH</span></span>
- <span data-ttu-id="6cc4d-500">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-500">2N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-501">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-501">1N2N3OFMTH</span></span>
- <span data-ttu-id="6cc4d-502">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-502">1N2N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-503">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-503">1N3N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-504">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-504">2N3N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-505">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-505">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-506">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="6cc4d-506">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="6cc4d-507">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-507">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="6cc4d-508">LASTOFQTR - LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-508">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="6cc4d-509">LASTMTHOFQTR - LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-509">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="6cc4d-510">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-510">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="6cc4d-511">LASTOFYEAR - LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-511">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="6cc4d-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="6cc4d-513">Aðsetur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-513">Addresses</span></span>

<span data-ttu-id="6cc4d-514">Að bera kennsl á kóða tiltekins lands eða svæðis, ríkis og fylkis (sveitarfélags) krefst sérstakra sniða sem Dayforce og innlendir veitendur/svæðisveitendur geta borið kennsl á.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-514">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="6cc4d-515">Þótt snið fyrir borgir sé sveigjanlegt, verður hver borg að vera tengd ríki.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-515">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="6cc4d-516">Mannauður</span><span class="sxs-lookup"><span data-stu-id="6cc4d-516">Human Resources</span></span>          | <span data-ttu-id="6cc4d-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="6cc4d-517">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="6cc4d-518">Land/svæði</span><span class="sxs-lookup"><span data-stu-id="6cc4d-518">Country/Region</span></span>  | <span data-ttu-id="6cc4d-519">Landsnúmer</span><span class="sxs-lookup"><span data-stu-id="6cc4d-519">Country Code</span></span>          |
| <span data-ttu-id="6cc4d-520">Póstnúmer</span><span class="sxs-lookup"><span data-stu-id="6cc4d-520">Zip/Postal Code</span></span> | <span data-ttu-id="6cc4d-521">Póstnúmer</span><span class="sxs-lookup"><span data-stu-id="6cc4d-521">Postal Code</span></span>           |
| <span data-ttu-id="6cc4d-522">Ríki</span><span class="sxs-lookup"><span data-stu-id="6cc4d-522">State</span></span>           | <span data-ttu-id="6cc4d-523">Ríkiskóði</span><span class="sxs-lookup"><span data-stu-id="6cc4d-523">State Code</span></span>            |
| <span data-ttu-id="6cc4d-524">Póststöð</span><span class="sxs-lookup"><span data-stu-id="6cc4d-524">City</span></span>            | <span data-ttu-id="6cc4d-525">Póststöð</span><span class="sxs-lookup"><span data-stu-id="6cc4d-525">City</span></span>                  |
| <span data-ttu-id="6cc4d-526">Sýsla</span><span class="sxs-lookup"><span data-stu-id="6cc4d-526">County</span></span>          | <span data-ttu-id="6cc4d-527">Sýsla (sveitarfélag)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-527">County (Municipality)</span></span> |
| <span data-ttu-id="6cc4d-528">Gata</span><span class="sxs-lookup"><span data-stu-id="6cc4d-528">Street</span></span>          | <span data-ttu-id="6cc4d-529">Heimilisfang, lína 1</span><span class="sxs-lookup"><span data-stu-id="6cc4d-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="6cc4d-530">Skattumdæmi</span><span class="sxs-lookup"><span data-stu-id="6cc4d-530">Tax regions</span></span>

<span data-ttu-id="6cc4d-531">Skattumdæmi eru notuð til að ákvarða viðeigandi skatt sem á að beita við myndun launagreiðslna.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="6cc4d-532">Skattasvæðum er varpað í Dayforce sem staðsetningaraðsetrum.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="6cc4d-533">Sjálfgefið skattumdæmi verður að vera tengt við virka stöðu starfsmannsins.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="6cc4d-534">Skattumdæmi (krafist)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-534">Tax region (required)</span></span>
- <span data-ttu-id="6cc4d-535">Land/svæði (krafist)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-535">Country/Region (required)</span></span>
- <span data-ttu-id="6cc4d-536">Ríki (krafist)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-536">State (required)</span></span>
- <span data-ttu-id="6cc4d-537">Sýsla</span><span class="sxs-lookup"><span data-stu-id="6cc4d-537">County</span></span> 
- <span data-ttu-id="6cc4d-538">Borg (krafist)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="6cc4d-539">Skilgreindu gögnin þín til að búa til launaskrá fyrir Mexíkó</span><span class="sxs-lookup"><span data-stu-id="6cc4d-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="6cc4d-540">Ef þú ert að búa til laun fyrir starfsmenn í Mexíkó, þarf að skilgreina eftirfarandi þætti:</span><span class="sxs-lookup"><span data-stu-id="6cc4d-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="6cc4d-541">Deildir eru nauðsynlegar fyrir stöður.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-541">Departments are required on positions.</span></span>
- <span data-ttu-id="6cc4d-542">Kostnaðarstaðir verða að vera stilltir sem fjárhagsvíddir og verða að vera fyrsti þátturinn í sjálfgefnum fjárhagsvíddarstreng.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="6cc4d-543">Vinnslugerðir</span><span class="sxs-lookup"><span data-stu-id="6cc4d-543">Job types</span></span>

<span data-ttu-id="6cc4d-544">Starfsgerðir eru notaðar til að flokka svipuð störf í flokka.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="6cc4d-545">Starfsgerðir eru nauðsynlegar til að vinna úr launaskrá í Mexíkó.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="6cc4d-546">Dæmi um starfsgerðir eru fullt starf og hlutastarf, eða föst laun og tímakaup.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="6cc4d-547">Starfsgerðum er varpað í Dayforce sem launagerðum sem gefa til kynna hvort starfsmaður sé á tímakaupi eða föstum launum.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="6cc4d-548">Eftirfarandi starfsgerðir og lýsingar eru nauðsynlegar.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="6cc4d-549">Starfsgerð</span><span class="sxs-lookup"><span data-stu-id="6cc4d-549">Job type</span></span>   | <span data-ttu-id="6cc4d-550">lýsing</span><span class="sxs-lookup"><span data-stu-id="6cc4d-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="6cc4d-551">Tímar</span><span class="sxs-lookup"><span data-stu-id="6cc4d-551">Hourly</span></span>     | <span data-ttu-id="6cc4d-552">MX tímakaup</span><span class="sxs-lookup"><span data-stu-id="6cc4d-552">MX Hourly</span></span>   |
| <span data-ttu-id="6cc4d-553">Föst laun</span><span class="sxs-lookup"><span data-stu-id="6cc4d-553">Salaried</span></span>   | <span data-ttu-id="6cc4d-554">MX föst laun</span><span class="sxs-lookup"><span data-stu-id="6cc4d-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="6cc4d-555">Stöðugerðir</span><span class="sxs-lookup"><span data-stu-id="6cc4d-555">Position types</span></span> 

<span data-ttu-id="6cc4d-556">Þú notar stöðugerðir til að lýsa því hvort staðan er fullt starf, hlutastarf eða eitthvað annað.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="6cc4d-557">Stöðugerðum er varpað í Dayforce sem launaflokkum sem gefa til kynna hvort starfsmaður sé í fullu starfi eða hlutastarfi.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="6cc4d-558">Eftirfarandi stöðugerðir og lýsingar eru nauðsynlegar.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="6cc4d-559">Gerð stöðu</span><span class="sxs-lookup"><span data-stu-id="6cc4d-559">Position type</span></span>   | <span data-ttu-id="6cc4d-560">lýsing</span><span class="sxs-lookup"><span data-stu-id="6cc4d-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="6cc4d-561">Fullt starf</span><span class="sxs-lookup"><span data-stu-id="6cc4d-561">Full-time</span></span>       | <span data-ttu-id="6cc4d-562">Starfsmaður í fullu starfi</span><span class="sxs-lookup"><span data-stu-id="6cc4d-562">Full time employee</span></span> |
| <span data-ttu-id="6cc4d-563">Hlutastarf</span><span class="sxs-lookup"><span data-stu-id="6cc4d-563">Part-time</span></span>       | <span data-ttu-id="6cc4d-564">Starfsmaður í hlutastarfi</span><span class="sxs-lookup"><span data-stu-id="6cc4d-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="6cc4d-565">Ástæðukóðar</span><span class="sxs-lookup"><span data-stu-id="6cc4d-565">Reason codes</span></span>

<span data-ttu-id="6cc4d-566">Ástæðukóðar veita upplýsingar um stöðu starfsmanns.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="6cc4d-567">Ástæðukóðum er varpað í Dayforce sem stöðuástæðum sem gefa til kynna ástæðuna fyrir breytingum á stöðu sem starfsmaður gegnir eða stöðu á starfsmanni.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="6cc4d-568">Eftirfarandi ástæðukóðar og lýsingar eru nauðsynlegar.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="6cc4d-569">Ástæðukóði</span><span class="sxs-lookup"><span data-stu-id="6cc4d-569">Reason code</span></span>            | <span data-ttu-id="6cc4d-570">lýsing</span><span class="sxs-lookup"><span data-stu-id="6cc4d-570">Description</span></span>                    | <span data-ttu-id="6cc4d-571">Tiltækar sviðsmyndir</span><span class="sxs-lookup"><span data-stu-id="6cc4d-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="6cc4d-572">BROTTFÖR Á UNDAN LAUNAGREIÐSLU</span><span class="sxs-lookup"><span data-stu-id="6cc4d-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="6cc4d-573">Brottför á undan launum</span><span class="sxs-lookup"><span data-stu-id="6cc4d-573">Departure before first payroll</span></span> | <span data-ttu-id="6cc4d-574">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-574">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-575">UPPSÖGN</span><span class="sxs-lookup"><span data-stu-id="6cc4d-575">RESIGNATION</span></span>            | <span data-ttu-id="6cc4d-576">Uppsögn</span><span class="sxs-lookup"><span data-stu-id="6cc4d-576">Resignation</span></span>                    | <span data-ttu-id="6cc4d-577">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-577">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-578">LÍFEYRIR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-578">PENSION</span></span>                | <span data-ttu-id="6cc4d-579">Lífeyrir</span><span class="sxs-lookup"><span data-stu-id="6cc4d-579">Pension</span></span>                        | <span data-ttu-id="6cc4d-580">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-580">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-581">STARFSLOK</span><span class="sxs-lookup"><span data-stu-id="6cc4d-581">TERMINATION</span></span>            | <span data-ttu-id="6cc4d-582">Lok</span><span class="sxs-lookup"><span data-stu-id="6cc4d-582">Termination</span></span>                    | <span data-ttu-id="6cc4d-583">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-583">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-584">STARFSLOK SÖKUM ALDURS</span><span class="sxs-lookup"><span data-stu-id="6cc4d-584">RETIREMENT</span></span>             | <span data-ttu-id="6cc4d-585">Starfslok</span><span class="sxs-lookup"><span data-stu-id="6cc4d-585">Retirement</span></span>                     | <span data-ttu-id="6cc4d-586">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-586">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-587">FJARVERA</span><span class="sxs-lookup"><span data-stu-id="6cc4d-587">ABSENTEE</span></span>               | <span data-ttu-id="6cc4d-588">Fjarvera</span><span class="sxs-lookup"><span data-stu-id="6cc4d-588">Absentee</span></span>                       | <span data-ttu-id="6cc4d-589">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-589">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-590">ANNAÐ</span><span class="sxs-lookup"><span data-stu-id="6cc4d-590">OTHER</span></span>                  | <span data-ttu-id="6cc4d-591">Aðrar ástæður</span><span class="sxs-lookup"><span data-stu-id="6cc4d-591">Other Reasons</span></span>                  | <span data-ttu-id="6cc4d-592">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-592">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-593">LOKUN</span><span class="sxs-lookup"><span data-stu-id="6cc4d-593">CLOSURE</span></span>                | <span data-ttu-id="6cc4d-594">Viðskiptalokun</span><span class="sxs-lookup"><span data-stu-id="6cc4d-594">Business Closure</span></span>               | <span data-ttu-id="6cc4d-595">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-595">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-596">DAUÐI</span><span class="sxs-lookup"><span data-stu-id="6cc4d-596">DEATH</span></span>                  | <span data-ttu-id="6cc4d-597">Dauði</span><span class="sxs-lookup"><span data-stu-id="6cc4d-597">Death</span></span>                          | <span data-ttu-id="6cc4d-598">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-598">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-599">FJARVISTARLEYFI</span><span class="sxs-lookup"><span data-stu-id="6cc4d-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="6cc4d-600">Fjarvistarleyfi</span><span class="sxs-lookup"><span data-stu-id="6cc4d-600">Leave of Absence</span></span>               | <span data-ttu-id="6cc4d-601">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-601">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-602">SAMNINGSLOK</span><span class="sxs-lookup"><span data-stu-id="6cc4d-602">CONTRACTEND</span></span>            | <span data-ttu-id="6cc4d-603">Lok á samningi</span><span class="sxs-lookup"><span data-stu-id="6cc4d-603">End of Contract</span></span>                | <span data-ttu-id="6cc4d-604">Segja starfskrafti upp</span><span class="sxs-lookup"><span data-stu-id="6cc4d-604">Terminate worker</span></span>     |
| <span data-ttu-id="6cc4d-605">LAUNABREYTINGAR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-605">SALARYCHANGE</span></span>           | <span data-ttu-id="6cc4d-606">Breyting launa</span><span class="sxs-lookup"><span data-stu-id="6cc4d-606">Change of Salary</span></span>               | <span data-ttu-id="6cc4d-607">Laun</span><span class="sxs-lookup"><span data-stu-id="6cc4d-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="6cc4d-608">Ráðningarskilmálar</span><span class="sxs-lookup"><span data-stu-id="6cc4d-608">Terms of employment</span></span>

<span data-ttu-id="6cc4d-609">Ráðningarskilmálar eru notaðir til að búa til flokka fyrir skilmála ráðningar.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="6cc4d-610">Skilmálunum er varpað í Dayforce sem gildum starfsmannavísis.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="6cc4d-611">Eftirfarandi ráðningarskilmálar og lýsingar eru nauðsynlegar.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="6cc4d-612">Ráðningarskilmálar</span><span class="sxs-lookup"><span data-stu-id="6cc4d-612">Terms of employment</span></span>   | <span data-ttu-id="6cc4d-613">lýsing</span><span class="sxs-lookup"><span data-stu-id="6cc4d-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="6cc4d-614">Venjuleg</span><span class="sxs-lookup"><span data-stu-id="6cc4d-614">Regular</span></span>               | <span data-ttu-id="6cc4d-615">Venjuleg</span><span class="sxs-lookup"><span data-stu-id="6cc4d-615">Regular</span></span>     |
| <span data-ttu-id="6cc4d-616">Beint</span><span class="sxs-lookup"><span data-stu-id="6cc4d-616">Direct</span></span>                | <span data-ttu-id="6cc4d-617">Beint</span><span class="sxs-lookup"><span data-stu-id="6cc4d-617">Direct</span></span>      |
| <span data-ttu-id="6cc4d-618">Starfsnám</span><span class="sxs-lookup"><span data-stu-id="6cc4d-618">Internship</span></span>            | <span data-ttu-id="6cc4d-619">Starfsnám</span><span class="sxs-lookup"><span data-stu-id="6cc4d-619">Internship</span></span>  |
| <span data-ttu-id="6cc4d-620">Fast</span><span class="sxs-lookup"><span data-stu-id="6cc4d-620">Permanent</span></span>             | <span data-ttu-id="6cc4d-621">Fast</span><span class="sxs-lookup"><span data-stu-id="6cc4d-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="6cc4d-622">Hjúskaparstaða</span><span class="sxs-lookup"><span data-stu-id="6cc4d-622">Marital status</span></span>

<span data-ttu-id="6cc4d-623">Gildi hjúskaparstöðu er varpað í Dayforce og þýtt, eftir því sem við á, yfir í samþykkt gildi við samþættingu.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="6cc4d-624">Eftirfarandi tafla sýnir hvernig gildum hjúskaparstöðu er varpað í Dayforce.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="6cc4d-625">Mannauður</span><span class="sxs-lookup"><span data-stu-id="6cc4d-625">Human Resources</span></span>                 | <span data-ttu-id="6cc4d-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="6cc4d-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="6cc4d-627">Gift(ur)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-627">Married</span></span>                | <span data-ttu-id="6cc4d-628">Gift(ur)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-628">Married</span></span>                   |
| <span data-ttu-id="6cc4d-629">Ein</span><span class="sxs-lookup"><span data-stu-id="6cc4d-629">Single</span></span>                 | <span data-ttu-id="6cc4d-630">Ein</span><span class="sxs-lookup"><span data-stu-id="6cc4d-630">Single</span></span>                    |
| <span data-ttu-id="6cc4d-631">Ekkja/ekkill</span><span class="sxs-lookup"><span data-stu-id="6cc4d-631">Widowed</span></span>                | <span data-ttu-id="6cc4d-632">Ekkja/ekkill</span><span class="sxs-lookup"><span data-stu-id="6cc4d-632">Widowed</span></span>                   |
| <span data-ttu-id="6cc4d-633">Fráskilin(n)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-633">Divorced</span></span>               | <span data-ttu-id="6cc4d-634">Fráskilin(n)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-634">Divorced</span></span>                  |
| <span data-ttu-id="6cc4d-635">Skráð hjónaband</span><span class="sxs-lookup"><span data-stu-id="6cc4d-635">Registered Partnership</span></span> | <span data-ttu-id="6cc4d-636">Sambúð</span><span class="sxs-lookup"><span data-stu-id="6cc4d-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="6cc4d-637">None</span><span class="sxs-lookup"><span data-stu-id="6cc4d-637">None</span></span>                   | <span data-ttu-id="6cc4d-638">*Ekki stutt af Mexíkó*</span><span class="sxs-lookup"><span data-stu-id="6cc4d-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="6cc4d-639">Í sambúð</span><span class="sxs-lookup"><span data-stu-id="6cc4d-639">Cohabiting</span></span>             | <span data-ttu-id="6cc4d-640">*Ekki stutt af Mexíkó*</span><span class="sxs-lookup"><span data-stu-id="6cc4d-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="6cc4d-641">Kyn</span><span class="sxs-lookup"><span data-stu-id="6cc4d-641">Gender</span></span>

<span data-ttu-id="6cc4d-642">Merki kyns er varpað í Dayforce og þýtt, eftir því sem við á, yfir í samþykkt gildi við samþættingu.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="6cc4d-643">Eftirfarandi tafla sýnir hvernig kynjamerkingu er varpað í Dayforce.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="6cc4d-644">Mannauður</span><span class="sxs-lookup"><span data-stu-id="6cc4d-644">Human Resources</span></span>       | <span data-ttu-id="6cc4d-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="6cc4d-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="6cc4d-646">Karl</span><span class="sxs-lookup"><span data-stu-id="6cc4d-646">Male</span></span>         | <span data-ttu-id="6cc4d-647">Karl</span><span class="sxs-lookup"><span data-stu-id="6cc4d-647">Male</span></span>                      |
| <span data-ttu-id="6cc4d-648">Kona</span><span class="sxs-lookup"><span data-stu-id="6cc4d-648">Female</span></span>       | <span data-ttu-id="6cc4d-649">Kona</span><span class="sxs-lookup"><span data-stu-id="6cc4d-649">Female</span></span>                    |
| <span data-ttu-id="6cc4d-650">Ótilgreint</span><span class="sxs-lookup"><span data-stu-id="6cc4d-650">Non-specific</span></span> | <span data-ttu-id="6cc4d-651">*Ekki stutt af Mexíkó*</span><span class="sxs-lookup"><span data-stu-id="6cc4d-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="6cc4d-652">Greiðslumáti</span><span class="sxs-lookup"><span data-stu-id="6cc4d-652">Payment method</span></span>

<span data-ttu-id="6cc4d-653">Greiðslumátar bjóða starfsmanni og fyrirtæki upp á leið til að lýsa því hvernig starfsmenn fá greitt.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="6cc4d-654">Greiðslumátum er varpað í Dayforce og þýtt, eftir því sem við á, yfir í samþykkt gildi við samþættingu.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="6cc4d-655">Eftirfarandi tafla sýnir hvernig greiðslumátum er varpað í Dayforce.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="6cc4d-656">Mannauður</span><span class="sxs-lookup"><span data-stu-id="6cc4d-656">Human Resources</span></span>             | <span data-ttu-id="6cc4d-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="6cc4d-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="6cc4d-658">Innlausn</span><span class="sxs-lookup"><span data-stu-id="6cc4d-658">Cash</span></span>               | <span data-ttu-id="6cc4d-659">Innlausn</span><span class="sxs-lookup"><span data-stu-id="6cc4d-659">Cash</span></span>                      |
| <span data-ttu-id="6cc4d-660">Rafræn greiðsla</span><span class="sxs-lookup"><span data-stu-id="6cc4d-660">Electronic Payment</span></span> | <span data-ttu-id="6cc4d-661">Flutningur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-661">Transfer</span></span>                  |
| <span data-ttu-id="6cc4d-662">Villuleit</span><span class="sxs-lookup"><span data-stu-id="6cc4d-662">Check</span></span>              | <span data-ttu-id="6cc4d-663">Ávísun</span><span class="sxs-lookup"><span data-stu-id="6cc4d-663">Cheque</span></span>                    |
| <span data-ttu-id="6cc4d-664">Bankaávísun</span><span class="sxs-lookup"><span data-stu-id="6cc4d-664">Bank Draft</span></span>         | <span data-ttu-id="6cc4d-665">*Ekki stutt af Mexíkó*</span><span class="sxs-lookup"><span data-stu-id="6cc4d-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="6cc4d-666">Annað</span><span class="sxs-lookup"><span data-stu-id="6cc4d-666">Other</span></span>              | <span data-ttu-id="6cc4d-667">*Ekki stutt af Mexíkó*</span><span class="sxs-lookup"><span data-stu-id="6cc4d-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="6cc4d-668">Gerð bankareiknings</span><span class="sxs-lookup"><span data-stu-id="6cc4d-668">Bank account type</span></span>

<span data-ttu-id="6cc4d-669">Gerðir bankareikninga eru notaðar fyrir rafrænar greiðslur til starfsmanna.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="6cc4d-670">Gerðum bankareikninga er varpað í Dayforce sem upplýsingum um millifærslureikninga.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="6cc4d-671">Gerðir bankareikninga eru þýddar, eftir því sem við á, yfir í samþykkt gildi við samþættingu.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="6cc4d-672">Mannauður</span><span class="sxs-lookup"><span data-stu-id="6cc4d-672">Human Resources</span></span>            | <span data-ttu-id="6cc4d-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="6cc4d-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="6cc4d-674">Ávísanareikningur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-674">Checking Account</span></span>  | <span data-ttu-id="6cc4d-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="6cc4d-675">CheckingAccount</span></span>           |
| <span data-ttu-id="6cc4d-676">Launareikningur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-676">Payroll Account</span></span>   | <span data-ttu-id="6cc4d-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="6cc4d-677">PayrollAccount</span></span>            |
| <span data-ttu-id="6cc4d-678">Sparnaðarreikningur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-678">Savings Account</span></span>   | <span data-ttu-id="6cc4d-679">*Ekki stutt af Mexíkó*</span><span class="sxs-lookup"><span data-stu-id="6cc4d-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="6cc4d-680">BankGirot-reikningur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-680">BankGirot account</span></span> | <span data-ttu-id="6cc4d-681">*Ekki stutt af Mexíkó*</span><span class="sxs-lookup"><span data-stu-id="6cc4d-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="6cc4d-682">PlusGirot-reikningur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-682">PlusGirot account</span></span> | <span data-ttu-id="6cc4d-683">*Ekki stutt af Mexíkó*</span><span class="sxs-lookup"><span data-stu-id="6cc4d-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="6cc4d-684">Tekjukóðar</span><span class="sxs-lookup"><span data-stu-id="6cc4d-684">Earning codes</span></span>

<span data-ttu-id="6cc4d-685">Tekjukóðar auðkenna með einkvæmum hætti allar gerðir af tekjum sem starfsmaður fær.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="6cc4d-686">Kóðarnir ná yfir ýmsar færibreytur sem tengjast tekjum, svo sem bókhaldsreglum, skattalögum, skýrslukröfum og hækkunargetu.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="6cc4d-687">Ef óþekkt tíðni er notuð er tíðnin **Sérhver launagreiðsla** notuð sjálfgefið fyrir útreikning.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="6cc4d-688">Studdar tíðnir</span><span class="sxs-lookup"><span data-stu-id="6cc4d-688">Supported frequencies</span></span>

- <span data-ttu-id="6cc4d-689">Allir</span><span class="sxs-lookup"><span data-stu-id="6cc4d-689">All</span></span>
- <span data-ttu-id="6cc4d-690">ALLAR LAUNAGREIÐSLUR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-690">EVERYPAY</span></span>
- <span data-ttu-id="6cc4d-691">SÉRHVERT LAUNATÍMABIL</span><span class="sxs-lookup"><span data-stu-id="6cc4d-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="6cc4d-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="6cc4d-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="6cc4d-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="6cc4d-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="6cc4d-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-694">1OFMTH</span></span>
- <span data-ttu-id="6cc4d-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-695">LASTOFMTH</span></span>
- <span data-ttu-id="6cc4d-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-696">2OFMTH</span></span>
- <span data-ttu-id="6cc4d-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-697">3OFMTH</span></span>
- <span data-ttu-id="6cc4d-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-698">4OFMTH</span></span>
- <span data-ttu-id="6cc4d-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-699">5OFMTH</span></span>
- <span data-ttu-id="6cc4d-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-700">1N2OFMTH</span></span>
- <span data-ttu-id="6cc4d-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-701">3N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-702">1N3OFMTH</span></span>
- <span data-ttu-id="6cc4d-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-703">1N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-704">2N3OFMTH</span></span>
- <span data-ttu-id="6cc4d-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-705">2N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="6cc4d-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="6cc4d-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="6cc4d-711">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="6cc4d-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="6cc4d-712">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="6cc4d-713">LASTOFQTR - LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="6cc4d-714">LASTMTHOFQTR - LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="6cc4d-715">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="6cc4d-716">LASTOFYEAR - LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="6cc4d-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="6cc4d-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="6cc4d-718">Aðsetur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-718">Addresses</span></span>

<span data-ttu-id="6cc4d-719">Að bera kennsl á kóða tiltekins lands eða svæðis, ríkis og fylkis (sveitarfélags) krefst sérstakra sniða sem Dayforce og innlendir veitendur/svæðisveitendur geta borið kennsl á.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="6cc4d-720">Þótt snið fyrir borgir sé sveigjanlegt, verður hver borg að vera tengd ríki.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="6cc4d-721">Mannauður</span><span class="sxs-lookup"><span data-stu-id="6cc4d-721">Human Resources</span></span>              | <span data-ttu-id="6cc4d-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="6cc4d-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="6cc4d-723">Land/svæði</span><span class="sxs-lookup"><span data-stu-id="6cc4d-723">Country/Region</span></span>      | <span data-ttu-id="6cc4d-724">Landsnúmer</span><span class="sxs-lookup"><span data-stu-id="6cc4d-724">Country Code</span></span>          |
| <span data-ttu-id="6cc4d-725">Póstnúmer</span><span class="sxs-lookup"><span data-stu-id="6cc4d-725">Zip/Postal Code</span></span>     | <span data-ttu-id="6cc4d-726">Póstnúmer</span><span class="sxs-lookup"><span data-stu-id="6cc4d-726">Postal Code</span></span>           |
| <span data-ttu-id="6cc4d-727">Ríki</span><span class="sxs-lookup"><span data-stu-id="6cc4d-727">State</span></span>               | <span data-ttu-id="6cc4d-728">Ríkiskóði</span><span class="sxs-lookup"><span data-stu-id="6cc4d-728">State Code</span></span>            |
| <span data-ttu-id="6cc4d-729">Póststöð</span><span class="sxs-lookup"><span data-stu-id="6cc4d-729">City</span></span>                | <span data-ttu-id="6cc4d-730">Póststöð</span><span class="sxs-lookup"><span data-stu-id="6cc4d-730">City</span></span>                  |
| <span data-ttu-id="6cc4d-731">Sýsla</span><span class="sxs-lookup"><span data-stu-id="6cc4d-731">County</span></span>              | <span data-ttu-id="6cc4d-732">Sýsla (sveitarfélag)</span><span class="sxs-lookup"><span data-stu-id="6cc4d-732">County (Municipality)</span></span> |
| <span data-ttu-id="6cc4d-733">Gata</span><span class="sxs-lookup"><span data-stu-id="6cc4d-733">Street</span></span>              | <span data-ttu-id="6cc4d-734">Heimilisfang, lína 1</span><span class="sxs-lookup"><span data-stu-id="6cc4d-734">Address Line 1</span></span>        |
| <span data-ttu-id="6cc4d-735">Húsnúmer</span><span class="sxs-lookup"><span data-stu-id="6cc4d-735">Street Number</span></span>       | <span data-ttu-id="6cc4d-736">Heimilisfang, lína 2</span><span class="sxs-lookup"><span data-stu-id="6cc4d-736">Address Line 2</span></span>        |
| <span data-ttu-id="6cc4d-737">Býr til viðbót</span><span class="sxs-lookup"><span data-stu-id="6cc4d-737">Building Complement</span></span> | <span data-ttu-id="6cc4d-738">Heimilisfang, lína 5</span><span class="sxs-lookup"><span data-stu-id="6cc4d-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="6cc4d-739">Vegabréfsnúmer</span><span class="sxs-lookup"><span data-stu-id="6cc4d-739">Passport number</span></span>

<span data-ttu-id="6cc4d-740">Starfsmenn geta gefið upp vegabréfsupplýsingar.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-740">Employees can declare passport information.</span></span> <span data-ttu-id="6cc4d-741">Þessar upplýsingar eru af auðkennisgerðinni **Vegabréf** og eru samþættar í Dayforce sem hluti af tilteknum mexíkönskum upplýsingum starfsmanns.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="6cc4d-742">Gerð auðkennis = „Vegabréf“</span><span class="sxs-lookup"><span data-stu-id="6cc4d-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="6cc4d-743">Útgáfudagsetning</span><span class="sxs-lookup"><span data-stu-id="6cc4d-743">Issued Date</span></span>
- <span data-ttu-id="6cc4d-744">Lokadagur</span><span class="sxs-lookup"><span data-stu-id="6cc4d-744">Expiration Date</span></span>

<span data-ttu-id="6cc4d-745">Starfsmenn geta gefið upp mörg auðkennisnúmer af auðkennisgerðinni **Vegabréf**.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="6cc4d-746">Hins vegar er aðeins núverandi virka færslan samþætt í Dayforce.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="6cc4d-747">Ef allar vegabréfsfærslur eru útrunnar verður vegabréfið sem síðast var gefið út samþætt í Dayforce.</span><span class="sxs-lookup"><span data-stu-id="6cc4d-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
