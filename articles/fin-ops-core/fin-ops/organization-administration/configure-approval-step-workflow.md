...
description: Þessi grein útskýrir hvernig skilgreina á eiginleika samþykktarskrefs.
author: ChrisGarty
ms.date: 08/23/2017
ms.topic: article
ms.prod: ''
...
Þessi grein útskýrir hvernig skilgreina á eiginleika samþykktarskrefs.
