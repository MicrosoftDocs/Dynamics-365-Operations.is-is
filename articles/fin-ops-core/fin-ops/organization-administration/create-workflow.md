...
description: Þessi grein útskýrir hvernig á að stofna verkflæði.
author: ChrisGarty
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
3. Fylgdu leiðbeiningunum í greininni [Skilgreining verkflæðiseiginleika](configure-workflow-properties.md).
