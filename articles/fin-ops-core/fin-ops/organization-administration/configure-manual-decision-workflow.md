...
description: Þessi grein útskýrir hvernig skilgreina á eiginleika handvirkrar ákvörðunar.
author: ChrisGarty
ms.date: 06/15/2020
ms.topic: article
ms.prod: ''
...
Þessi grein útskýrir hvernig skilgreina á eiginleika handvirkrar ákvörðunar.
...
3. Til að bæta notanda við stigmögnunarslóð, smella **bæta við stigmögnun**. Veljið einn af valkostum í eftirfarandi töflu, og fylgið svo viðbótarskref fyrir valkostinn áður en farið er í skrefi 4.
    ...
    <ol>
    <li>Eftir að þú velur <strong>Notanda</strong>, skal smellið á <strong>Notanda</strong> flipa.</li>
    <li>Listinn <strong>Tiltækir notendur</strong> inniheldur alla notendur. Veldu Notendur til að stigmagna Ákvörðun fyrir, og færðu síðan þessa notendur í <strong>Valdir notendur</strong> lista.</li>
    </ol>
    </td>
    </tr>
    </tbody>
...
Fylgið eftirfarandi skrefum ef verður að taka ákvörðunina innan tiltekins tíma.
