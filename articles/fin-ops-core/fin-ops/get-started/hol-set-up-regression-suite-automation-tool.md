...
- <span data-ttu-id="2700d-107">Kynntu þér uppsetningu og forsendur sem þarf fyrir þau mismunandi forrit sem styðja Regression Suite Automation Tool (RSAT).</span><span class="sxs-lookup"><span data-stu-id="2700d-107">Understand the installation and prerequisite setup that are required for the various applications that support Regression suite automation tool (RSAT).</span></span>
...
## <a name="configure-azure-devops"></a><span data-ttu-id="2700d-123">Skilgreina Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="2700d-123">Configure Azure DevOps</span></span>
...
<span data-ttu-id="2700d-173">Fyrir LCS-verkefnið er hægt að nota núverandi innleiðingu viðskiptavina eða samstarfsverkefni.</span><span class="sxs-lookup"><span data-stu-id="2700d-173">For your LCS project, you can use an existing customer implementation or partner project.</span></span>
...
8. <span data-ttu-id="2700d-270">Ef þú vilt vista verkskráningu á staðnum og hlaða henni síðan inn í BPM í gegnum LCS skaltu fylgja þessum skrefum:</span><span class="sxs-lookup"><span data-stu-id="2700d-270">If you want to save the task recording locally and then upload it to BPM through LCS, follow these steps:</span></span>
    ...
    3. <span data-ttu-id="2700d-275">Farðu í BPM-safnið **RSAT** og veldu viðskiptaferlið sem á að vista verkskráninguna gegn.</span><span class="sxs-lookup"><span data-stu-id="2700d-275">Go to the **RSAT** BPM library, and select the business process to save the task recording against.</span></span>
...
### <a name="install-an-authentication-certificate"></a><span data-ttu-id="2700d-306">Settu upp sannvottunarvottorð</span><span class="sxs-lookup"><span data-stu-id="2700d-306">Install an authentication certificate</span></span>
...
## <a name="get-started-with-rsat"></a><span data-ttu-id="2700d-352">Hafist handa með RSAT</span><span class="sxs-lookup"><span data-stu-id="2700d-352">Get started with RSAT</span></span>
...
### <a name="load-and-run-test-cases"></a><span data-ttu-id="2700d-418">Sækja og keyra prófunardæmi</span><span class="sxs-lookup"><span data-stu-id="2700d-418">Load and run test cases</span></span>
...
4. <span data-ttu-id="2700d-431">Til að staðfesta að sjálfvirkniskrár og færibreytuskrár séu vistaðar á Azure DevOps skaltu fara í Azure DevOps-verkið, velja **Spjald \> Vinnuliður** og síðan prófunardæmið **Stofna nýja vöru**.</span><span class="sxs-lookup"><span data-stu-id="2700d-431">To verify that the automation files and parameter files are saved to Azure DevOps, go to the Azure DevOps project, select **Boards \> Work Items**, and select the **Create a new product** test case.</span></span> <span data-ttu-id="2700d-432">Á flipanum **Viðhengi** ættirðu að sjá fjórar skrár:</span><span class="sxs-lookup"><span data-stu-id="2700d-432">On the **Attachments** tab, you should see four files:</span></span>
    ...
    - <span data-ttu-id="2700d-433">**.cs** – C\# sjálfvirkniskrá</span><span class="sxs-lookup"><span data-stu-id="2700d-433">**.cs** – C\# automation file</span></span>
...
5. <span data-ttu-id="2700d-467">Flipinn **Keyra samantekt** gefur til kynna að prófunardæmið hafi ekki tekist en hann veitir ekki raunverulegu villuboðin.</span><span class="sxs-lookup"><span data-stu-id="2700d-467">The **Run summary** tab indicates that the test case failed, but it doesn't provide the actual error message.</span></span> <span data-ttu-id="2700d-468">Til að skoða sundurliðuð villuboð velurðu flipann **Prófunarniðurstöður**.</span><span class="sxs-lookup"><span data-stu-id="2700d-468">To view the detailed error message, select the **Test results** tab.</span></span>

    ![Flipinn Keyra samantekt](./media/setup_rsa_tool_77.png)

    <span data-ttu-id="2700d-470">Flipinn **Prófunarniðurstöður** veitir upplýsingar um prófunardæmið, ásamt útkomunni og villuboðunum.</span><span class="sxs-lookup"><span data-stu-id="2700d-470">The **Test results** tab provides the test case information, together with the outcome and the error message.</span></span>

    ![Flipinn Niðurstöður prófunar](./media/setup_rsa_tool_78.png)

6. <span data-ttu-id="2700d-472">Tvísmelltu á viðeigandi skrá til að skoða upplýsingar villuboða.</span><span class="sxs-lookup"><span data-stu-id="2700d-472">Double-click the relevant record to view the detailed error message.</span></span>

    ![Upplýsingar villuboða](./media/setup_rsa_tool_79.png)

    > [!NOTE]
    > <span data-ttu-id="2700d-474">Öll villuskilaboð eru einnig tiltæk staðbundið í **C:\\Notendur\\\$YourUserName\\AppData\\Roaming\\regressionTool\\errormsg-.txt**.</span><span class="sxs-lookup"><span data-stu-id="2700d-474">All error messages are also available locally in **C:\\Users\\\$YourUserName\\AppData\\Roaming\\regressionTool\\errormsg-.txt**.</span></span>

7. <span data-ttu-id="2700d-475">Þú getur einnig flutt út niðurstöður prófunarkeyrslu úr prófunaráætlunarstiginu með því að velja **Flytja út**.</span><span class="sxs-lookup"><span data-stu-id="2700d-475">You can also export the test run results from the test plan level by selecting **Export**.</span></span>

    ![Flytur út prófunaráætlun](./media/setup_rsa_tool_80.png)

### <a name="modify-the-excel-parameter-file"></a><span data-ttu-id="2700d-477">Breyta Excel-færibreytuskrá</span><span class="sxs-lookup"><span data-stu-id="2700d-477">Modify the Excel parameter file</span></span>

1. <span data-ttu-id="2700d-478">Opnaðu RSAT.</span><span class="sxs-lookup"><span data-stu-id="2700d-478">Open RSAT.</span></span>
2. <span data-ttu-id="2700d-479">Veldu prófdæmið og veldu síðan **Breyta** til að opna Excel-færibreytuskrána.</span><span class="sxs-lookup"><span data-stu-id="2700d-479">Select the test case, and then select **Edit** to open the Excel parameter file.</span></span>

    <span data-ttu-id="2700d-480">Á blaðinu **EcoResProductCreate** skaltu athuga að gildið í reinum **Afurðarnúmer** er harðkóðað.</span><span class="sxs-lookup"><span data-stu-id="2700d-480">On the **EcoResProductCreate** sheet, notice that the value of the **Product number** field is hard-coded.</span></span> <span data-ttu-id="2700d-481">Þú verður að uppfæra þennan reit í nýtt afurðarnúmer áður en prófunardæmið er keyrt aftur.</span><span class="sxs-lookup"><span data-stu-id="2700d-481">You must update this field to a new product number before you run the test case again.</span></span>

3. <span data-ttu-id="2700d-482">Til að mynda einkvæmt afurðarnúmer fyrir hverja keyrslu án þess að þurfa að enduropna Excel-færibreytuskrána og uppfæra afurðarnúmerið handvirkt í hvert skipti skaltu nota eftirfarandi Excel-formúlu.</span><span class="sxs-lookup"><span data-stu-id="2700d-482">To generate a unique product number for each run without having to reopen the Excel parameter file and manually update the product number every time, use the following Excel formula.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="2700d-483">Í viðbót við flipann **Almennt** inniheldur Excel-færibreytuskráin gagnaflipa fyrir hverja síðu sem prófið heimsækir.</span><span class="sxs-lookup"><span data-stu-id="2700d-483">In addition to the **General** tab, the Excel parameter file contains a data tab for every form page the test case visits.</span></span>

    ![Reiturinn Afurðarnúmer](./media/setup_rsa_tool_81.png)

4. <span data-ttu-id="2700d-485">Veldu **Vista** og lokaðu síðan Excel-skjalinu.</span><span class="sxs-lookup"><span data-stu-id="2700d-485">Select **Save**, and then close the Excel workbook.</span></span>
5. <span data-ttu-id="2700d-486">Veldu **Hlaða upp** til að vista Excel-færibreytuskrá á Azure DevOps.</span><span class="sxs-lookup"><span data-stu-id="2700d-486">Select **Upload** to save the Excel parameter file to Azure DevOps.</span></span>

    ![Upphleðsla skráar tókst](./media/setup_rsa_tool_82.png)

    > [!NOTE]
    > <span data-ttu-id="2700d-488">Til að keyra prófdæmi í tilteknu notendasamhengi skaltu slá inn netfang notanda í reitnum **Prófa notanda** á flipnum **Almennt** í Excel-færibreytuskránni.</span><span class="sxs-lookup"><span data-stu-id="2700d-488">To run test cases in a specific user context, enter the user's email ID in the **Test User** field on the **General** tab of the Excel parameter file.</span></span> <span data-ttu-id="2700d-489">Í nýjustu útgáfunni af RSAT hefur útlit reitanna í Excel-færibreytuskránni verið uppfærð, en hugtakið er enn það sama.</span><span class="sxs-lookup"><span data-stu-id="2700d-489">In the latest version of RSAT, the layout of the fields in the Excel parameter file has been updated, but the concept remains the same.</span></span>
    >
    > ![Reiturinn Prófa notanda](./media/setup_rsa_tool_83.png)

### <a name="validate-the-results"></a><span data-ttu-id="2700d-491">Sannprófa niðurstöður</span><span class="sxs-lookup"><span data-stu-id="2700d-491">Validate the results</span></span>

- <span data-ttu-id="2700d-492">Veldu **Keyra** til að endurkeyra prófunardæmið og sannprófa að prófunardæmið hafi staðist.</span><span class="sxs-lookup"><span data-stu-id="2700d-492">Select **Run** to rerun the test case, and verify that the test case has passed.</span></span> <span data-ttu-id="2700d-493">Þú getur skoðað niðurstöðurnar eins og lýst er í kaflanum [Skoða prófunarniðurstöður](#view-the-test-results).</span><span class="sxs-lookup"><span data-stu-id="2700d-493">You can view the test results as described in the [View the test results](#view-the-test-results) section.</span></span>

    ![Niðurstöðureitur stilltur á Stóðst](./media/setup_rsa_tool_84.png)

### <a name="chaining-of-test-cases"></a><span data-ttu-id="2700d-495">Keðja prófunardæma</span><span class="sxs-lookup"><span data-stu-id="2700d-495">Chaining of test cases</span></span>

<span data-ttu-id="2700d-496">Eitt lykilatriði í RSAT er keðja prófunardæma (það er að segja, geta prófunar til að gefa gildi til annarra prófana).</span><span class="sxs-lookup"><span data-stu-id="2700d-496">One key feature of RSAT is the chaining of test cases (that is, the capability of a test to pass values to other tests).</span></span> <span data-ttu-id="2700d-497">Prófunardæmi eru keyrð í samræmi við skilgreinda röð þeirra í Azure DevOps-prófunaráætlun.</span><span class="sxs-lookup"><span data-stu-id="2700d-497">Test cases are run according to their defined order in the Azure DevOps test plan.</span></span> <span data-ttu-id="2700d-498">(Þessa röð er einnig hægt að uppfæra í prófunarverkfærinu sjálfu.) Ef þú vilt framsenda breytur úr einni prófun í aðra er afar mikilvægt að prófanirnar séu í réttri röð.</span><span class="sxs-lookup"><span data-stu-id="2700d-498">(This order can also be updated in the test tool itself.) Therefore, if you want to pass variables from one test case to another, it's very important that the tests be in the correct order.</span></span>

<span data-ttu-id="2700d-499">Í þessum kafla muntu stofna vistaða breytu í fyrsta prófunardæminu, stofna annað prófunardæmi og senda vistaða breytu úr fyrsta prófunardæminu í annað prófunardæmi.</span><span class="sxs-lookup"><span data-stu-id="2700d-499">In this section, you will create a saved variable in the first test case, create a second test case, and pass the saved variable from the first test case to the second test case.</span></span> <span data-ttu-id="2700d-500">Síðan muntu keyra prófunardæmin sem keðju af prófunardæmum í RSAT.</span><span class="sxs-lookup"><span data-stu-id="2700d-500">You will then run the test cases as a chained test case in RSAT.</span></span>

#### <a name="modify-an-existing-task-recording-to-create-a-saved-variable"></a><span data-ttu-id="2700d-501">Breyta núverandi verkskráningu til að stofna vistaða breytu</span><span class="sxs-lookup"><span data-stu-id="2700d-501">Modify an existing task recording to create a saved variable</span></span>

1. <span data-ttu-id="2700d-502">Opna á biðlarann.</span><span class="sxs-lookup"><span data-stu-id="2700d-502">Open the client.</span></span>
2. <span data-ttu-id="2700d-503">Veldu hnappinn **Stillingar** (gírtáknið) og síðan **Verkskráningu**.</span><span class="sxs-lookup"><span data-stu-id="2700d-503">Select the **Settings** button (the gear symbol), and then select **Task recorder**.</span></span>
3. <span data-ttu-id="2700d-504">Veldu **Breyta skráningu**.</span><span class="sxs-lookup"><span data-stu-id="2700d-504">Select **Edit Recording**.</span></span>

    ![Hnappurinn Breyta skráningu](./media/setup_rsa_tool_85.png)

4. <span data-ttu-id="2700d-506">Veldu **Opna úr Lifecycle Services**.</span><span class="sxs-lookup"><span data-stu-id="2700d-506">Select **Open from Lifecycle Services**.</span></span>

    ![Opna úr hnappnum Lifecycle Services](./media/setup_rsa_tool_86.png)

5. <span data-ttu-id="2700d-508">Veldu **Velja Lifecycle Services-safnið**.</span><span class="sxs-lookup"><span data-stu-id="2700d-508">Select **Select the Lifecycle Services library**.</span></span>

    ![Veldu hnappinn Lifecycle Services-safnið](./media/setup_rsa_tool_87.png)

    <span data-ttu-id="2700d-510">BPM-söfn eru sótt úr LCS.</span><span class="sxs-lookup"><span data-stu-id="2700d-510">BPM libraries are loaded from LCS.</span></span>

    ![Framvinduvísir](./media/setup_rsa_tool_88.png)

6. <span data-ttu-id="2700d-512">Eftir að BPM-söfn hafa verið sótt úr LCS skaltu velja **RSAT** BPM-safnið og viðskiptaferlið **Stofna nýja vöru** sem verkskráningin var tengd við.</span><span class="sxs-lookup"><span data-stu-id="2700d-512">After the BPM libraries are loaded from LCS, select the **RSAT** BPM library and the **Create a new product** business process that the task recording was associated with.</span></span> <span data-ttu-id="2700d-513">Veljið síðan **Í lagi**.</span><span class="sxs-lookup"><span data-stu-id="2700d-513">Then select **OK**.</span></span>

    ![Val á BPM-safn og viðskiptaferli](./media/setup_rsa_tool_89.png)

7. <span data-ttu-id="2700d-515">Heiti viðeigandi verkskráningar er slegið inn í reitinn **Heiti skráningar**.</span><span class="sxs-lookup"><span data-stu-id="2700d-515">The name of the appropriate task recording is entered in the **Recording name** field.</span></span> <span data-ttu-id="2700d-516">Velja **Ræsa**.</span><span class="sxs-lookup"><span data-stu-id="2700d-516">Select **Start**.</span></span>

    ![Heiti verkskáningarinnar í reitnum Heiti skráningar](./media/setup_rsa_tool_90.png)

8. <span data-ttu-id="2700d-518">Farðu í **Afurðaupplýsingastjórnun \> Afurðir** og veldu **Nýtt** til að opna síðuna þar sem upphafleg verkskráning, **Stofna afurð**, var skráð.</span><span class="sxs-lookup"><span data-stu-id="2700d-518">Go to **Product information management \> Products**, and select **New** to open the page where the original task recording, **Create a product**, was recorded.</span></span>
9. <span data-ttu-id="2700d-519">Veldu **Setja inn skref**.</span><span class="sxs-lookup"><span data-stu-id="2700d-519">Select **Insert step**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="2700d-520">Nýja skrefið er sett inn á **eftir** skrefinu sem þú valdir í glugganum.</span><span class="sxs-lookup"><span data-stu-id="2700d-520">The new step is inserted **after** the step that you selected in the pane.</span></span>

    ![Hnappurinn Setja inn skref](./media/setup_rsa_tool_91.png)

10. <span data-ttu-id="2700d-522">Hægrismelltu á reitinn **Afurðarnúmer** og veldu síðan **Verkskráning \> Afrita**.</span><span class="sxs-lookup"><span data-stu-id="2700d-522">Right-click the **Product number** field, and then select **Task recorder \> Copy**.</span></span>

    ![Afrita skipun](./media/setup_rsa_tool_92.png)

11. <span data-ttu-id="2700d-524">Nýju skrefi er bætt í glugganum.</span><span class="sxs-lookup"><span data-stu-id="2700d-524">A new step is added in the pane.</span></span> <span data-ttu-id="2700d-525">Skráðu niður gildið í reitnum **Afurðarnúmer** vegna þess að þú þarft það síðar.</span><span class="sxs-lookup"><span data-stu-id="2700d-525">Make a note of the value in the **Product number** field, because you will need it later.</span></span>

    ![Nýju skrefi bætt við](./media/setup_rsa_tool_93.png)

12. <span data-ttu-id="2700d-527">Veldu **Breytingum lokið**.</span><span class="sxs-lookup"><span data-stu-id="2700d-527">Select **Done editing**.</span></span>
13. <span data-ttu-id="2700d-528">Veldu **Vista í Lifecycle Services** og tengdu nýja verkskráningu við sama BPM-safnið og viðskiptaferlið sem upphafleg verkskráning var tengd við.</span><span class="sxs-lookup"><span data-stu-id="2700d-528">Select **Save to Lifecycle Services**, and associate the new task recording with the same BPM library and business process that the original task recording was associated with.</span></span> <span data-ttu-id="2700d-529">Nánari upplýsingar er að finna í kaflanum [Stofna verkskráningu og vista hana í BPM-safnið](#create-a-task-recording-and-save-it-to-the-bpm-library).</span><span class="sxs-lookup"><span data-stu-id="2700d-529">For more information, see the [Create a task recording and save it to the BPM library](#create-a-task-recording-and-save-it-to-the-bpm-library) section.</span></span>
14. <span data-ttu-id="2700d-530">Farðu í BPM-safnið og veldu **Samstilla prófunardæmi** til að yfirskrifa þá verkskráningu sem fylgir prófunardæminu í Azure DevOps, eins og lýst er í kaflanum [Prófa samstillingu úr BPM við Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops).</span><span class="sxs-lookup"><span data-stu-id="2700d-530">Go to the BPM library, and select **Sync testcases** to overwrite the task recording that is attached to the test case in Azure DevOps, as described in the [Test the synchronization from BPM to Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops) section.</span></span>
15. <span data-ttu-id="2700d-531">Opnaðu RSAT og veldu **Sækja** til að endursækja öll prófunardæmin í prófunarpakkanum.</span><span class="sxs-lookup"><span data-stu-id="2700d-531">Open RSAT, and select **Load** to reload all the test cases in the test suite.</span></span> <span data-ttu-id="2700d-532">Það verður að endurnýja sjálfvirkni- og færibreytuskrár fyrir viðeigandi prófunardæmi með því að velja prófunardæmið og velja síðan **Nýtt \> Mynda prófunarkeyrslu- og færibreytuskrár**, eins og lýst er í kaflanum [Sækja og keyra prófunardæmi](#load-and-run-test-cases).</span><span class="sxs-lookup"><span data-stu-id="2700d-532">You must regenerate the automation and parameter files for the appropriate test case by selecting the test case and then selecting **New \> Generate Test Execution and Parameter files**, as described in the [Load and run test cases](#load-and-run-test-cases) section.</span></span>

    > [!NOTE]
    > <span data-ttu-id="2700d-533">Ef Excel-færibreytuskráin var skilin eftir opnuð mun endurnýjun ekki takast.</span><span class="sxs-lookup"><span data-stu-id="2700d-533">If the Excel parameter file was left open, regeneration will fail.</span></span> <span data-ttu-id="2700d-534">Passaðu þess vegna að Excel-færibreytuskráin fyrir prófunardæmið sé lokuð áður en þú myndar nýja Excel-færibreytuskrá.</span><span class="sxs-lookup"><span data-stu-id="2700d-534">Therefore, make sure that the Excel parameter file for the test case is closed before you generate the new Excel parameter file.</span></span>

16. <span data-ttu-id="2700d-535">Veldu **Breyta** til að opna nýja Excel-færibreytuskrána.</span><span class="sxs-lookup"><span data-stu-id="2700d-535">Select **Edit** to open the new Excel parameter file.</span></span> <span data-ttu-id="2700d-536">Þú munt sjá nýja færslu **Vistuð breyta** í línu 9.</span><span class="sxs-lookup"><span data-stu-id="2700d-536">You will see a new **Saved variable** entry on line 9.</span></span> <span data-ttu-id="2700d-537">Þessi breyta, **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}**, er vistuð í XML-skrá verkskráningarinnar og hana má nota í síðari prófanir.</span><span class="sxs-lookup"><span data-stu-id="2700d-537">This variable, **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}**, is saved in the task recording's XML file and can be used in subsequent tests.</span></span>

    ![Vistuð breytufærsla](./media/setup_rsa_tool_94.png)

#### <a name="create-a-new-test-case"></a><span data-ttu-id="2700d-539">Stofna nýtt prófunardæmi</span><span class="sxs-lookup"><span data-stu-id="2700d-539">Create a new test case</span></span>

1. <span data-ttu-id="2700d-540">Farðu í **RSAT** BPM-safnð.</span><span class="sxs-lookup"><span data-stu-id="2700d-540">Go to the **RSAT** BPM library.</span></span>
2. <span data-ttu-id="2700d-541">Veldu ferlið **Sýnisstuðningsviðskiptaferli** og síðan velurðu til hægri **Breyta ham**.</span><span class="sxs-lookup"><span data-stu-id="2700d-541">Select the **Sample Support Business Process** process, and then, on the right, select **Edit mode**.</span></span>
3. <span data-ttu-id="2700d-542">Breyttu gildi bæði reitarins **Heiti** og reitarins **Lýsing** í **Losa afurð**.</span><span class="sxs-lookup"><span data-stu-id="2700d-542">Change the value of both the **Name** field and the **Description** field to **Release a product**.</span></span> <span data-ttu-id="2700d-543">Veldu síðan **Vista**.</span><span class="sxs-lookup"><span data-stu-id="2700d-543">Then select **Save**.</span></span>

    ![Heiti og lýsingu breytt í Losa afurð](./media/setup_rsa_tool_95.png)

#### <a name="create-a-new-task-recording-that-has-a-validate-function"></a><span data-ttu-id="2700d-545">Stofna nýja verkskráningu sem er með staðfestingaraðgerð</span><span class="sxs-lookup"><span data-stu-id="2700d-545">Create a new task recording that has a Validate function</span></span>

- <span data-ttu-id="2700d-546">Stofnaðu verkskráningu til að losa afurðina sem var stofnuð áður til lögaðila í Bandaríkjunum.</span><span class="sxs-lookup"><span data-stu-id="2700d-546">Create a task recording to release the product that was created earlier to the USRT legal entity.</span></span> <span data-ttu-id="2700d-547">Nánari upplýsingar er að finna í kaflanum [Stofna verkskráningu og vista hana í BPM-safnið](#create-a-task-recording-and-save-it-to-the-bpm-library).</span><span class="sxs-lookup"><span data-stu-id="2700d-547">For more information, see the [Create a task recording and save it to the BPM library](#create-a-task-recording-and-save-it-to-the-bpm-library) section.</span></span>

    > [!NOTE]
    > <span data-ttu-id="2700d-548">Fyrir keðjuð prófunardæmi mælum við alltaf með að þú finnir eða síir fyrir skrána sem þú þarfnast með því að *rita gildið handvirkt inn í reitinn*.</span><span class="sxs-lookup"><span data-stu-id="2700d-548">For chained test cases, we always recommend that you find or filter for the record that you require by *manually typing the value of the field*.</span></span> <span data-ttu-id="2700d-549">Þannig getur verkfærið ákvarðað skrána sem nota verður aðgerðin við í síðara prófunardæminu.</span><span class="sxs-lookup"><span data-stu-id="2700d-549">In that way, the tool can determine the record that the action must be taken against in the subsequent test case.</span></span>

    ![Ný verkskráning sem er með staðfestingaraðgerð](./media/setup_rsa_tool_96.png)

    <span data-ttu-id="2700d-551">Þegar afurðin er fundin með því að nota flýtiafmörkun, en áður en þú velur **Losa afurðir**, staðfestirðu gildi reitsins **Afurðarnúmer** til að ganga úr skugga um að afurðakennið sé það afurðakenni sem var búið til áður, eins og skýringarmyndin á undan sýnir.</span><span class="sxs-lookup"><span data-stu-id="2700d-551">As the preceding illustration shows, after the product is found by using the Quick Filter, but before you select **Release products**, you validate the value of the **Product number** field to make sure that the product ID is the product ID that was created earlier.</span></span> <span data-ttu-id="2700d-552">Til að staðfesta gildi skaltu hægrismella á reitinn **Afurðarnúmer** og velja síðan **Verkskráning \> Staðfesta \> Núverandi gildi**.</span><span class="sxs-lookup"><span data-stu-id="2700d-552">To validate the value, right-click the **Product number** field, and then select **Task recorder \> Validate \> Current Value**.</span></span>

    ![Staðfesting á núvarndi gildi](./media/setup_rsa_tool_97.png)

#### <a name="save-the-task-recording-to-bpm"></a><span data-ttu-id="2700d-554">Vistaðu verkskráninguna í BPM</span><span class="sxs-lookup"><span data-stu-id="2700d-554">Save the task recording to BPM</span></span>

1. <span data-ttu-id="2700d-555">Þegar verkskráningunni er lokið skaltu velja **Vista í Lifecycle Services**.</span><span class="sxs-lookup"><span data-stu-id="2700d-555">After the task recording is completed, select **Save to Lifecycle Services**.</span></span>

    ![Vista valkosti](./media/setup_rsa_tool_98.png)

2. <span data-ttu-id="2700d-557">Upplýsingar um söfn er hlaðið úr LCS.</span><span class="sxs-lookup"><span data-stu-id="2700d-557">Library information is loaded from LCS.</span></span>

    ![Framvinduvísir](./media/setup_rsa_tool_99.png)

3. <span data-ttu-id="2700d-559">Veldu BPM-safn til að tengja við verkskráninguna.</span><span class="sxs-lookup"><span data-stu-id="2700d-559">Select the BPM library to associate the task recording with.</span></span> <span data-ttu-id="2700d-560">Fyrir þetta kennsluefni skaltu velja BPM-safnið **RSAT** sem var stofnað áður og síðan viðskiptaferlið **Losa afurð** undir því.</span><span class="sxs-lookup"><span data-stu-id="2700d-560">For this tutorial, select the **RSAT** BPM library that was created earlier and the **Release a product** business process under it.</span></span> <span data-ttu-id="2700d-561">Veljið síðan **Í lagi**.</span><span class="sxs-lookup"><span data-stu-id="2700d-561">Then select **OK**.</span></span>

#### <a name="sync-bpm-to-azure-devops"></a><span data-ttu-id="2700d-562">Samstilla BPM við Azure DevOps</span><span class="sxs-lookup"><span data-stu-id="2700d-562">Sync BPM to Azure DevOps</span></span>

1. <span data-ttu-id="2700d-563">Farðu í BPM-safnið og opnaðu **RSAT**-safnið.</span><span class="sxs-lookup"><span data-stu-id="2700d-563">Go to the BPM library, and open the **RSAT** library.</span></span>
2. <span data-ttu-id="2700d-564">Veldu **VSTS-samstilling** og síðan **Samstilla prófunardæmi**.</span><span class="sxs-lookup"><span data-stu-id="2700d-564">Select **VSTS sync** and then **Sync test cases**.</span></span> <span data-ttu-id="2700d-565">Nánari upplýsingar er að finna í kaflanum [Prófa samstillingu úr BPM við Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops).</span><span class="sxs-lookup"><span data-stu-id="2700d-565">For more information, see the [Test the synchronization from BPM to Azure DevOps](#test-the-synchronization-from-bpm-to-azure-devops) section.</span></span>

    <span data-ttu-id="2700d-566">Þegar samstillingunni er lokið, verður nýr vinnuliður og samsvarandi prófdæmi fyrir viðskiptaferlið **Losa afurð** birtist í Azure DevOps á **Spjald \> Vinnuliðir**.</span><span class="sxs-lookup"><span data-stu-id="2700d-566">After the synchronization is completed, the new work item and the corresponding test case for the **Release a product** business process appear in Azure DevOps at **Boards \> Work Items**.</span></span>

#### <a name="add-the-new-test-case-to-the-existing-test-suite"></a><span data-ttu-id="2700d-567">Bættu nýjum prófunardæmum við núverandi prófunarpakka</span><span class="sxs-lookup"><span data-stu-id="2700d-567">Add the new test case to the existing test suite</span></span>

1. <span data-ttu-id="2700d-568">Farðu í **Prófunaráætlanir \> Prófunaráætlanir** og veldu áætlunina **RSAT-prófunaráætlun**.</span><span class="sxs-lookup"><span data-stu-id="2700d-568">Go to **Test plans \> Test plans**, and select the **RSAT Test Plan** plan.</span></span>
2. <span data-ttu-id="2700d-569">Veldu **Bæta við fyrirliggjandi**.</span><span class="sxs-lookup"><span data-stu-id="2700d-569">Select **Add existing**.</span></span>
3. <span data-ttu-id="2700d-570">Á síðunni **Bæta prófunardæmum við í safn** velurðu **Keyra fyrirspurn**.</span><span class="sxs-lookup"><span data-stu-id="2700d-570">On the **Add test cases to suite** page, select **Run query**.</span></span>
4. <span data-ttu-id="2700d-571">Veldu nýja prófunardæmið sem var búið til fyrir **Losa afurð** og veldu síðan **Bæta við prófunardæmum** neðst í hægra horni síðunnar (þessi hnappur er ekki sýndur á eftirfarandi mynd).</span><span class="sxs-lookup"><span data-stu-id="2700d-571">Select the new test case that was created for **Release a product**, and then select **Add test cases** in the lower-right corner of the page (this button isn't shown in the following illustration).</span></span>

    ![Síðan Bæta prófunardæmum við safn](./media/setup_rsa_tool_100.png)

    <span data-ttu-id="2700d-573">Núna er prófunarsafnið með tvö prófunardæmi.</span><span class="sxs-lookup"><span data-stu-id="2700d-573">The test suite now has two test cases.</span></span>

    ![Tvö prófunardæmi í prófunarpakkanum](./media/setup_rsa_tool_101.png)

#### <a name="load-test-cases-into-rsat"></a><span data-ttu-id="2700d-575">Hlaða prófunardæmum í RSAT</span><span class="sxs-lookup"><span data-stu-id="2700d-575">Load test cases into RSAT</span></span>

1. <span data-ttu-id="2700d-576">Opnaðu RSAT og veldu **Sækja**.</span><span class="sxs-lookup"><span data-stu-id="2700d-576">Open RSAT, and select **Load**.</span></span>
2. <span data-ttu-id="2700d-577">Prófunardæmunum hefur verið hlaðið og þú færð viðvörun sem segir: „Þessi aðgerð mun skrifa yfir Excel-prófgagnaskrár, staðbundnar breytingar munu glatast.</span><span class="sxs-lookup"><span data-stu-id="2700d-577">The test cases are loaded, and you receive a warning that states, "This action will overwrite Excel test data files, local changes will be lost.</span></span> <span data-ttu-id="2700d-578">Á að halda áfram?“</span><span class="sxs-lookup"><span data-stu-id="2700d-578">Do you want to proceed?"</span></span> <span data-ttu-id="2700d-579">Veldu **Já** til að uppfæra Excel-færibreytuskrár í staðbundna kerfinu en ekki Excel-færibreytuskrár sem var hlaðið upp í Azure DevOps.</span><span class="sxs-lookup"><span data-stu-id="2700d-579">Select **Yes** to update the Excel parameter files in the local system but not the Excel parameter files that were uploaded to Azure DevOps.</span></span>

    ![Viðvörunarboð](./media/setup_rsa_tool_102.png)

    <span data-ttu-id="2700d-581">Báðum prófunardæmunum hefur verið hlaðið, ásamt Excel-færibreytuskránni fyrir fyrsta prófunardæmið.</span><span class="sxs-lookup"><span data-stu-id="2700d-581">Both the test cases are loaded, together with the Excel parameter file for the first test case.</span></span> <span data-ttu-id="2700d-582">Þar sem þú valdir **Hlaða upp** í síðustu keyrslunni eru færibreytuskrárnar dregnar úr Azure DevOps.</span><span class="sxs-lookup"><span data-stu-id="2700d-582">Because you selected **Upload** in the last run, the parameter files are pulled from Azure DevOps.</span></span>

    ![Prófunardæmum hlaðið](./media/setup_rsa_tool_103.png)

3. <span data-ttu-id="2700d-584">Veldu aðeins annað prófunardæmið og veldu síðan **Nýtt \> Mynda prófunarkeyrslu og færibreytuskrár**.</span><span class="sxs-lookup"><span data-stu-id="2700d-584">Select only the second test case, and then select **New \> Generate test execution and parameter files**.</span></span>

#### <a name="edit-the-excel-parameter-file"></a><span data-ttu-id="2700d-585">Breyta Excel-færibreytuskránni</span><span class="sxs-lookup"><span data-stu-id="2700d-585">Edit the Excel parameter file</span></span>

1. <span data-ttu-id="2700d-586">Veldu aðeins annað prófdæmið og veldu síðan **Breyta** til að opna samsvarandi Excel-færibreytuskrá.</span><span class="sxs-lookup"><span data-stu-id="2700d-586">Select only the second test case, and then select **Edit** to open the corresponding Excel parameter file.</span></span>
2. <span data-ttu-id="2700d-587">Afritaðu vistaða breytu **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}** (sjá kaflann [Breyta núverandi verkskráningu til að stofna vistaða breytu](#modify-an-existing-task-recording-to-create-a-saved-variable)) úr fyrsta prófunardæminu inn í alla reiti þar sem afurðarnúmerið er notað.</span><span class="sxs-lookup"><span data-stu-id="2700d-587">Copy the **{{EcoResProductCreate\_Identification\_ProductNumber\_Copy}}** saved variable (see the [Modify an existing task recording to create a saved variable](#modify-an-existing-task-recording-to-create-a-saved-variable) section) from the first test case into all the fields where the product number is used.</span></span> <span data-ttu-id="2700d-588">Í þessu dæmi afritar þú breytu inn í reitina **Afurðarnúmer** og **Staðfesta afurðarnúmer** á blaðinu **EcoResProductListPage**.</span><span class="sxs-lookup"><span data-stu-id="2700d-588">In this case, you copy the variable into the **Product number** and **Validate Product number** fields on the **EcoResProductListPage** sheet.</span></span>

    ![Reitirnir Afurðarnúmer og Staðfesta afurðarnúmer](./media/setup_rsa_tool_104.png)

    > [!NOTE]
    > <span data-ttu-id="2700d-590">Aðeins er hægt að láta breytur ganga áfram á milli prófana í sömu prófunarkeyrslu.</span><span class="sxs-lookup"><span data-stu-id="2700d-590">Variables can be passed between tests only during the same test run.</span></span> <span data-ttu-id="2700d-591">Heiti breytanna verða að stemma nákvæmlega.</span><span class="sxs-lookup"><span data-stu-id="2700d-591">The names of the variables must match exactly.</span></span>

3. <span data-ttu-id="2700d-592">Veldu **Vista** og lokaðu síðan Excel-skjalinu.</span><span class="sxs-lookup"><span data-stu-id="2700d-592">Select **Save**, and then close the Excel workbook.</span></span>
4. <span data-ttu-id="2700d-593">Veldu **Hlaða upp** til að vista breytingarnar sem þú gerðir í Excel-færibreytuskránni.</span><span class="sxs-lookup"><span data-stu-id="2700d-593">Select **Upload** to save the changes that you made to the Excel parameter file.</span></span>

#### <a name="run-the-chained-test-cases"></a><span data-ttu-id="2700d-594">Keyrðu keðjuð prófunardæmi</span><span class="sxs-lookup"><span data-stu-id="2700d-594">Run the chained test cases</span></span>

1. <span data-ttu-id="2700d-595">Veldu bæði prófunardæmin og veldu síðan **Keyra**.</span><span class="sxs-lookup"><span data-stu-id="2700d-595">Select both the test cases, and then select **Run**.</span></span>
2. <span data-ttu-id="2700d-596">Staðfestu að bæði prófunardæmin hafi staðist.</span><span class="sxs-lookup"><span data-stu-id="2700d-596">Verify that both test cases have passed.</span></span>
