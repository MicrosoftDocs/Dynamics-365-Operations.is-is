...
- [Vélbúnaðarþörf fyrir staðbundin umhverfi](../../fin-ops/get-started/hardware-sizing-on-premises-environments.md)
- [Kaupa Finance + Operations (á staðnum)](../../fin-ops/get-started/purchase-on-premises.md)
...
- [Skilgreina gagnstæða staðgengla fyrir innanhússumhverfi](onprem-reverseproxy.md)
...
- [Eiginleikar sem ekki eru innleiddir í uppsetningu á staðnum](../../fin-ops/get-started/features-not-implemented-on-prem.md)
