## <a name="customers-v3-to-contacts"></a>Viðskiptavinir v3 í tengiliði

Þetta sniðmát samstillir gögn á milli Finance and Operations -forrita og Common Data Service.

Upprunasía: ((PartyType == "Person"))

Bakfærð upprunasía: msdyn_sellable eq true og msdyn_contactpersonid ne ''

Svæði í Finance and Operations | Gerð vörpunar | Annar Dynamics 365 reitur | Sjálfgildi
---|---|---|---
ekkert | >> | msdyn_sellable | Satt
PARTYTYPE | << | ekkert | Einstaklingur
...
ADDRESSLOCATIONROLES | << | ekkert | Fyrirtæki
...
ekkert | >> | address1_addresstypecode | 3
