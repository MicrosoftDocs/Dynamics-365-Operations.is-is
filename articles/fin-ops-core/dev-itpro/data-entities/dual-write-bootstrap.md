...
ms.locfileid: "2769707"
---
# <a name="bootstrap-with-company-data-faq"></a><span data-ttu-id="e1db3-103">Ræsiband með algengum spurningum um fyrirtæki</span><span class="sxs-lookup"><span data-stu-id="e1db3-103">Bootstrap with company data FAQ</span></span>
 
[!include [banner](../includes/banner.md)]

## <a name="why-do-i-need-bootstrapping"></a><span data-ttu-id="e1db3-104">Af hverju þarf ég ræsibönd?</span><span class="sxs-lookup"><span data-stu-id="e1db3-104">Why do I need bootstrapping?</span></span> 
<span data-ttu-id="e1db3-105">Þú gætir verið með fyrirliggjandi Common Data Service eða annað Dynamics 365 forritstilvik með viðskiptagögnum og vilt virkja tvískipta tengingu á móti því.</span><span class="sxs-lookup"><span data-stu-id="e1db3-105">You might have an existing Common Data Service or other Dynamics 365 app instance with business data, and you want to enable dual-write connection against it.</span></span> <span data-ttu-id="e1db3-106">Í því tilfelli þarf að ræsa Common Data Service eða önnur Dynamics 365 forritsgögn með fyrirtækisupplýsingum áður en hægt er að virkja tvískipta tengingu.</span><span class="sxs-lookup"><span data-stu-id="e1db3-106">In this case, you need to bootstrap Common Data Service or other Dynamics 365 app data with company information before enabling dual-write connection.</span></span>  
 
## <a name="when-should-i-use-bootstrapping"></a><span data-ttu-id="e1db3-107">Hvenær ætti ég að nota ræsibönd?</span><span class="sxs-lookup"><span data-stu-id="e1db3-107">When should I use bootstrapping?</span></span> 
<span data-ttu-id="e1db3-108">Þú ættir að nota ræsibönd áður en þú virkjar kort með tvískiptum skrifum (í þrepi #5).</span><span class="sxs-lookup"><span data-stu-id="e1db3-108">You should use bootstrapping before enabling dual-write entity maps (during step #5).</span></span>  
1. <span data-ttu-id="e1db3-109">Til að setja upp tvískipt ritaða tengingu á milli tilvika forritsins Finance and Operations og Common Data Service eða annars Dynamics 365 forrits, skráðu þig inn í forritið Finance and Operations sem stjórnandi.</span><span class="sxs-lookup"><span data-stu-id="e1db3-109">To setup the dual-write connection between instances of your Finance and Operations app and the Common Data Service or other Dynamics 365 app, log in to the Finance and Operations app as an administrator.</span></span> 
2. <span data-ttu-id="e1db3-110">Farðu í eininguna **Gagnastjórnun** og smelltu á hnappinn **Tvískipt skrif**.</span><span class="sxs-lookup"><span data-stu-id="e1db3-110">Go to the **Data Management** module and click the **Dual-Write** button.</span></span> <span data-ttu-id="e1db3-111">Þetta kveikir á **Data Integrator**.</span><span class="sxs-lookup"><span data-stu-id="e1db3-111">This launches the **Data Integrator**.</span></span> 
3. <span data-ttu-id="e1db3-112">Búðu til tvískipta tengingu fyrir eitt eða fleiri fyrirtæki.</span><span class="sxs-lookup"><span data-stu-id="e1db3-112">Create the dual-write connection for one or more companies.</span></span>  
    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="e1db3-113">![Búðu til tvískipt tengingu](media/dual-write-boot-1.png)</span><span class="sxs-lookup"><span data-stu-id="e1db3-113">![Create dual-write connection](media/dual-write-boot-1.png)</span></span>
4. <span data-ttu-id="e1db3-114">Virkjaðu einingakortið **Cdm_companies**.</span><span class="sxs-lookup"><span data-stu-id="e1db3-114">Enable the **Cdm_companies** entity map.</span></span> <span data-ttu-id="e1db3-115">Þetta samstillir fyrirtæki úr forritinu Finance and Operations við Common Data Service.</span><span class="sxs-lookup"><span data-stu-id="e1db3-115">This synchronizes companies from the Finance and Operations app to Common Data Service.</span></span>  
    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="e1db3-116">![Virkja einingarkortið](media/dual-write-boot-2.png)</span><span class="sxs-lookup"><span data-stu-id="e1db3-116">![Enable the entity map](media/dual-write-boot-2.png)</span></span>
5. <span data-ttu-id="e1db3-117">Keyrðu sýnishorn ræsikóða á Common Data Service eða annað forritstilvik Dynamics 365.</span><span class="sxs-lookup"><span data-stu-id="e1db3-117">Run the sample bootstrapping code on the Common Data Service or other Dynamics 365 app instance.</span></span>  
6. <span data-ttu-id="e1db3-118">Þegar ræsingu er lokið og kerfið er tilbúið fyrir samstillingu í beinni, virkjarðu einingakortin.</span><span class="sxs-lookup"><span data-stu-id="e1db3-118">When the bootstrapping is done and the system is ready for the live sync, enable the entity maps.</span></span>  

    <span data-ttu-id="e1db3-119">Með því að virkja einingakort kviknar á upphafsgagnasamstillingu fyrir virkjuð einingakort.</span><span class="sxs-lookup"><span data-stu-id="e1db3-119">Enabling the entity maps triggers the initial data sync for the enabled entity maps.</span></span> <span data-ttu-id="e1db3-120">Gögnin sem samsvara fyrirtækjunum sem valin eru í tvískiptatengingunni eru samstillt á milli forritsins Finance and Operations og Common Data Service.</span><span class="sxs-lookup"><span data-stu-id="e1db3-120">The data corresponding to the companies chosen on the dual-write connection is synchronized between the Finance and Operations app and Common Data Service.</span></span> 
 
## <a name="how-to-i-use-the-code-sample"></a><span data-ttu-id="e1db3-121">Hvernig nota ég kóðasýnið?</span><span class="sxs-lookup"><span data-stu-id="e1db3-121">How to I use the code sample?</span></span>
<span data-ttu-id="e1db3-122">Dæmi um kóða er C# forrit sem þú getur hlaðið í Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="e1db3-122">The sample code is a C# application that you can load in Visual Studio.</span></span> <span data-ttu-id="e1db3-123">Það þarf NuGet pakkatengsl á Common Data Service SDK, sem þú getur hressað í gegnum staðalinn Visual Studio verkfæri.</span><span class="sxs-lookup"><span data-stu-id="e1db3-123">It takes NuGet package dependencies on the Common Data Service SDK, that you can refresh through standard Visual Studio tooling.</span></span> 

<span data-ttu-id="e1db3-124">Eftir að hafa losnað lausnina og opnað hana í Visual Studio og endurheimta NuGet pakka, leitaðu að **TODO** í kóðanum.</span><span class="sxs-lookup"><span data-stu-id="e1db3-124">After unzipping and opening the solution in Visual Studio and restoring the NuGet packages, search for **TODO** in the code.</span></span> <span data-ttu-id="e1db3-125">Sérhver ákvörðun sem þú þarft að taka um það hvernig þú vilt ræsa upplýsingar um fyrirtæki eru gefnar með **TODO** með sýnishornskóða fyrir rétt myndaða útfærslu.</span><span class="sxs-lookup"><span data-stu-id="e1db3-125">Each decision you need to make about how you want to bootstrap company information is noted by a **TODO**, with sample code for a canonical implementation.</span></span> 

<span data-ttu-id="e1db3-126">Sýnishornakóðinn sýnir aðeins eina af mörgum leiðum sem þú gætir flokkað einingaskrár eftir fyrirtækjum.</span><span class="sxs-lookup"><span data-stu-id="e1db3-126">The sample code shows only one of many ways you might categorize entity records by company.</span></span> <span data-ttu-id="e1db3-127">Með því að breyta rökfræðinni í hlutanum **TODO** getur þú búið til sérsniðna flokkun þína.</span><span class="sxs-lookup"><span data-stu-id="e1db3-127">By changing the logic in the **TODO** sections, you can create your custom categorization.</span></span> 
 
## <a name="what-should-i-expect"></a><span data-ttu-id="e1db3-128">Við hverju á ég að búast?</span><span class="sxs-lookup"><span data-stu-id="e1db3-128">What should I expect?</span></span>
<span data-ttu-id="e1db3-129">Sjálfgefið er að sýnishornaforritið gerir þér kleift að leggja fram orðabók yfir varpanir viðskiptaeininga til fyrirtækis.</span><span class="sxs-lookup"><span data-stu-id="e1db3-129">By default, the sample application lets you provide a dictionary of business unit-to-company code mappings.</span></span> <span data-ttu-id="e1db3-130">Sérhver eining sem þú ræsir með reitnum **OwningBusinessUnit** er sjálfkrafa stillt á að nota tilgreint fyrirtæki.</span><span class="sxs-lookup"><span data-stu-id="e1db3-130">Any entity you bootstrap with an **OwningBusinessUnit** field is automatically set to use the specified company.</span></span> <span data-ttu-id="e1db3-131">Sérhver aðili án reitsins **OwningBusinessUnit**, svo sem vara, mun stilla fyrirtækið út frá vörpun með tómt gildi viðskiptaeiningar.</span><span class="sxs-lookup"><span data-stu-id="e1db3-131">Any entity without an **OwningBusinessUnit** field, such as product, will set the company based on the mapping with an empty business unit value.</span></span>

<span data-ttu-id="e1db3-132">Stjórnborðsforritið býst við einni færibreytu, annaðhvort **–simulate** eða **–apply**.</span><span class="sxs-lookup"><span data-stu-id="e1db3-132">The console application expects one parameter, either **–simulate** or **–apply**.</span></span> <span data-ttu-id="e1db3-133">Ef þú notar skipanalínufæribreytuna **–simulate** verða engin gögn uppfærð.</span><span class="sxs-lookup"><span data-stu-id="e1db3-133">If you use the **–simulate** command line parameter, then no data is updated.</span></span> <span data-ttu-id="e1db3-134">Aðeins **simulation_<entityname>.csv** skrár eru búnar til í sama skráasafni og tólið, ein fyrir hverja einingu sem hefði verið uppfærð.</span><span class="sxs-lookup"><span data-stu-id="e1db3-134">Only **simulation_<entityname>.csv** files are generated in the same directory as the tool, one for each entity that would have been updated.</span></span> <span data-ttu-id="e1db3-135">Þú getur endurskoðað þessar skrár endurtekið meðan þú vinnur að því að tryggja að kóðinn uppfæri gildi fyrirtækisins eins og búist var við.</span><span class="sxs-lookup"><span data-stu-id="e1db3-135">You can iteratively review these files while working to ensure the code updates company values as expected.</span></span> 

<span data-ttu-id="e1db3-136">Þegar þú hefur lokið við herma uppfærslurnar skaltu nota færibreytuna **–apply**.</span><span class="sxs-lookup"><span data-stu-id="e1db3-136">When you finish with the simulated updates, then use the **–apply** parameter.</span></span> <span data-ttu-id="e1db3-137">Þetta uppfærir allar skrár sem nú eru með rangt fyrirtækisgildi, í lotum með 1000 skrám í einu (sjálfgefið).</span><span class="sxs-lookup"><span data-stu-id="e1db3-137">This updates all records that currently have an incorrect company value, in batches of 1000 records at a time (by default).</span></span> <span data-ttu-id="e1db3-138">Kóðinn er einkvæmur eins og kveðið er á um, sem þýðir að þú getur keyrt hann aftur og aðeins rangt úthlutuð fyrirtæki verða uppfærð.</span><span class="sxs-lookup"><span data-stu-id="e1db3-138">The code is idempotent as provided, meaning you can re-run it and only the incorrectly assigned companies will be updated.</span></span> <span data-ttu-id="e1db3-139">Þegar þú keyrir með **–apply**, kóðinn gefur út CSV-skrár af þeim breytingum sem gerðar hafa verið, sem eru nefndar **applied_<entityname>.csv**.</span><span class="sxs-lookup"><span data-stu-id="e1db3-139">When running with **–apply**, the code outputs CSV files of the changes made, which are named **applied_<entityname>.csv**.</span></span> 
