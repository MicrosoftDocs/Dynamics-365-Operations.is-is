...
description: Þessi grein útskýrir hvernig ekki er hægt að hafa sama skiltákn fyrir bókhaldslykil og víddargildi. Þú verður að breyta gildum skiltákns eftir uppfærslu.
...
Í Microsoft Dynamics AX 2012 er hægt að nota sama skiltáknið fyrir bókhaldslykil og víddargildi. Í núverandi útgáfu af fjármálum- og rekstri er ekki hægt að hafa sama skiltákn fyrir bókhaldslykil og víddarheiti eða -gildi. Ef tvítekið skiltákn er til staðar er hægt að breyta því eftir uppfærslu. 
...
Líkt og auðkenni verkefnis/undirverkefnis ættu allar aðrar aðalgagnafærslur sem notaðar eru sem fjárhagsvíddir, svo sem lánardrottnar eða viðskiptavinir, ekki að hafa lykilauðkennisgildi sem nota sama skiltákn bókhaldslykils. 
