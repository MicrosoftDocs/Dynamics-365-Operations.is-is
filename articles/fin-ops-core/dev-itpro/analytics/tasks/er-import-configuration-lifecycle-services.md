...
description: Þessi grein útskýrir hvernig á að flytja inn nýja útgáfu af skilgreiningu rafrænnar skýrslugerðar úr Microsoft Dynamics Lifecycle Services (LCS).
author: kfend
ms.date: 06/17/2021
...
> [!NOTE]
> Ganga skal úr skugga um að núverandi notandi Dynamics 365 Finance sé aðili að LCS-verki sem inniheldur eignasafnið sem notandinn vill fá [aðgang](../../lifecycle-services/asset-library.md#asset-library-support) að til að flytja inn skilgreiningar rafrænnar skýrslugerðar.
>
