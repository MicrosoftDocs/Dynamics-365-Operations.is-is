...
description: Þessi grein lýsir því hvernig á að stilla rafrænt skýrslusnið til að telja og leggja saman byggt á gögnum um textaúttak sem þegar er búið til. (Hluti 4)
author: NickSelin
ms.date: 08/29/2018
