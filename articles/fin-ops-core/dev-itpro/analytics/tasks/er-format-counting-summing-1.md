...
description: Þessi grein lýsir því hvernig á að stilla rafrænt skýrslusnið til að telja og leggja saman byggt á gögnum um þegar myndaðan textaúttak. (Hluti 1)
author: kfend
ms.date: 08/29/2018
