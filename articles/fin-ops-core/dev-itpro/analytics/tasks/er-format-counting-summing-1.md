...
description: Þessi grein útskýrir hvernig á að skilgreina snið rafrænnar skýrslugerðar til að telja og gera samantekt sem byggist á gögnum fyrir þegar myndað úttak texta. (Hluti 1)
author: kfend
ms.date: 08/29/2018
