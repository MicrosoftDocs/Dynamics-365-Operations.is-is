...
description: Þessi grein lýsir því sem er innifalið í Sölu- og arðsemisframmistaða Power BI efni.
author: Henrikan
ms.date: 12/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9274660"
---
# <a name="sales-and-profitability-performance-power-bi-content"></a>Sölu- og arðsemisframmistaða Power BI efni

[!include [banner](../includes/banner.md)]

Þessi grein lýsir því hvað er innifalið í **Sölu- og arðsemisframmistöðu** Microsoft Power BI efnis. Það lýsir einnig hvernig eigi að fara í Power BI-skýrslur og veitir upplýsingar um gagnalíkan og einingar sem notaðar eru til að búa til efnið.
