...
description: Þessi grein listar PowerBI.com lausnir sem eru í boði og bendir þér á úrræði þar sem þú getur lært meira um lausnirnar.
author: sericks007
ms.date: 10/02/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8872912"
---
# <a name="power-bi-content-home-page"></a>Power BI efni – heimasíða

[!include [banner](../includes/banner.md)]

Eftirfarandi lausnir PowerBI.com eru í tiltækar fyrir forritaumhverfi.
...
> [!NOTE]
> Flestar lausnir PowerBI.com í eftirfarandi lista hafa verið innfelldar í greiningarvinnusvæði í nýlegum útgáfum. Notkun á greiningarvinnusvæðum útilokar nauðsyn þess að sækja þessar lausnir frá samnýtta eignasafninu í LCS. Efnisatriðin í þessum lista gefa til kynna hvar þessar lausnir PowerBI.com hafa verið innleiddar, þar sem við á.

- [Rauntölur bornar saman við fjárhagsáætlun](ledger-budgets-power-bi.md)
- [Yfirlit yfir reiðufé](../../../finance/cash-bank-management/Cash-Overview-Power-BI-content.md)
...
- [Skulda- og innheimtuumsjón](../../../finance/accounts-receivable/credit-collections-power-bi.md)
...
- [Eignastýring](../../../finance/fixed-assets/Fixed-asset-management-workspace.md)
...
- [Greiðslur lánardrottna](../../../finance/accounts-payable/Vendor-payments-workspace.md)
