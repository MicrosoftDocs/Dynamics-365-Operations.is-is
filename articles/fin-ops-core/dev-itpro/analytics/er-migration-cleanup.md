...
description: Í þessari grein er útskýrt hvernig hægt er að nota hreinsunaraðgerð fyrir flutning rafrænnar skýrslugerðar til að leysa úr málum er varða sniðmát rafrænnar skýrslugerðar.
author: kfend
ms.date: 04/29/2020
ms.topic: article
ms.prod: ''
