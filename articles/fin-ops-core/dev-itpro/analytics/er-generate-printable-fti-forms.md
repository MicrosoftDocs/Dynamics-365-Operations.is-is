...
description: Þessi grein útskýrir hvernig nota á ramma rafrænnar skýrslugerðar til að búa til prentvæn eyðublöð fyrir reikninga með frjálsum texta sem Microsoft Office skjöl.
author: kfend
ms.date: 07/24/2018
ms.topic: article
ms.prod: ''
...
Rammi rafrænnar skýrslugerðar leyfir þér að búa til prentvæn eyðublöð fyrir reikninga með frjálsum texta sem Microsoft Office skjöl. Þessi grein veitir upplýsingar um hvernig á að útbúa sínar eigin skilgreiningar sem og upplýsingar um tiltæk grunnstillingarsniðmát.
