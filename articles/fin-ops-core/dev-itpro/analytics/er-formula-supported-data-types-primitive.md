...
description: Þessi grein veitir upplýsingar um frumstæðu gagnagerðir sem eru studdar í formúlum fyrir rafrænar skýrslur (ER).
author: NickSelin
ms.date: 06/02/2021
...
Þessi grein veitir upplýsingar um frumstæðu gagnagerðir sem eru studdar í [Rafræn skýrsla (ER)](general-electronic-reporting.md) tjáningar. Hér er listi yfir frumstæðar gagnagerðir:
