...
description: Þessi grein veitir upplýsingar um hvernig á að stilla skjalasafn áfangastaðar fyrir hvern FOLDER- eða FILE-hluta á rafrænu skýrslugerðarsniði.
author: kfend
ms.date: 11/30/2020
ms.topic: article
ms.prod: ''
