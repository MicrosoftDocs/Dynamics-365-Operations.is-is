...
description: Þessi grein útskýrir hvernig á að hanna lausn rafrænnar skýrslugerðar til að prenta sérsniðna skýrslu.
author: kfend
ms.date: 08/10/2020
ms.topic: article
ms.prod: ''
...
Stofna þarf nýja skilgreiningu rafrænnar skýrslugerðar sem inniheldur gagnalíkan íhlut fyrir fyrirtækislénið **Spurningalisti**. Þetta gagnalíkan verður seinna notað sem gagnagjafi þegar hannað er snið rafrænnar skýrslugerðar til að búa til skýrsluna **Spurningalisti**.
...
Sem notandi í hönnunarhlutverki rafrænnar skýrslugerðar þarf að stofna nýja skilgreiningu rafrænnar skýrslugerðar sem inniheldur íhlut líkanavörpunar fyrir gagnalíkanið **Spurningalisti**. Vegna þess að þessi íhlutur innleiðir skilgreint gagnalíkan fyrir Finance, á hann sérstaklega við um Finance. Skilgreina verður íhlut líkanavörpunar til að tilgreina hugbúnaðarhluti sem þarf að nota til að fylla út skilgreint gagnalíkan með forritsgögnum við keyrslu. Til að ljúka þessu verki þarf að gera sér grein fyrir upplýsingum innleiðingar fyrir gagnaskipulagið á fyrirtækisléninu **Spurningalisti** í Finance.
