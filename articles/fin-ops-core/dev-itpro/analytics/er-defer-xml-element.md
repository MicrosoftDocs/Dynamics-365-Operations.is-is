...
description: Þessi grein útskýrir hvernig á að fresta framkvæmd XML-þáttar á ER-sniði
author: kfend
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
...
Hægt er að framkvæma þessi skref í fyrirtækinu **USMF** í Microsoft Dynamics 365 Finance.
...
Ef þú hefur ekki enn lokið við dæmið í greininni [Fresta keyrslu raðeininga í sniði rafrænnar skýrslugerðar](er-defer-sequence-element.md#Example) skaltu hlaða niður eftirfarandi [skilgreiningum](general-electronic-reporting.md#Configuration) á sýnilausn rafrænnar skýrslugerðar.
