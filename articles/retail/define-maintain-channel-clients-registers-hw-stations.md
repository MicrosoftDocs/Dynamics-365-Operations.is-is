...
Fletting: Smellt er á **Smásölu** &gt; **miðlunarleiðir** &gt; **smásöluverslanir** &gt; **Allar smásöluverslanir**. Veljið verslun og smellið svo á flipann **vélbúnaðarstöðvar**.
...
>
> Sölukerfi í skýinu verður að nota sjálfstæða vélbúnaðarstöð til samskipta við jaðartæki í smásölu.
