...
Farðu í **Smásala** \> **Vörulistar og vöruúrval** \> **Allir vörulistar** til að grunnstilla vörulistann þinn.
...
Til að bæta vöru við vörulista þarf yfirlitsstigveldi að vera valið. Yfirlitsstigveldið mun styðja við skipan flokkanna fyrir vörulistann. Þú verður að velja úr einu af yfirlitsstigveldunum sem tengjast smásölurásunum sem eru valdar á **Smásölurás** flýtiflipanum á **Vörulisti** síðunni. Ef yfirlitsrás var ekki tengd við rás áður skal fara í **Smásala** \> **Rásaruppsetning** \> **Rásarflokkar og afurðareigindir** til að tengja sjálfgildi yfirlitsstigveldis við sérhverja smásölurás þína.
