...
description: Þetta efnisatriði lýsir því hvernig á að vinna með biðstöðu pantana með því að nota Dynamics 365 Retail.
author: josaw1
manager: AnnBe
ms.date: 05/14/2018
ms.topic: article
...
ms.locfileid: "2018367"
---
# <a name="configure-and-work-with-call-center-order-holds"></a>Skilgreina og vinna með símaverspantanir í bið

[!include [banner](includes/banner.md)]

Þetta efnisatriði lýsir eiginleikum fyrir pantanir í bið sem Dynamics 365 Retail er með fyrir símaverspantanir.
