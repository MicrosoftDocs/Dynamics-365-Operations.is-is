...
Til að kveikja á handvirku samþykki fyrir pöntunarlínur skal fara í **Retail** \> **Rásir** \> **Smásöluverslanir** \> **Allar smásöluverslanir**. Veldu verslunina og smelltu á kenni verslunar til að skoða upplýsingar um verslunina. Smellið á **Breyta**. Á **Almennt** flýtiflipanum skaltu finna **Pöntunaruppfylling** undirhausinn og breyta **Handvirkt samþykki** frá **Nei** til **Já**.
