...
- **Samþætting rafrænna viðskipta:** Samþætting við smásölu er nauðsynleg til að styðja atburðarásir þar sem pöntunin á upptök sín í netverslun. Nánari upplýsingar um SDK-rafræn viðskipti í Retail skal sjá [Þróunartól hugbúnaðar (SDK) fyrir verkvang rafrænna viðskipta](https://docs.microsoft.com/dynamics365/unified-operations/retail/dev-itpro/ecommerce-platform-sdk). Í sýniútgáfuumhverfi styður tilvísun netverslunar atburðarásir fyrir greiðslu omni-rásar. 
...
- **Skilgreining á greiðslum omni-rásar:** í bakvinnslunni skal opna **Smásala \> Uppsetning höfuðstöðva \> Færibreytur \> Samnýttar smásölufæribreytur**. Síðan, í flipanum **Greiðslur á omni-rás**, skal stilla valkostinn **Nota greiðslur á omni-rás** á **Já**.
...
- Valkosturinn **Greiðslur á Omni-rás** á síðunni **Samnýttar smásölufæribreytur** er stilltur á **Satt**.
...
3. Í smásölu skal nota runuvinnsluna **Samstilla pantanir** og dreifingaráætlunina **P-001** til að stofna pöntun í bakvinnslunni.
...
1. Í Retail, á síðunni **Notendaþjónusta**, skal færa **Karen Berg** inn í leitarstikuna og síðan velja **Leita**. 
