...
description: Þessi grein lýsir því hvernig á að setja upp strikamerkjastafi, strikamerkisgrímur og hvernig á að úthluta strikamerkisgrímum á strikamerki.
author: BrianShook
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8853713"
---
# <a name="set-up-bar-code-masks"></a>Setja upp sniðmát fyrir strikamerki

[!include [banner](includes/banner.md)]

Þessi grein lýsir því hvernig á að setja upp strikamerkjastafi, strikamerkisgrímur og hvernig á að úthluta strikamerkisgrímum á strikamerki.
