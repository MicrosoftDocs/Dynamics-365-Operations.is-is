...
Þetta efnisatriði lýsir því hvernig á að tengja tilraunina í Commerce og gera breytingar á afbrigðum þannig að þau samræmist tilgátunni. Eftirfarandi skýringarmynd sýnir öll skrefin sem taka þátt í uppsetningu og vinnslu á tilraun á vefsvæði rafrænna viðskipta í Dynamics 365 Commerce. Önnur skref eru afgreidd í aðskildum efnisatriðum.
...
1. Til að ræsa leiðsagnarforritið skal velja flipann **Tilraunir** í vefsmiðnum og síðan velja **Tengja**. Að öðrum kosti er hægt að opna leiðsagnarforritið í gegnum ritil síðu eða brots. Í breytingastillingu skal velja **Tengja tilraun** í skipanastikunni.
