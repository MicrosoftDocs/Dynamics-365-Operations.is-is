...
description: Þessi grein lýsir tilboðsbundinni afsláttarvirkni sem gerir smásöluaðilum kleift að stilla afslátt fyrir tilteknar tilboðsgerðir í Microsoft Dynamics 365 Commerce.
author: bebeale
ms.date: 08/19/2022
ms.topic: article
...
ms.locfileid: "9473782"
---
# <a name="tender-based-discount"></a>Útboðsbundinn afsláttur

[!include [banner](includes/banner.md)]

Þessi grein lýsir tilboðsbundinni afsláttarvirkni sem gerir smásöluaðilum kleift að stilla afslátt fyrir tilteknar tilboðsgerðir í Microsoft Dynamics 365 Commerce.
...
Ef útboðsbundinn afsláttur er settur upp fyrir reiðufé og gjaldkeri á sölustað (POS) velur **Borga reiðufé** hnappinn til að tékka á reiðufé og bera færslu, er tilboðsbundinn afsláttur sjálfkrafa settur á færsluna. Minni upphæðin er síðan sýnd sem staða. Hins vegar, ef gjaldkerinn velur hnappinn **Til baka** á greiðsluskjánum er afslátturinn fjarlægður og upphafleg upphæð er sýnd á viðskiptaskjánum. Útboðsbundinn afsláttur er fjarlægður ef greiðslulínan er ógild.
