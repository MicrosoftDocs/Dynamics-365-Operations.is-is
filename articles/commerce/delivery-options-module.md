...
> [!NOTE]
> Þú gætir fundið fyrir ósamræmdri afhendingu meðhöndlunar, eða þú gætir ekki séð gjöld sem ekki eru hlutfallsleg á hausstigi á rafrænu viðskiptarásinni þinni. Fyrir leiðbeiningar um hvernig eigi að laga þessi vandamál, sjá [Virkjaðu samræmda afhendingarham meðhöndlun í rafrænum viðskiptarásum](consistent-delivery-mode-handling.md).
