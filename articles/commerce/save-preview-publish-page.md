...
description: Þessi grein lýsir því hvernig á að vista, forskoða og birta síðu í Microsoft Dynamics 365 Commerce.
author: psimolin
ms.date: 04/14/2020
ms.topic: article
ms.prod: ''
...
## <a name="save-preview-and-publish-a-home-page"></a>Vista, forskoða og birta heimasíðu
...
## <a name="publish-a-url"></a>Birta slóð

Til að birta vefslóð skal fylgja þessum skrefum.

1. Undir **Svæði** velurðu **Fabrikam** (eða heiti svæðisins).
1. Í stýriglugganum vinstra megin velurðu **Vefslóðir**.
1. Finna og velja vefslóðina sem á að birta.
1. Á skipanastikunni velurðu **Birta**.
