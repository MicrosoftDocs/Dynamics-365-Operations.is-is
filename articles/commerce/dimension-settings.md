...
description: Þessi grein fjallar um skjástillingar fyrir vörustærðir og lýsir því hvernig eigi að nota þær í Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/28/2021
ms.topic: article
ms.prod: ''
...
Þessi grein fjallar um skjástillingar fyrir vörustærðir og lýsir því hvernig eigi að nota þær í Microsoft Dynamics 365 Commerce.
