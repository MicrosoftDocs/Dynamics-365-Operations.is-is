...
Til að flytja einkunna- og umsagnargögn úr núverandi kerfi inn í Commerce, verður þú að bæta Dynamics 365 Ratings and Review Power Automate tengi við annað hvort núverandi Power Automate flæði eða nýtt. Fyrir frekari upplýsingar, sjá [Dynamics 365 Commerce - Einkunnir og umsagnir (Forskoðun)](/connectors/dynamics365ratingsre/).
