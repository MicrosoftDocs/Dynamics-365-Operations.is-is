...
description: Þessi grein fjallar um pöntunarstaðfestingareiningar og lýsir því hvernig á að nota þær í Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9269136"
---
# <a name="order-confirmation-module"></a>Eining pöntunarstaðfestingar

[!include [banner](includes/banner.md)]

Þessi grein fjallar um pöntunarstaðfestingareiningar og lýsir því hvernig á að nota þær í Microsoft Dynamics 365 Commerce.
...
1. Í **Nýtt sniðmát** svargluggi, undir **Nafn sniðmáts**, sláðu inn nafnið **Sniðmát til staðfestingar pöntunar**, og veldu síðan **Allt í lagi**.
...
1. Undir **Veldu sniðmát**, veldu **Sniðmát til staðfestingar pöntunar**, og veldu síðan **Næst**.
