...
Söluaðilar geta einnig notað athugasemdir til að afla almennra viðskiptavinaupplýsinga sem vísa má í á undan hverjum samskiptum. Þessar athugasemdir eru vistaðar í Headquarters og hægt er að skoða þær á viðskiptavinasniði eða á upplýsingasíðu viðskiptavinar í símaverinu.
...
Til að kveikja á samþættingu Customer Insights við Commerce verður þú að ganga úr skugga um að þú sért með virkt tilvik af Customer Insights í leigjanda þar sem Commerce er veitt. Þú verður líka að hafa Azure Active Directory (Azure AD) notendareikning sem er með Azure áskrift.
...
- **Biðlari lyklageymslu**: „KeyVault_Access_AppID“ (úr skrefi 5 hér að ofan).
- **Leynilykill lyklageymslu**: „KeyVault_Access_Secret“ (úr skrefi 5 hér að ofan).
