...
description: Þessi grein lýsir því hvernig hægt er að skila vörum á mörgum pöntunum viðskiptavinar og reikningum í Dynamics 365 Commerce.
author: josaw1
ms.date: 08/27/2020
ms.topic: index-page
ms.prod: ''
...
Hægt er að framkvæma vöruskil fyrir margar pantanir og reikninga. 

## <a name="configure-commerce-to-support-returns-across-multiple-customer-order-and-invoices"></a>Grunnstilla viðskipti til að styðja við vöruskil á mörgum pöntunum og reikningum viðskiptavinar

1. Opnið **viðskiptafæribreytur \> pantanir viðskiptavinar**.
