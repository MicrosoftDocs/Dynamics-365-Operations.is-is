---
title: Körfueining
description: Þessi grein fjallar um körfueiningar og lýsir því hvernig á að bæta þeim við vefsíður í Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8866057"
---
# <a name="cart-module"></a>Körfueining

[!include [banner](includes/banner.md)]

Þessi grein fjallar um körfueiningar og lýsir því hvernig á að bæta þeim við vefsíður í Microsoft Dynamics 365 Commerce.
...
1. Í **Veldu brot** valmynd, veldu **Karfa** mát.
...
1. Í **Karfa** rauf, veldu sporbaug (**...**), og veldu síðan **Bæta við einingu**.
