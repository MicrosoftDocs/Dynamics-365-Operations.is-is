...
description: Þetta efnisatriði fjallar um myndlistaeiningar og útskýrir hvernig á að bæta þeim við síður svæða í Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 07/08/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "6638831"
---
# <a name="image-list-module"></a>Myndalistaeining

[!include [banner](includes/banner.md)]

Þetta efnisatriði fjallar um myndlistaeiningar og útskýrir hvernig á að bæta þeim við síður svæða í Microsoft Dynamics 365 Commerce.
...
1. Í glugganum **Bæta við einingu** skal velja eininguna **Myndalisti** og síðan velja **Í lagi**.
...
1. Í glugganum **Bæta við einingu** skal velja **Myndalisti** og síðan velja **Í lagi**.
