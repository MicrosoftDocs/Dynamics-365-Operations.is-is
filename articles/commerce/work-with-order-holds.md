...
description: Þessi grein lýsir því hvernig á að vinna með bið á pöntunum með því að nota Dynamics 365 Commerce.
author: josaw1
ms.date: 05/14/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8860138"
---
# <a name="configure-and-work-with-call-center-order-holds"></a>Skilgreina og vinna með símaverspantanir í bið

[!include [banner](includes/banner.md)]

Þessi grein lýsir pöntunarhaldseiginleikum sem Dynamics 365 Commerce hefur fyrir pantanir í símaveri.
