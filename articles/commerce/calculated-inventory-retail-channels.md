...
description: Þessi grein lýsir því hvernig fyrirtæki getur notað Microsoft Dynamics 365 Commerce til að skoða áætlað framboð á vörum í net- og verslunarrásum.
author: hhainesms
ms.date: 09/01/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9279682"
---
# <a name="calculate-inventory-availability-for-retail-channels"></a>Reikna tiltækar birgðir fyrir smásölurásir

[!include [banner](../includes/banner.md)]

Þessi grein lýsir því hvernig fyrirtæki getur notað Microsoft Dynamics 365 Commerce til að skoða áætlað framboð á vörum í net- og verslunarrásum.
