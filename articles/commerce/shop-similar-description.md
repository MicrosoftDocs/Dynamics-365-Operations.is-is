---
title: Virkjaðu ""verslun svipaða lýsingu"" ráðleggingar
description: Þessi grein lýsir því hvernig á að virkja ""verslun svipað lýsing"" vöruráðleggingar í Microsoft Dynamics 365 Commerce.
author: bebeale
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9274979"
---
# <a name="enable-shop-similar-description-recommendations"></a>Virkja ráðleggingar um „versla svipaða lýsingu“

[!include [banner](includes/banner.md)]

Þessi grein lýsir því hvernig á að virkja vöruráðleggingar um „verslaðu svipaða lýsingu“ í Microsoft Dynamics 365 Commerce.
