...
description: Þessi grein lýsir því hvernig á að bæta höfundarréttartilkynningu við rafræn viðskipti vefsvæðið þitt.
author: josaw1
ms.date: 10/16/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9270456"
---
# <a name="add-a-copyright-notice"></a>Bæta við yfirlýsingu um höfundarrétt

[!include [banner](includes/banner.md)]

Þessi grein lýsir því hvernig á að bæta höfundarréttartilkynningu við rafræn viðskipti vefsvæðið þitt.
