---
title: Hólfeining
description: Þessi grein fjallar um gámaeiningar og lýsir því hvernig á að bæta þeim við vefsíður í Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8867841"
---
# <a name="container-module"></a>Hólfeining

[!include [banner](includes/banner.md)]

Þessi grein fjallar um gámaeiningar og lýsir því hvernig á að bæta þeim við vefsíður í Microsoft Dynamics 365 Commerce.
...
1. Í **Nýtt sniðmát** svargluggi, undir **Nafn sniðmáts**, koma inn **Gámasniðmát**, og veldu síðan **Allt í lagi**.
...
1. Í **Búðu til nýja síðu** svargluggi, undir **Nafn síðu**, koma inn **Gámasíða**, og veldu síðan **Næst**.
1. Undir **Veldu sniðmát**, veldu **Gámasniðmát** sem þú bjóst til og veldu síðan **Næst**.
