...
description: Þessi grein útskýrir lykilmuninn á Store Commerce og Cloud POS og lýsir ýmsum þáttum sem smásalar sem innleiða Dynamics 365 Commerce ætti að íhuga að hjálpa þeim að gera besta valið fyrir kröfur þeirra.
author: josaw1
ms.date: 04/21/2022
ms.topic: article
ms.prod: ''
