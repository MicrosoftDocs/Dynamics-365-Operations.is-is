...
Notaðu **Stilla innfelld Microsoft PowerApps** síðu til að forstilla Talent síður til að opna PowerApps forrit. Til að opna **Stilla innfelld Microsoft PowerApps** síðuna skaltu opna **Kerfisstjórnun** vinnusvæði og opna síðan flipann **Tenglar**. Veldu **Microsoft PowerApps** úr **Uppsetning** hópnum. 

Eftirfarandi upplýsingar eru færðar inn eða stilltar á þessari síðu: 
...
Þú getur einnig tilgreint hvaða lögaðilar forritið verður í boði fyrir, eða þú getur gert það aðgengilegt öllum lögaðilum þínum. Sjálfgefið er að PowerApps forritin þín eru í boði fyrir alla lögaðila.

## <a name="opening-an-application"></a>Opna forrit
Þegar þú hefur forstillt innfellt PowerApps forrit, verður tenglum á forritin sem þú tilgreindir bætt við síðurnar innan Talent. Smella á tengil til að opna forrit. 
