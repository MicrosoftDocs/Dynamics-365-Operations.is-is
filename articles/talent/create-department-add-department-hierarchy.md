...
Sjá efnisatriðið [Skilgreina nýjar deildir](../fin-and-ops/hr/tasks/define-new-departments.md) fyrir skref fyrir skref aðferð til að búa til nýja deild. 
