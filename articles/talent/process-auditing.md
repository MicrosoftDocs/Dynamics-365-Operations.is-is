...
Þú getur skoðað gögnin sem fylgst með í Power BI með því að nota OData tengið. Frekari upplýsingar er að finna í [Tengjast við OData straum í Power BI Desktop](https://docs.microsoft.com/en-us/power-bi/desktop-connect-odata).
