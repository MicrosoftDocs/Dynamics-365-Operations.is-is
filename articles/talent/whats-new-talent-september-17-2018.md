...
## <a name="leave-and-absence--accrue-time-based-on-hours-worked"></a>Leyfi og fjarvistir - Uppsöfnun tíma sem byggist á vinnustundum
...
## <a name="platform-update-18-for-finance-and-operations"></a>Uppfærsla 18 fyrir verkvang fyrir Finance and Operations
...
-   Í verkvangsuppfærslu 18 fyrir Finance and Operations stillir Talent-vefbiðlarinn nú myndefni sitt við Microsoft Fluent Design.
    ...
    -   Breytingar á því hvernig reitir birtast þegar þeir eru lestrarstillingu.

    -   Fyrirsagnir í vinnusvæðum og síðum eru feitletraðar.

-   Hegðun óútskiptanlegra uppflettinga hefur verið bætt. Nánari upplýsingar er að finna í [Endurbætur á hegðun fyrir óútskiptanlegar flettingar](https://docs.microsoft.com/business-applications-release-notes/October18/dynamics365-finance-operations/non-replacing-lookups).
