...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-june-18-2019"></a>Nýjungar eða breytingar í Dynamics 365 Talent (18. júní 2019)
...
Breytingunum sem er lýst í þessum hluta eiga við um smíðarnúmer 8.1.2347.

### <a name="confirmation-of-course-participants-causes-an-error"></a>Staðfesting þátttakenda í námskeiðinu veldur villu

Valmyndin fyrir prentun skýrslunnar um þátttakendur í námskeiðinu hefur verið fjarlægð. Þessi skýrsla er ekki studd í Talent.

### <a name="the-compensation-section-of-the-transfer-worker-page-isnt-available-in-some-scenarios"></a>Bótahlutinn á síðunni Flytja starfskraft er ekki tiltæk í sumum aðstæðum

Þessi breyting gerir notendum kleift að slá inn bætur þegar þeir fylla út síðuna **Flytja starfskraft**.
...
Eftirfarandi einindi munu styðja sérsniðna reitir: Launatekjukóði og Tilvísunarpunktur launa. 

### <a name="new-common-data-service-entities"></a>Ný Common Data Service eining

Einindi ástæðukóða verður bætt við Common Data Service.
