...
-   [Flettingaleit](../fin-and-ops/get-started/navigation-search.md) - Þetta efnisatriði útskýrir hvernig skuli nota leitarvirknina til að fara inn á síður. Talent felur í sér fjölda svæða og síður til að hjálpa þér að framkvæma ýmis verk. Til að finna fljótt þær síður sem þú þarft til að ljúka verkefnum þínum skaltu nota eiginleikann flettingaleit. 
...
Hægt er að finna skoðanir, fréttir og aðrar upplýsingar um viðskiptaskuldir og aðrar lausnir á [Dynamics 365 Talent](https://community.dynamics.com/enterprise/b/dynamics365fortalent). 
