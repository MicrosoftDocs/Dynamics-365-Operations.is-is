...
ms.locfileid: "2898504"
---
# <a name="troubleshoot-integration-with-linkedin-and-attract"></a>Úrræðaleita samþættingu við LinkedIn og Attract
...
Ef þú ert í vandræðum með að skrá þig inn á LinkedIn úr Attract skaltu prófa þessi skref:

1. Staðfestu að aðgangsupplýsingarnar fyrir LinkedIn sem þú slóst inn í Attract séu réttar og í gildi.
2. Ef upplýsingarnar eru enn í gildi og réttar skaltu hafa samband við [Notendaþjónusta LinkedIn](https://www.linkedin.com/help/linkedin).
3. Ef vandamálið er viðvarandi skaltu hafa samband við [Notendaþjónusta Microsoft](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Starfsauglýsingar úr Attract birtast ekki á LinkedIn
