...
<td>Merkin á skjámyndum <strong>InventPosting</strong>, <strong>Resource</strong>, <strong>ResourceGroup</strong> og <strong>ProductionGroup</strong> eru ekki alltaf samstilltar við merkin <strong>LedgerPostingType</strong> sem eru raunverulega notuð. Ekki er auðvelt að skilja orðalistann sem notaður er í merkjunum.</td>
...
|                                                                                                              |                                                                                                                                                                                                    |                                                                                                                                                                                                                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|--------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                      <strong>Hvað hægt er að gera?</strong>                                       |                                                                                 <strong>Dynamics AX 2012</strong>                                                                                  |                                                                                                <strong>Dynamics AX 7.0</strong>                                                                                                |                                                                                                                                                                                                                                                                               <strong>Hví er þetta mikilvægt?</strong>                                                                                                                                                                                                                                                                                |
...
|                                       Samþætting með Microsoft Office.                                       |                                                                                           Ekki tiltækt                                                                                            |                                              Ný geta er m.a. Excel Data Connector forritið, <strong>Vinnubókarhönnuður</strong> síðan, Flytja út API og skjalastjórnun.                                              |                                                                                                                                                                                                                                                                      Hægt er að stofna framleiðnilausnir fyrir endanotendur þína.                                                                                                                                                                                                                                                                       |
...
<td>Það er auðveldara að fá aðgang að mikilvægum upplýsingum þegar lykilskipulag er skilgreint og breytt.</td>
</tr>
<tr class="even">
...
<td> Það er auðveldara að fá aðgang að mikilvægum upplýsingum þegar bókhaldslykill er skilgreindur og úthlutaður.</td>
</tr>
<tr class="odd">
...
<td>Prentun skýrslu myndi nota prentvalkosti vafrans til að prenta og prenta aðeins það sem notandinn getur séð á skjánum. </td>
...
<td>Greina fjárhagsleg gögn með því að nota „Fylgjast með fjárhagslegri frammistöðu“ (Monitor financial performance) efni fyrir PowerBI.</td>
<td>Ekki tiltækt</td>
...
<td>Hægt er að nota ný verkskráning beint úr vefbiðlara. Aðgangur að verkskráningu krefst ekki kerfisstjóraréttinda. Skráð skref er hægt að skoða í beinni á meðan verið er að skrá, ný breytingavalkostir hafa verið innleiddur, og verkskráning styður fleiri aðstæður auk fyrirliggjandi viðskiptaferlavinnslu (BPM) aðstæður.</td>
...
<td>Hún veitir síað yfirlit yfir starfsmenn sem eru ráðnir í fyrirtækinu sem maður er innskráður í. Fyrir ósíað yfirlit yfir alla starfsmenn og verktaka, þá er starfsmannalistinn enn tiltækur. Í núverandi útgáfu af Dynamics AX, breytir kerfið ekki fyrirtæki á grundvelli starfsmanns sem er valinn í listanum.</td>
</tr>
<tr class="odd">
...
<td>Rafræn skjöl eru harðkóðuð í X ++ eða sem Extensible Stylesheet Language Transformations (Xslt). Allar leiðréttingar sniðs krefjast þróunarvinna . Aðgangur að gögnum og sniði er ekki einangrað. Uppsetning Leiðrétts sniðs krefst nýrri Microsoft Dynamics AX bráðabótarpakka sem hnekkir fyrirliggjandi sniði. Sérstillt breytingar á hverju sniði verður að tengja handvirkt við upprunakóða nýrrar Microsoft Dynamics AX bráðabótarpakka .</td>
...
|                                                                                                                                                                   |                                                                                                                                                |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
|                                                                 <strong>Hvað hægt er að gera?</strong>                                                                 |                                                       <strong>Dynamics AX 2012</strong>                                                        |
| Framkvæma athugun á efnisframboð fyrir framleiðslupantanir á sérstakri síðu sem er opnuð í <strong>Stjórnun á framleiðslugólfi</strong> vinnusvæði. |                                                                 Ekki tiltækt                                                                  |
|                               Byrjaðu og skrifaðu skýrslu um framleiðsluverk með því að nota nýju síðuna <strong>Verkspjaldstæki</strong>.                                | <strong>Starfsskráning</strong>skjámynd er aðallega ætlað fyrir stóra skjái á afgreiðslustöðvar og Notendaviðmóti eru yfirleitt opnuð með músarsmellum. |
...
<ul>
<li>Stjórna starfskröftum og heimildum starfskrafta á sölustað (POS).</li>
...
<tr class="odd">
<td>Greina sölugögn smásölurásar með því að nota „Fylgjast með frammistöðu smásölurásar“ efni fyrir Power BI.</td>
<td>Ekki tiltækt</td>
...
<td>E-commerce API er ekki studdur gegnum Retail-þjón.</td>
...
Til staðar er bætt "lágsnertingar" uppsetning íhlutar með sjálfsafgreiðsluuppsetningu:
<ul>
...
<td>Þessi aðgerð krefst <a href="http://www.microsoft.com/en-us/download/details.aspx?id=42636">System Center 2012 Management Pack fyrir Microsoft Dynamics AX 2012 R3 CU8 Retail</a>.</td>
