...
Þennan eiginleika er hægt að nota til að staðfesta hvort aðgerð hafi átt sér stað. Til dæmis, þegar framleiðslufyrirmæli er búið til, áætlað og síðan byrjað, Microsoft Dynamics 365 for Finance and Operations Sýnir "Production - Start" skilaboð til að tilkynna þér að framleiðslufyrirmæli hafi verið hafin.
...
Þegar prófunardæmið hefur verið keyrt eru skilaboðin í Excel-færibreytuskránni borin saman við skilaboðin sem birtast í Finance and Operations. Ef skilaboðin stemma ekki mun prófunardæmið ekki takast.
