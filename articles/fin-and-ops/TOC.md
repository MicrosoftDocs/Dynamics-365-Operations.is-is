...
##### [Microsoft FastTrack fyrir Dynamics 365](get-started/fasttrack-dynamics-365-overview.md)
...
#### [Sérstillt svæði](get-started/user-defined-fields.md)
...
#### Útreikningur uppskrifta með kostnaðarskjali (spila verkleiðbeiningar í röð)
...
### Staðalkostnaður
#### [Forsendur fyrir staðalkostnaði](../supply-chain/cost-management/prerequisites-standard-costs.md)
...
#### [Undirbúa viðhald staðalkostnaðar fyrir framleiddar vörur](../supply-chain/cost-management/prepare-maintain-standard-costs-manufactured-items.md)
### Power BI-efnispakki
...
##### [Skilgreiningargagnapakkar (aðeins útgáfa í júlí 2017)](../dev-itpro/data-entities/configuration-data-packages.md)
...
#### [Finna upplýsingar um staðlaðar gagnaeiningar](../dev-itpro/data-entities/data-entities-report.md)
...
##### [NF-e vottorð](../financials/localizations/latam-bra-nfe-certs.md)
...
##### [CFDI útgáfa 3.3](../financials/localizations/latam-mex-cfdi-3-3.md)
...
#### [Fjármálainnsýn](../dev-itpro/analytics/financial-insights.md)
...
##### [Skilgreina líkanavörpun og velja gagnaveitur fyrir rafræna skýrslugerð](../dev-itpro/analytics/tasks/er-define-model-mapping-select-data-sources-2016-11.md)
##### [Varpa gagnalíkani á valdar gagnaveitur fyrir rafræna skýrslugerð](../dev-itpro/analytics/tasks/er-map-data-model-selected-data-sources-2016-11.md)
##### [Stofna skilgreiningu sniðs fyrir rafræna skýrslugerð](../dev-itpro/analytics/tasks/er-format-configuration-2016-11.md)
...
#### [Breyta sniði með því að endurnýta Microsoft Excel-sniðmát fyrir rafræna skýrslugerð](../dev-itpro/analytics/tasks/er-modify-format-by-reapplying-microsoft-excel-template-july-2017.md)
...
##### [Hanna gagnalíkan til að nota fjárhagsvíddir sem gagnaveitu í rafrænni skýrslugerð](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-1.md)
...
##### [Stofna snið fyrir talningu og samlagningu í rafrænni skýrslugerð](../dev-itpro/analytics/tasks/er-format-counting-summing-1.md)
...
##### [Keyra snið sem notar svæði sem hægt er að stækka lárétt til að bæta sjálfkrafa við dálkum í Excel-skýrslum fyrir rafræna skýrslugerð](../dev-itpro/analytics/tasks/er-horizontal-2.md)
...
##### [Hanna skilgreiningar til að mynda skýrslur á Microsoft Office-sniði með innfelldum myndum fyrir rafræna skýrslugerð (ER) (hluti 1) ](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md)
...
#### [Þátta móttekin skjöl til að uppfæra forritsgögn](../dev-itpro/analytics/parse-incoming-electronic-documents.md)
#### [Þátta móttekin skjöl á CSV-sniði](../dev-itpro/analytics/parse-incoming-electronic-documents-csv-format.md)

##### [Breytingar á API rafræns skýrslugerðarramma fyrir Application update 7.3](../dev-itpro/analytics/er-apis-app73.md)
...
##### [Gantt-línurit fyrir vinnsluröðun](../supply-chain/production-control/visual-scheduling-production.md)
...
##### [Leysisstefna fyrir afurðarafbrigði](../supply-chain/pim/solver-strategy-product-configuration.md)
...
#### [Microsoft Project biðlarasamþætting](../financials/project-management/project-integration.md)
