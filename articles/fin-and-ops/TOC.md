...
#### [Skoða stöðu kostnaðarhlutar (verkleiðbeiningar)](../supply-chain/cost-management/tasks/view-cost-object-balance.md)
#### [Skoða birgðayfirlit og afkastavísi eftir kostnaðarhlut (verkleiðbeiningar)](../supply-chain/cost-management/tasks/view-inventory-statement-kpi-cost-object.md)
#### [Kostnaðarfærsla](../supply-chain/cost-management/cost-entries.md)
#### [Skoða kostnaðarfærslur fyrir kostnaðarhlut (verkleiðbeiningar)](../supply-chain/cost-management/tasks/view-cost-entries-cost-object.md)
...
#### [Taka efnislegt virði með](../supply-chain/cost-management/include-physical-value.md)
...
#### [Skoða núverandi VÍV-stöðu framleiðslupöntunar (verkleiðbeiningar)](../supply-chain/cost-management/tasks/view-current-wip-status-production-order.md)
#### [Bera saman virkan, áætlaðan og innleystan kostnað í framleiðslupöntun (verkleiðbeiningar)](../supply-chain/cost-management/tasks/compare-active-estimated-realized-costs.md)
...
#### Útreikningur uppskrifta með kostnaðarskjali (verkleiðbeiningar í röð fyrir hvítbók)
##### [Stofna tilbúna afurð (aðeins febrúar 2016)](../supply-chain/cost-management/tasks/create-finished-product-2016-02.md)
##### [Stofna hálftilbúna afurð (aðeins febrúar 2016)](../supply-chain/cost-management/tasks/create-semi-finished-product-2016-02.md)
##### [Stofna hráefni (aðeins febrúar 2016)](../supply-chain/cost-management/tasks/create-raw-materials-2016-02.md)
##### [Stofna uppskriftir (aðeins febrúar 2016)](../supply-chain/cost-management/tasks/create-boms-2016-02.md)
##### [Stofna leiðir (aðeins febrúar 2016)](../supply-chain/cost-management/tasks/create-routes-2016-02.md)
...
### [Inn- og útflutningsverk gagna](../dev-itpro/data-entities/data-import-export-job.md)
...
#### [Sérstilla App Suite skýrslur með viðbótum](../dev-itpro/analytics/customize-app-suite-reports-with-extensions.md)
#### [Útvíkka Application Suite gagnasöfn skýrslu](../dev-itpro/analytics/expand-app-suite-report-data-sets.md)
#### [Valmyndaratriði skýrslu stækkuð](../dev-itpro/analytics/extend-report-menu-items.md)
...
### [Setja upp komuyfirlitsreglur (verkleiðbeiningar)](../supply-chain/inventory/tasks/set-up-item-arrival-overview-profile.md)
...
### [Setja upp forsendur fyrir stjórnun (verkefnaleiðbeiningar)](../supply-chain/inventory/tasks/set-up-prerequisites-nonconformance-management.md)
### [Stofna og vinna úr samræmi (verkefnaleiðbeiningar)](../supply-chain/inventory/tasks/create-process-non-conformance.md)
### [Biðgeymslupöntun](../supply-chain/inventory/quarantine-orders.md)
### [Setja upp gæðapantanir (verkefnaleiðbeiningar)](../supply-chain/inventory/tasks/set-up-quality-orders.md)
### [Skoða gæði vara (verkleiðbeiningar)](../supply-chain/inventory/tasks/inspect-quality-goods.md)
### [Birgðalæsing](../supply-chain/inventory/inventory-blocking.md)
...
### [Búa til nýtt útlit vöruhús (verkleiðbeiningar)](../supply-chain/inventory/tasks/create-new-warehouse-layout.md)
...
### [Uppsetning vörusendingar](../supply-chain/inventory/consignment.md)
...
### [Leiðrétta rakningarupplýsingar birgða (verkleiðbeiningar)](../supply-chain/inventory/tasks/correct-inventory-tracking-information.md)
...
### [Útleiðarferli](../supply-chain/inventory/outbound-process.md)
...
### [Bilanagreining Office-samþættingar](../dev-itpro/office-integration/office-integration-troubleshooting.md)
...
## [Framleiðsla](../supply-chain/production-control/production-process-overview.md)
...
##### [Framleiðslubókun](../supply-chain/cost-management/production-posting.md)
#### Afmörkuð framleiðsluverk
##### [Skilgreina afmarkaða tilfangaflokka framleiðslu (verkleiðbeiningar)](../supply-chain/production-control/tasks/define-discrete-manufacturing-resource-group.md)
##### [Bæta fyrirliggjandi verkþætti við útgáfu framleiðsluflæðis (verkleiðbeiningar)](../supply-chain/production-control/tasks/add-existing-activity-production-flow-version.md)
##### [Gera útgáfu framleiðsluflæðis óvirka (verkleiðbeiningar)](../supply-chain/production-control/tasks/deactivate-production-flow-version.md)
##### [Skilgreina lokadag fyrir útgáfu framleiðsluflæðis (verkleiðbeiningar)](../supply-chain/production-control/tasks/define-expiry-date-production-flow-version.md)
##### [Skilgreina líkön framleiðsluflæðis (verkleiðbeiningar)](../supply-chain/production-control/tasks/define-production-flow-models.md)
##### [Stofna eiginleika áætlunargerðar vinnutíma (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-working-time-scheduling-properties.md)
##### [Stofna sniðmát vinnutíma (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-working-time-templates.md)
##### Stjórna líftíma framleiðslupöntunar
###### [Stofna framleiðslupöntun (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-production-order.md)
###### [Áætla framleiðslupöntun (verkleiðbeiningar)](../supply-chain/production-control/tasks/estimate-production-order.md)
###### [Áætla framleiðslupöntun (verkleiðbeiningar)](../supply-chain/production-control/tasks/schedule-production-order.md)
###### [Gefa út framleiðslupöntun (verkleiðbeiningar)](../supply-chain/production-control/tasks/release-production-order.md)
###### [Hefja framleiðslupöntun (verkleiðbeiningar)](../supply-chain/production-control/tasks/start-production-order.md)
###### [Tilkynna framleiðslupöntun sem lokna (verkleiðbeiningar)](../supply-chain/production-control/tasks/report-production-order-finished.md)
###### [Ljúka framleiðslupöntun (verkleiðbeiningar)](../supply-chain/production-control/tasks/end-production-order.md)
###### [Áætla framleiðslupöntun með rekstrar- og vinnuröðun (verkleiðbeiningar)](../supply-chain/production-control/tasks/schedule-production-order-operations-job-scheduling.md)
##### [Stofna rekstrartilföng (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-operations-resource.md)
##### [Skilgreina möguleika tilfanga (verkleiðbeiningar)](../supply-chain/production-control/tasks/define-resource-capabilities.md)
##### [Virkja launaferli fyrir tíma og mætingu (verkleiðbeiningar)](../supply-chain/production-control/tasks/payroll-process-time-attendance.md)
##### [Bóka sem tilbúið fyrir plötustýrða staðsetningu (verkleiðbeiningar)](../supply-chain/production-control/tasks/report-finished-non-license-plate-controlled-location-2016-11.md)
##### [Tilkynna um framvindu í fartæki (verkleiðbeiningar)](../supply-chain/production-control/tasks/report-progress-mobile-job-device.md)
##### [Nota færslubók öryggisbirgða til að uppfæra lágmarkstryggingu (verkleiðbeiningar)](../supply-chain/production-control/tasks/use-safety-stock-journal-update-minimum-coverage.md)
##### [Skilgreina starfsmann með fartæki (verkleiðbeiningar)](../supply-chain/production-control/tasks/worker-mobile-job-device.md)
...
##### [Endurgjöf um framleiðslu](../supply-chain/production-control/production-feedback.md)
#### Lean-framleiðsluverkefni
##### [Skilgreina vinnuflokka lean-framleiðslu (verkleiðbeiningar)](../supply-chain/production-control/tasks/define-lean-manufacturing-work-cells.md)
##### [Skilgreina flokka í markvissri áætlanagerð (verkleiðbeiningar)](../supply-chain/production-control/tasks/define-lean-schedule-groups.md)
##### Framleiðsluflæði og verkþættir í lean-framleiðslu 
###### [Stofna útgáfu framleiðsluflæðis (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-production-flow-version.md)
###### [Stofna vinnsluverkþætti fyrir lean-framleiðslu (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-process-activities-lean-manufacturing.md)
###### [Stofna flutningsverkþætti fyrir lean-framleiðslu (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-transfer-activities-lean-manufacturing.md)
###### [Villuleita í framleiðsluflæði og útgáfu (verkleiðbeiningar)](../supply-chain/production-control/tasks/validate-production-flow-version.md)
###### [Virkja útgáfu framleiðsluflæðis (verkleiðbeiningar)](../supply-chain/production-control/tasks/activate-production-flow-version.md)
###### [Stofna verkþáttarvensl: Næsti þáttur (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-activity-relation-successor.md)
###### [Bæta forvera við framleiðsluflæðisverkþátt (verkleiðbeiningar)](../supply-chain/production-control/tasks/add-predecessor-production-flow-activity.md)
###### [Stofna virðisstraum (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-value-stream.md)
##### [Lean-þarfarakning úr sölupöntun (verkleiðbeiningar)](../supply-chain/production-control/tasks/lean-pegging-sales-orders.md)
##### [Stofna úthýstan vinnuflokk fyrir lean-framleiðslu (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-subcontracted-work-cell-lean-manufacturing.md)
##### [Bæta útreikningsreglu kanban-magns við kanban-reglu (verkleiðbeiningar)](../supply-chain/production-control/tasks/add-kanban-quantity-calculation-policy-kanban-rule.md)
##### [Reikna út tillögur um kanban-magn (verkleiðbeiningar)](../supply-chain/production-control/tasks/calculate-kanban-quantity-suggestions.md)
##### [Breyta kanban-reglum fyrir vinnsluverk (verkleiðbeiningar)](../supply-chain/production-control/tasks/change-kanban-rules-process-job.md)
##### [Stofna tilviksreglu kanbans fyrir uppskriftarlínu (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-bom-line-event-kanban-rule.md)
##### [Stofna kanban í föstu magni fyrir framleiðslu (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-fixed-quantity-kanban-rule-manufacturing.md)
##### [Stofna kanban-reglu með kanban-línutilviki (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-kanban-rule-kanban-line-event.md)
##### [Stofna kanban-reglu með lágmarksbirgðatilviki (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-kanban-rule-minimum-stock-event.md)
##### [Stofna kanban-reglu fyrir marga verkþætti (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-kanban-rule-multiple-activities.md)
##### [Stofna nýja kanban-reglu með því að afrita fyrirliggjandi kanban-reglu (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-new-kanban-rule-duplicating-existing-kanban-rule.md)
##### [Stofna kanban-reglu til að koma í staðinn (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-replacement-kanban-rule.md)
##### [Stofna kanban-regla sölutilviks (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-sales-event-kanban-rule.md)
##### [Stofna kanban-reglu úttektar (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-withdrawal-kanban-rule.md)
##### [Keyra kanban-vinnsluverk (verkleiðbeiningar)](../supply-chain/production-control/tasks/execute-kanban-process-jobs.md)
##### [Færa áætlaðar kanban-vinnslur (verkleiðbeiningar)](../supply-chain/production-control/tasks/move-scheduled-kanban-jobs.md)
##### [Undirbúa kanban-vinnslu ferlis þegar efni er tiltækt fyrir vinnuflokk (verkleiðbeiningar)](../supply-chain/production-control/tasks/prepare-kanban-job-materials.md)
##### [Undirbúa kanban-vinnslu ferlis þegar efni er ekki tiltækt fyrir vinnuflokk (verkleiðbeiningar)](../supply-chain/production-control/tasks/prepare-process-kanban-job-materials-not-available.md)
##### [Fjarlægja kanban-vinnslu úr áætlun (verkleiðbeiningar)](../supply-chain/production-control/tasks/remove-kanban-job-schedule.md)
##### [Snúa aftur stöðu kanban-vinnslu (verkleiðbeiningar)](../supply-chain/production-control/tasks/revert-kanban-job-status.md)
##### [Áætla kanban-vinnslu (verkleiðbeiningar)](../supply-chain/production-control/tasks/schedule-kanban-jobs.md)
##### [Flytja efni innan kanban-vinnsla (verkleiðbeiningar)](../supply-chain/production-control/tasks/transfer-materials-kanban-jobs.md)
##### [Uppfæra kanban-stöðu (verkleiðbeiningar)](../supply-chain/production-control/tasks/update-kanban-status.md)
...
##### [Búa til formúlu með því að afrita úr fyrirliggjandi formúlu (verkleiðbeiningar)](../supply-chain/production-control/tasks/create-formula-copying-existing-formula.md)
##### [Ferill runupöntunar frá stofnun til upphafs (verkleiðbeiningar)](../supply-chain/production-control/tasks/batch-order-lifecycle-start.md)
##### [Raða framleiðsluvinnslum fyrir framleiðsluferli (verkleiðbeiningar)](../supply-chain/production-control/tasks/sequence-production-jobs-process-manufacturing.md)




## [Afurðaupplýsingastjórnun](../supply-chain/pim/product-information.md)
### [Afurðarupplýsingar](../supply-chain/pim/product-information.md)
...
#### [Stofna nafnakerfi afurðarnúmers fyrir fyrirframskilgreind afurðarafbrigði (verkleiðbeiningar)](../supply-chain/pim/tasks/create-product-number-nomenclature-predefined-variants-2016-11.md)
...
#### [Útreikningur uppskrifta](../supply-chain/cost-management/bom-calculations.md)
### [Afbrigðalíkön afurða](../supply-chain/pim/build-product-configuration-model.md)
...
#### [Stofna skorðuskilgreiningu](../supply-chain/pim/set-up-maintain-product-configuration-model.md)
...
## [Sala og markaðssetning](../supply-chain/sales-marketing/overview-sales-marketing.md)
### Sölupantanir
