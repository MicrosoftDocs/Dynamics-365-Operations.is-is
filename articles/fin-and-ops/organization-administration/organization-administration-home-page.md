...
Þessi efnisatriði bendir á tilföng sem munu hjálpa notendum og stjórnendum  að skilgreina Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition í fyrirtækinu. Þetta efni mun hjálpa þeim að skilgreina kerfið til að vinna vel og skilvirkt fyrir fyrirtæki þitt og rekstur.
...
Áður en að fyrirtæki og stigveldi fyrirtækis eru sett upp í Finance and Operations , skaltu gæta þess að skipuleggja hvernig fyrirtækið mun þróast. Fyrirtækjalíkan hefur töluverð áhrif á innleiðingu á Finance and Operations og í viðskiptaferlum.

-   [Fyrirtæki og fyrirtækjastigveldi](organizations-organizational-hierarchies.md)
...
-   [Altæk aðsetursbók](overview-global-address-book.md)
-   [Áætlun um uppsetningu altækrar aðsetursbókar og annarra aðsetursbóka](plan-configuration-global-address-book-additional-address-books.md)
...
Verkflæði  er kerfi sem var uppsett með Finance and Operations og má nota við gerð einstaks verkflæðis, eða viðskiptaferla. Það skilgreinir hvernig skjal flæðir eða hreyfist gegnum kerfið með því að sýna hver verður að ljúka verki, taka ákvörðun eða samþykkja skjal. 

-   [Yfirlit yfir verkflæði](overview-workflow-system.md)
...
-   [Skilgreining öryggis, vinnsla og flokka mála](plan-case-management.md)
