...
## <a name="create-a-hierarchy"></a>Búa til stigveldi
...
5. Í listanum skal finna og velja þá skráningu sem óskað er eftir.
    * Veljið tilgangur sem úthluta á stigveldi fyrirtækisins.  
6. Smelltu á Bæta við.
7. Í listanum skal merkja valda línu.
    * Finna stigveldið sem var verið að stofna.  
8. Smellið á „Í lagi“.

## <a name="add-organizations-to-the-hierarchy"></a>Bæta við fyrirtækjum í stigveldi áætlunar
1. Í listanum skal finna og velja þá skráningu sem óskað er eftir.
    * Velja skal þitt stigveldi.  
