...
---
# <a name="create-operating-units"></a>Búa til rekstrareiningar
...
1. Fara í Fyrirtækisstjórnun > Fyrirtæki > rekstrareiningar.
2. Smellt er á Nýtt til að opna felligluggann.
3. Í listanum skal finna og velja þá skráningu sem óskað er eftir.
    * Veldu þá tegund rekstrareiningar sem á að stofna.  
...
5. Í reitinn Heiti skal slá inn gildi.
    ...
    * Færðu inn upplýsingar um aðsetur, til dæmis götunafn og götunúmer, póstnúmer og borg. Smella skal á Nýtt til að færa inn nýja aðsetursfærslu eða Breyta til að breyta fyrirliggjandi aðsetursfærslu.   
