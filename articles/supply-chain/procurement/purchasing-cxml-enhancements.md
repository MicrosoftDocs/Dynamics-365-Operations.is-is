...
Til að kveikja á eiginleikanum skal opna **[Eiginleikastjórnun](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)** og leita að eiginleikanum sem er nefndur *Viðbætur cXML-innkaupa*. Veljið eiginleikann og veljið svo **Virkja núna** til að kveikja á honum. (Sem hluti af Supply Chain Management, útgáfa 10.0.21, er sjálfgefið kveikt á þessum eiginleika.)
...
- **USERAGENT** – Færið inn gildi til að auðkenna kerfið sem er notað. Sláðu til dæmis inn _Dynamics 365 Supply Chain Management_.
...
Til að stilla þær gerðir af athugasemdum sem kerfið leitar að, skal fara í **Innkaup og aðföng \> Uppsetning \> Skjámyndir \> Uppsetning sniðmáts**. Síðan, í flipanum **Innkaupapöntun**, skal stilla reitinn **Taka með skjöl af gerðinni** á gerð athugasemdar sem þú vilt að verði tekin með. Aðeins athugasemdir á textaformi verða teknar með, ekki viðhengi skjala.
