...
'' Deild innkaupa auðkennir birgja fyrir afurðir og þjónustu og þetta getur falið í sér að *beiðni um tilboð* er send mörgum mögulegum lánardrottnum. Hægt er að deila upplýsingum um vöru sem beðið er um og mögulegir lánadrottnar geta skoðað þær til að sjá ef þeir geta afhent°afurð sem passar við þær. Lánardrottnar skila tilboðum sínum sem eru síðan endurskoðuð af innkaupadeild áður en valinn er birgir sem óskað er eftir að°kaupa af.  
...
### <a name="delivery-options"></a>Sendingarvalkostir
