...
description: Þessi grein lýsir nýjum eða breyttum eiginleikum í Microsoft Dynamics 365 Supply Chain Management 10.0.23.
author: kamaybac
ms.date: 10/15/2021
ms.topic: article
...
Í þessari grein er að finna eiginleika sem eru annaðhvort nýir eða breyttir í Microsoft Dynamics 365 Supply Chain Management útgáfu 10.0.23. Þessi útgáfa er með byggingarnúmer 10.0.1037 og er fáanlegt á eftirfarandi hátt:
...
| Framleiðsla | [Samþætting framleiðslukerfa](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/manufacturing-execution-systems-integration) | [Samþætta við kerfi þriðju aðila fyrir framkvæmd framleiðslu](../production-control/mes-integration.md) | Eiginleikastjórnun (*Samþætting á framkvæmd framleiðslukerfis*) |
...
| Áætlun | [Stuðningur við fínstillingu áætlanagerðar fyrir forgangsraðað áætlanagerð](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/planning-optimization-support-priority-based-planning) | [Forgangsröðuð áætlun](../master-planning/planning-optimization/priority-based-planning.md) | Eiginleikastjórnun (*Forgangsraðaður stuðningur við MRP fyrir fínstillingu skipulagningar*) |
...
| Áætlanagerð | Azure Machine Learning Service fyrir eftirspurnarspá | Þessi eiginleiki gerir Azure Machine Learning Service kleift að mynda eftirspurnarspá sem byggir á sögulegum gögnum. Frekari upplýsingar eru í [Uppsetning eftirspurnarspár](../master-planning/demand-forecasting-setup.md). |
...
| Sala og markaðsstarf | Hreinsa uppfærsluferil sölu eftir aldri | Eiginleikinn gerir þér kleift að stilla hámarksaldur á færslum sem á að halda þegar reglubundna verkið **Hreinsun á uppfærsluferli sölu** er keyrt. Eldri færslum verður eytt. Þetta er gagnlegt þegar þú setur upp verksem á að keyra reglulega vegna þess að aldurinn er alltaf reiknaður út miðað við þann dag sem verkið er keyrt. Ef þessi aðgerð er ekki notuð er aðeins hægt að velja ákveðna dagsetningu fyrir elstu færslurnar. Frekari upplýsingar eru í [Tímasetja gagnahreinsun söluferils](../sales-marketing/sales-update-history-cleanup-performance-improvements.md). |
...
| Sala og markaðsstarf | Viðskiptum innan samstæðu er nú lýst í þaula og byrjar á [Setja upp samstæðuviðskipti](../sales-marketing/intercompany-trade-set-up.md) og tengdum greinum. |
...
| Birgðir | Fylgigögn birgðasýnileika hafa verið stækkuð og uppfærð og byrja á [Yfirlit viðbótar fyrir sýnileika birgða](../inventory/inventory-visibility.md) og tengdum greinum. |
...
Microsoft Dynamics 365 Supply Chain Management 10.0.23 inniheldur verkvangsuppfærslur. Frekari upplýsingar má finna í [Verkvangsuppfærslur fyrir útgáfu 10.0.23 á fjármála- og rekstrarforritum (október 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-23.md).
