---
title: Forútgáfa af Dynamics 365 Supply Chain Management 10.0.30 (nóvember 2022)
...
ms.locfileid: "9429124"
---
# <a name="preview-of-dynamics-365-supply-chain-management-10030-november-2022"></a>Forútgáfa af Dynamics 365 Supply Chain Management 10.0.30 (nóvember 2022)

[!include [banner](../includes/banner.md)]
[!include [preview banner](../includes/preview-banner.md)]

Þessi grein sýnir eiginleika sem eru annað hvort nýir eða breyttir í Microsoft Dynamics 365 Supply Chain Management forskoðunarútgáfa 10.0.30. Þessi útgáfa hefur byggingarnúmer 10.0.1362 og er fáanleg samkvæmt eftirfarandi áætlun:
...
|---|---|---|---|
| Framleiðsla | [Fylgstu með búnaði með Sensor Data Intelligence](/dynamics365-release-plan/2022wave2/finance-operations/dynamics365-supply-chain-management/monitor-equipment-sensor-data-intelligence) | [Heimasíða Sensor Data Intelligence](../sensor-data-intelligence/sdi-home-page.md) | Eiginleikastjórnun:<br>*(Forútgáfa) Gagnagreindarskynjari* |
| Vöruhúsakerfi | Fjölþrepa hjáleiðir fyrir fartækjaforrit Warehouse Management <!-- KFM: Add link when RP updates --> | [Skilgreina hjáleiðir fyrir skref í valmyndaratriðum fartækis](../warehousing/warehouse-app-detours.md) | Eiginleikastjórnun:<br>*Fjölþrepa hjáleiðir fyrir fartækjaforrit Warehouse Management* |
...
|---|---|---|
| Framleiðslustýring | Tilbúnar upplýsingar í framleiðslupöntunum til að gefa út síðu | Bætir við dálki fyrir birgðamagn á lager fyrir línuvöruna í línuhlutanum á **Framleiðslupantanir til að gefa út** síðu. |
| Flutningsstjórnun | Úthlutaðu sendingum á tengda leiðarhluta | Þessi eiginleiki gerir kerfinu kleift að skipta flutningskostnaði með nákvæmari hætti, þar á meðal fyrir farm með mörgum sendingum sem eru afhentar til mismunandi áfangastaða á einni leið. Það úthlutar hverri sendingu á heppilegasta leiðarhlutann miðað við ákvörðunarheimilisföng sendingar og hluta. Eiginleikinn reiknar síðan flutningskostnað hverrar sendingar sem hlutfall af heildarflutningskostnaði farmsins, byggt á hlutfallslegri þyngd, rúmmáli, magni og ekinni vegalengd sendingarinnar. Þessi eiginleiki á aðeins við um sendingar sem stjórnað er með flutningsstjórnunareiningunni (TMS). |

## <a name="additional-resources"></a>Frekari upplýsingar

### <a name="platform-updates-for-finance-and-operations-apps"></a>Palluppfærslur fyrir Finance and Operations öpp

Microsoft Dynamics 365 Supply Chain Management 10.0.30 inniheldur verkvangsuppfærslur. Til að læra meira, sjá [Palluppfærslur fyrir útgáfu 10.0.30 af Finance and Operations forritum (nóvember 2022)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-30.md). <!--KFM: Confirm link -->

### <a name="bug-fixes"></a>Villuleiðréttingar

Til að fá upplýsingar um villuleiðréttingar sem fylgja hverri uppfærslu sem er hluti af útgáfu 10.0.29 skaltu skrá þig inn á Lifecycle Services (LCS) og skoða [KB grein](https://fix.lcs.dynamics.com/Issue/Details?bugId=745468).
