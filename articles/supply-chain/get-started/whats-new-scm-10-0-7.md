...
---
# <a name="whats-new-and-changed-in-dynamics-365-supply-chain-management-1007-january-2020"></a>Nýjungar og breytingar í Dynamics 365 Supply Chain Management 10.0.7 (janúar 2020)

[!include [banner](../includes/banner.md)]


Í þessu efnisatriði er að finna lýsingu á nýjum eða breyttum eiginleikum í Microsoft Dynamics 365 Supply Chain Management 10.0.7. Þessi útgáfa er með byggingarnúmer 10.0.283 og er fáanlegt á eftirfarandi hátt:
...
Frekari upplýsingar um útgáfu 10.0.7 er að finna í [Frekari upplýsingar](whats-new-scm-10-0-7.md#additional-resources).
...
Til að fá upplýsingar um villuleiðréttingarnar sem fylgja sérhverri uppfærslu sem er hluti af 10.0.7, skráðu þig inn á Lifecycle Services (LCS) og skoðaðu [KB grein](https://fix.lcs.dynamics.com/Issue/Details?kb=4528173&bugId=386529&dbType=3&qc=d6f5cd3ead06907477eae511043a52c1d4290a12bf52374dd55faf0d28ae732e).

### <a name="platform-update-31"></a>Update 31 fyrir verkvang
Microsoft Dynamics 365 Supply Chain Management 10.0.7 inniheldur verkvangsuppfærslu 31. Til að læra meira um verkvangsuppfærslu 31, sjá [Hvað er nýtt og breytt í verkvangsuppfærslu 31](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-31.md).
