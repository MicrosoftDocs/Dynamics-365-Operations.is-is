...
description: Þessi grein lýsir eiginleikum sem eru annað hvort nýir eða breyttir Dynamics 365 Supply Chain Management 10.0.18.
author: kamaybac
ms.date: 03/01/2021
ms.topic: article
ms.prod: ''
...
Þessi grein sýnir eiginleika sem eru annað hvort nýir eða breyttir í Microsoft Dynamics 365 Supply Chain Management 10.0.18. Þessi útgáfa er með byggingarnúmer 10.0.793 og er fáanlegt á eftirfarandi hátt:

- **Forskoðun á útgáfu:** mars 2021
- **Almennt framboð losunar (sjálfvirk uppfærsla):** Apríl 2021
- **Almennt framboð losunar (sjálfvirk uppfærsla):** Maí 2021
...
- [Innbót fyrir sýnileika birgða](../inventory/inventory-visibility.md)
- [Eining heildarkostnaðar](../landed-cost/landed-cost-overview.md)
- [Viðmót efnismeðhöndlunarbúnaðar (MHAX)](../warehousing/mhax.md)
- [Samræmisgreining á fínstillingu áætlanagerðar](../master-planning/planning-optimization/planning-optimization-fit-analysis.md)

## <a name="additional-resources"></a>Frekari upplýsingar

### <a name="platform-updates-for-finance-and-operations-apps"></a>Palluppfærslur fyrir Finance and Operations öpp

Microsoft Dynamics 365 Supply Chain Management 10.0.18 inniheldur verkvangsuppfærslur. Til að læra meira, sjá [Uppfærslur á vettvangi fyrir útgáfu 10.0.18 af Finance and Operations forritum (maí 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-18.md).

### <a name="bug-fixes"></a>Villuleiðréttingar

Til að fá upplýsingar um villuleiðréttingarnar sem fylgja sérhverri uppfærslu sem er hluti af 10.0.18, skráðu þig inn á Lifecycle Services (LCS) og skoðaðu [KB grein](https://fix.lcs.dynamics.com/Issue/Details?bugId=561679&dbType=3&qc=13bb1641c1be430ead8b21ae3d4e0f800d5b81c39b3a56e890db1de7ede59e46).
