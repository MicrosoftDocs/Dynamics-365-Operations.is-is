...
Notaða sniðmátið **Afurðir Field Service með birgðaeiningu (Finance and Operations til Field Service)** byggist á sniðmátinu **Afurðir Field Service (Finance and Operations til Field Service)**. Nánari upplýsingar er að finna í [Afurðir Field Service (Finance and Operations til Field Service)](field-service-product.md).
...
- **Afurðir Field Service (Finance and Operations til Field Service)** 
