...
- Vörpun **CustomerGroupId** úr **CDS &gt; áfangastaðnum** verður að uppfæra í tækt gildi í Finance and Operations. Hægt er að tilgreina sjálfgefið gildi eða setja upp gildi með því að nota gildisvörpun. Sjálfgefið sniðmátsgildi er **10**.
- **Svæðiskóði fyrir aðsetursland** er nauðsynlegur í Finance and Operations. Til að forðast samstillingarvillur er hægt að tilgreina sjálfgildi í vörpun úr **CDS &gt; áfangastað**. Sjálfgefna gildið er svo notaðu ef reiturinn er skilinn eftir auður í Sales.
