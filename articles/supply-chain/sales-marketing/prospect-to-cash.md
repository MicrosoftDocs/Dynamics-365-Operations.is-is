...
2. Gakktu úr skugga um að opið sé fyrir zip-skrána. Annars geta eftirfarandi villuboð birst þegar þú reynir að setja upp lausnapakkann: „Fann enga uppsetningarpakka.“ Til að opna fyrir zip-skrána, skaltu hægrismella á hana og velja **Eiginleikar**. Veldu síðan **Opna fyrir**.
