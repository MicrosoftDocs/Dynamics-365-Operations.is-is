---
title: Ein línanna er þegar í farmi
description: 'Þessi síða útskýrir hvers vegna þú gætir hafa fengið villuna: „Ein línanna er þegar í farmi. Ekki tókst að losa í vöruhúsið,“ og hvernig á að leysa úr vandamálinu.'
author: perlynne
ms.date: 06/24/2021
...
ms.locfileid: "7476710"
---
# <a name="one-of-the-lines-is-already-on-a-load"></a>Ein línanna er þegar í farmi

## <a name="symptoms"></a>Einkenni

Þegar unnið er með hleðsluáætlun og sendingar gætir þú fengið eftirfarandi villuboð:

> Ein línanna er þegar í farmi. Ekki er hægt að losa í vöruhús.
