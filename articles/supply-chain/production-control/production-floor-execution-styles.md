...
- Allar stýringar í svarglugganum verða að vera skilgreindar eins og lýst er í þessu efnisatriði.
...
- Önnur stýringin er **CommonButton** stýring og nafnið byrjar á **ClearButton**. Þessi hnappur verður að innihalda kóða sem notar eiginleikann **virkja** til að sýna eða fela hnappinn. Til dæmis til að sýna eða fela hnappinn **Hreinsa** meðan notandinn er að slá inn upplýsingar í innsláttarstýringuna geturðu notað eftirfarandi kóða.
    ...
    Notið eftirfarandi kóða fyrir aðferðina **smellt** fyrir hnappinn **Hreinsa**.
...
- Innan hópsins er fyrsta stýringin **QuickFilter** stýring. (Hér slær notandinn inn leitarstrenginn.)
- Önnur stýringin er **FormStaticTextControl** með heitinu **NumberOfResults**. (Þetta er valfrjálst og sýnir fjölda fundinna atriða ef þau eru innifalin.)
- Þriðja stýringin er stýringin **CommonButton** með heiti sem byrjar á **ClearButton**.
