---
title: Gerðu fullunnar vörur líkamlega aðgengilegar áður en þær eru bókaðar í færslubækur
...
ms.locfileid: "9266500"
---
# <a name="make-finished-goods-physically-available-before-posting-to-journals"></a>Gerðu fullunnar vörur líkamlega aðgengilegar áður en þær eru bókaðar í færslubækur
...
1. Á **Vöruhús** Flýtiflipi, í **Framleiðslupantanir** kafla, stilltu **Birtingaraðferð** reit í eitt af eftirfarandi gildum:
...
- **Staða skilaboða** – Tilgreindu stöðu skilaboðanna sem eru sýnd á hnitanetinu. Eftirfarandi ríki eru til:
    ...
    - *Hætt við* – Ekki tókst að vinna úr skilaboðunum í síðustu tilraun og var síðan afturkallað af notanda.
...
Þú getur fundið nákvæmar upplýsingar um skeyti með því að velja þau í töflunni og velja síðan **Log** eða **Hrá efni** flipann undir skeytanetinu, þar sem hver vinnsluatburður er sýndur.
...
- **Búnt** – Hægt er að keyra margar skilaboðaaðgerðir sem hluta af sömu runuvinnslu. Velja þennan hnapp til að skoða þessi ítarlegu gögn. Til dæmis geturðu séð hvort ósjálfstæðir eru til staðar sem krefjast ákveðinnar vinnsluröð fyrir sum skilaboð.

### <a name="manually-process-or-cancel-a-message"></a>Vinna handvirkt úr eða hætta við skilaboð

Þú getur handvirkt unnið úr eða hætt við skilaboð eftir þörfum, allt eftir núverandi ástandi þeirra. Veldu skilaboðin í hnitanetinu og veldu síðan **Ferli** eða **Hætta við** á aðgerðasvæðinu.
