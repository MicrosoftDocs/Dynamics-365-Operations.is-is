---
title: Eignarlán
description: Í þessari grein er því lýst hvernig á að skrá lánseign í Eignastýringu.
...
Til að skoða lista yfir allar eignir sem þú hefur lánað til annarra staðsetninga eða viðskiptavina skal velja **Eignastýring** \> **Eignalán** \> **Öll eignalán**. Ef gátreiturinn **Klárað** er valinn fyrir eign hefur eignin verið skráð sem skilað til fyrirtækisins.
