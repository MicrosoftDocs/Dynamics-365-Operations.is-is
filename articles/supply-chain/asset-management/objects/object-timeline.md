...
- Þegar starfstegund var síðast notuð á eign
- Þegar tiltekinn starfsmaður færði inn athugasemd í verkbeiðnistörf

Tímalínan er uppfærð í hvert skipti sem síðan er opnuð. Það inniheldur eftirfarandi upplýsingar:

- Breytingar sem gerðar hafa verið á eigninni: staðsetningu eigna, auðkenni eigna, nafn og ábyrgð seljanda
- Yfireign
- Uppskrift eignar (BOM)
- Kladdi líftímastöðu eignar
- Virk staðsetning
- Viðhaldsbeiðnir
