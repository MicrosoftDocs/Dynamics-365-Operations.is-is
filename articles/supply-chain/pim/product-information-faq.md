...
description: Þetta efnisatriði veitir svör við algengum spurningum um virkni vöruupplýsingastjórnunar í Supply Chain Management.
author: t-benebo
ms.date: 06/03/2021
ms.topic: article
...
ms.locfileid: "7476608"
---
# <a name="product-information-management-faq"></a>Algengar spurningar um vöruupplýsingastjórnun

[!include [banner](../includes/banner.md)]

Þetta efnisatriði veitir svör við algengum spurningum um virkni vöruupplýsingastjórnunar í Supply Chain Management.
