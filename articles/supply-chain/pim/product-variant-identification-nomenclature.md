...
description: Þessi grein lýsir því hvernig hægt er að setja upp nafnakerfi afurðarnúmers til að skipta út föstu sniði [Númer afurðarsniðmáts - Skilgreining - Stærð - Litur - Stíll].
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
