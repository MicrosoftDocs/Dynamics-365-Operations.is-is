...
## <a name="associate-product-lifecycle-states-to-released-products"></a><span data-ttu-id="444bc-115">Tengja lífferilsstöðu afurðar við útgefnar afurðir</span><span class="sxs-lookup"><span data-stu-id="444bc-115">Associate product lifecycle states to released products</span></span>  

<span data-ttu-id="444bc-116">Það eru margar leiðir til að tengja lífferilsstöðu afurðar við útgefnar afurðir eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-116">There are multiple ways to associate a product lifecycle state to released products or product variants.</span></span>

-  <span data-ttu-id="444bc-117">Við stofnun nýrrar útgefinnar afurðar er sjálfgefin **Lífferilsstaða afurðar** úthlutað sjálfkrafa.</span><span class="sxs-lookup"><span data-stu-id="444bc-117">On creation of a new released product, the default **Product lifecycle state** is automatically assigned.</span></span> 
-  <span data-ttu-id="444bc-118">Við útgáfu afurðar til lögaðila, er sjálfgefin **Lífferilsstaða afurðar** úthlutað sjálfkrafa.</span><span class="sxs-lookup"><span data-stu-id="444bc-118">On release of a product to a legal entity, the default **Product lifecycle state** is automatically assigned.</span></span> 
-  <span data-ttu-id="444bc-119">Við útgáfu afurðaafbrigða til lögaðila, er **Lífferilsstaða afurðar** sem tengd er við útgefið afurðasniðmát í þessum lögaðila, sjálfkrafa úthlutað til nýja afbrigðisins.</span><span class="sxs-lookup"><span data-stu-id="444bc-119">On release of a product variant to a legal entity, the **Product lifecycle state** associated to the released product master in this legal entity is automatically assigned to the new variant.</span></span> 

<span data-ttu-id="444bc-120">Hægt er að uppfæra lífferilsstöðu afurðar handvirkt með því að nota:</span><span class="sxs-lookup"><span data-stu-id="444bc-120">You can manually update the product lifecycle state by using:</span></span> 

-    <span data-ttu-id="444bc-121">Listasíða **Útgefnar afurðir** eða **Upplýsingar yfirlit**.</span><span class="sxs-lookup"><span data-stu-id="444bc-121">The **Released products** list page or **Details view**.</span></span> 
-  <span data-ttu-id="444bc-122">Listasíða **Útgefin afurðaafbrigði** lista síðu eða **Upplýsingar yfirlit**.</span><span class="sxs-lookup"><span data-stu-id="444bc-122">The **Released product variants** list page or **Details view**.</span></span> 
-  <span data-ttu-id="444bc-123">Finndu úreltar afurðir eða afurðaafbrigði sem byggist á eftirspurn og tengdu við það lífferilsstöðu.</span><span class="sxs-lookup"><span data-stu-id="444bc-123">Find the obsolete products or product variants based on demand and associate a lifecycle state.</span></span>  

<span data-ttu-id="444bc-124">Til að fá nánari upplýsingar um hvernig á að tengja lífferilsstöðu afurðar skaltu spila eða lesa tvær eftirfarandi verkefnaleiðbeiningar.</span><span class="sxs-lookup"><span data-stu-id="444bc-124">For detailed information about how to associate product lifecycle states, play or read the following two task guides.</span></span>

-  <span data-ttu-id="444bc-125">Til að tengja lífferilsstöðu afurðar við útgefinn afurðasniðmát, spilaðu eða lestu verkefnaleiðsögnina **Úthlutaðu lífferilsstöðu afurðar til útgefins afurðasniðmáts**.</span><span class="sxs-lookup"><span data-stu-id="444bc-125">To associate a product lifecycle state to a released product master, play or read the task guide **Assign a product lifecycle state to a released product master**.</span></span> 

-  <span data-ttu-id="444bc-126">Til að tengja lífferilsstöðu afurðar við útgefna afurð skaltu spila eða lesa verkefnaleiðsögnina **Úthlutaðu lífferilsstöðu afurðar til útgefinnar afurðar**.</span><span class="sxs-lookup"><span data-stu-id="444bc-126">To associate a product lifecycle state to a release product, play or read the task guide **Assign a product lifecycle state to a released product**.</span></span> 

## <a name="impact-on-master-planning"></a><span data-ttu-id="444bc-127">Áhrif á aðaláætlanagerð</span><span class="sxs-lookup"><span data-stu-id="444bc-127">Impact on master planning</span></span> 

<span data-ttu-id="444bc-128">Lífferilsstaða afurðar hefur aðeins eina stýringarmerki: **Er virkt fyrir áætlanagerð**.</span><span class="sxs-lookup"><span data-stu-id="444bc-128">The product lifecycle state has only one control flag: **Is active for planning**.</span></span> <span data-ttu-id="444bc-129">Sjálfgefið er þetta stillt á **Já** fyrir allar tilbúnar lífferilsstöðu afurðar, en það er hægt að breyta í **Nei**.</span><span class="sxs-lookup"><span data-stu-id="444bc-129">By default, this is set to **Yes** for all created product lifecycle states, but it can be changed to **No**.</span></span> <span data-ttu-id="444bc-130">Þegar stillt er á **Nei**, eru tengdir útgefnar afurðir eða útgefin afurðaafbrigði:</span><span class="sxs-lookup"><span data-stu-id="444bc-130">When set to **No**, the associated released products or released product variants are:</span></span> 

-  <span data-ttu-id="444bc-131">Útilokuð frá aðaláætlanagerð.</span><span class="sxs-lookup"><span data-stu-id="444bc-131">Excluded from master planning.</span></span> 
-  <span data-ttu-id="444bc-132">Útilokuð frá útreikningi á BOM-stigi.</span><span class="sxs-lookup"><span data-stu-id="444bc-132">Excluded from BOM-level calculation.</span></span> 

<span data-ttu-id="444bc-133">Nánari upplýsingar um hvernig á að nota lífferilsstöðu afurðar til að útiloka afurðir frá aðaláætlanagerð og útreikningum á BOM-stigi, spilaðu eða lesið verkefnaleiðbeiningarnar **Búðu til lífferilsstöðu afurðar til að útiloka afurðir frá aðaláætlanagerð**.</span><span class="sxs-lookup"><span data-stu-id="444bc-133">For detailed information about how to use product lifecycle state to exclude products from master planning and BOM-level calculation, play or read the task guide **Create a product lifecycle state to exclude products from Master planning**.</span></span>
...
-  <span data-ttu-id="444bc-153">Afurðin eða afurðarafbrigðið var búið til fyrir nokkrum dögum síðan miðað við fjölda daga sem þú slærð inn í svargluggann fyrir val.</span><span class="sxs-lookup"><span data-stu-id="444bc-153">The product or product variant was created some days ago based on the number of days that you enter in the selection dialog box.</span></span> 
-  <span data-ttu-id="444bc-154">Það eru engar opnar framleiðslupantanir (= staða < lokið) fyrir afurð eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-154">There are no open production orders (= status < ended) for the product or product variant.</span></span> 
-  <span data-ttu-id="444bc-155">Það eru engar opnar birgðafærslur (= staða útgáfa ReservPhysical til QuotationIssue eða staða innhreyfingar Skráð í QuotationReceipt) fyrir afurð eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-155">There are no open inventory transactions (= status issue ReservPhysical to QuotationIssue or status receipt Registrered to QuotationReceipt) for the product or product variant.</span></span> 
-  <span data-ttu-id="444bc-156">Engin birgðafærslur eiga sér stað á síðustu dögum fyrir afurð eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-156">There are no inventory transactions within the last number of days for the product or product variant.</span></span> 
-  <span data-ttu-id="444bc-157">Það er engin framtíðareftirspurn eða framboðspá fyrir afurð eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-157">There is no future demand or supply forecast for the product or product variant.</span></span>  
-  <span data-ttu-id="444bc-158">Engin lágmarks birgðir hefur verið stillt í vöruþekju fyrir afurð eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-158">No minimum stock level has been set in item coverage for the product or product variant.</span></span> 
-  <span data-ttu-id="444bc-159">Engin föst kanban-regla virk fyrir afurð eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-159">No active fixed quantity kanban rule for the product or product variant.</span></span>  
-  <span data-ttu-id="444bc-160">Engar þjónustupöntunarlínur fyrir afurð eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-160">No service order line for the product or product variant.</span></span> 
-  <span data-ttu-id="444bc-161">Engar virkar eða framtíðar sölu- eða innkaupsamningslínur fyrir afurð eða afurðaafbrigði.</span><span class="sxs-lookup"><span data-stu-id="444bc-161">No active or future sales or purchase agreement lines for the product or product variant.</span></span> 
-  <span data-ttu-id="444bc-162">Afurð eða afurðaafbrigði er ekki notuð í BOM sem tengist samþykktri BOM útgáfu sem ekki er útrunnin fyrir afurð eða afbrigði sem er virk fyrir áætlunargerð.</span><span class="sxs-lookup"><span data-stu-id="444bc-162">The product or product variant is not used in a BOM that is associated with a non-expired approved BOM version for a product or variant that is active for planning.</span></span>

## <a name="related-topics"></a><span data-ttu-id="444bc-163">Tengd efnisatriði</span><span class="sxs-lookup"><span data-stu-id="444bc-163">Related topics</span></span>

-  [<span data-ttu-id="444bc-164">Stofna nýja lífferilsstöðu afurðar (verkleiðbeiningar)</span><span class="sxs-lookup"><span data-stu-id="444bc-164">Create a new product lifecycle state (Task guide)</span></span>](tasks/new-product-lifecycle-state.md)
-  [<span data-ttu-id="444bc-165">Stofna sjálfgefna lífferilsstöðu afurðar (verkleiðbeiningar)</span><span class="sxs-lookup"><span data-stu-id="444bc-165">Create a default product lifecycle state (Task guide)</span></span>](tasks/default-product-lifecycle-state.md)
-  [<span data-ttu-id="444bc-166">Úthluta líftímastöðu afurðar til útgefins afurðarsniðmáts (verkleiðbeiningar)</span><span class="sxs-lookup"><span data-stu-id="444bc-166">Assign a product lifecycle state to a released product master (Task guide)</span></span>](tasks/product-lifecycle-state-released-product-master.md)
-  [<span data-ttu-id="444bc-167">Úthluta lífferilsstöðu afurðar til útgefinnar afurðar (verkleiðbeiningar)</span><span class="sxs-lookup"><span data-stu-id="444bc-167">Assign a product lifecycle state to a released product (Task guide)</span></span>](tasks/product-lifecycle-state-released-product.md)
-  [<span data-ttu-id="444bc-168">Finna úrelt afurðaafbrigði og úthluta lífferilsstöðu afurðar (verkleiðbeiningar)</span><span class="sxs-lookup"><span data-stu-id="444bc-168">Find obsolete product variants and assign a product lifecycle state (Task guide)</span></span>](tasks/obsolete-product-variants.md)
-  [<span data-ttu-id="444bc-169">Stofna lífferlisstöðu afurðar til að útiloka afurðir frá aðaláætlanagerð (verkleiðbeiningar)</span><span class="sxs-lookup"><span data-stu-id="444bc-169">Create a product lifecycle state to exclude products from Master planning (Task guide)</span></span>](tasks/exclude-products-master-planning.md)
