...
[Stofna segð töfluskorðu](tasks/add-expression-constraint-product-configuration-model.md)

[Bæta útreikningi við afbrigðalíkan afurðar](tasks/add-calculation-product-configuration-model.md)
