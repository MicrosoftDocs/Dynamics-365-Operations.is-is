...
description: Þessi grein veitir yfirlit yfir Færsluupplýsingarsíðuna sem sýnir upplýsingar um valda birgðafærslu.
...
| Flýtiflipi | Lýsing |
|---|---|
| Almennt | Þessi flýtiflipi sýnir grunnupplýsingar um valda birgðafærslu. Til viðbótar við reitina sem birtast á **Birgðaviðskipti** síðu, inniheldur það viðbótarreitina sem lýst er síðar í þessari grein. |
| Uppfærslur | Þessi flýtiflipi sýnir upplýsingar sem tengjast efnislegum, fjárhagslegum og uppgjörsþáttum valinnar birgðafærslu. Það fer eftir núverandi stöðu færslunnar, sumir reitir gætu verið auðir. Hins vegar verða þeir reitir sjálfkrafa stilltir þegar færslur eru bókaðar. Til viðbótar við reitina sem birtast á **Birgðaviðskipti** síðu inniheldur þessi flýtiflipi viðbótarreitin sem lýst er síðar í þessari grein. |
...
| Víddarnúmer | Einstakt auðkenni sem táknar samsetningu allra birgðavíddargilda sem eru úthlutað á valda birgðafærslu. |
...
| Reitur | Lýsing |
|---|---|
| Efnislegt fylgiskjal | Skírteinisnúmerið úr fjárhag þar sem efnisbókun fyrir valda birgðafærslu var mynduð. |
...
| Leiðrétting | Upphæðin sem var leiðrétt á völdum birgðafærslu úr birgðalokun og leiðréttingarferli. |
...
| Afgreitt magn framleiðsluþyngdar | Það aflaþyngdarmagn sem fellur undir uppgjörið. |
