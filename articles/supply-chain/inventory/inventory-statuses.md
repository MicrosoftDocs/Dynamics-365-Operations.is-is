...
> [!NOTE]
> Eiginleiki *Breyta birgðastöðu atriða sem er stjórnað af rakningarvíddum* gerir notendum kleift að breyta birgðastöðu á vörum sem rakningarvíddir stýra, þ.m.t. möguleikanum á að uppfæra aðeins valdar færslur. Notið [eiginleikastjórnun](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) til að virkja eiginleikann eftir þörfum. Þegar eiginleikinn er virkur er hægt að gera eftirfarandi:
>
