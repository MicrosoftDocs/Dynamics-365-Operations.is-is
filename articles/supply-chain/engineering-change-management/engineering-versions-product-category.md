...
description: Þessi grein veitir upplýsingar um hugmyndina um verkfræðilegar útgáfur. Hönnunarútgáfur tryggja að mismunandi stöður afurðar og gögn hennar sé haldið uppfærðum og skýrum og að hægt sé að sjá þau í kerfinu.
author: t-benebo
ms.date: 04/07/2022
ms.topic: article
ms.prod: ''
