...
description: Þessi grein veitir upplýsingar um vörueigendur. Eigendur afurða er hópur notenda sem ber ábyrgð á tilteknum afurðum. Aðeins meðlimir í hópnum geta losað þessar afurðir. Einnig er hægt að nota Eigendur afurða í samþykktarverkflæðinu.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
