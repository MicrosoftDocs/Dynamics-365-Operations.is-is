...
ms.locfileid: "3986769"
---
# <a name="consolidate-shipments-by-using-shipment-consolidation-policies"></a>Sameina sendingar með því að nota samstæðureglur sendingar

[!include [banner](../includes/banner.md)]

Eftirfarandi aðstæður leiða notanda í gegnum samstæðuferli sendingar sem notar samstæðureglur sendingar við sjálfvirka og handvirka losun í vöruhúsið:
