...
description: Þessi grein lýsir reglu birgðafrátekningar sem gerir fyrirtækjum sem selja runuraktar afurðir og keyra vörustjórnun sína sem vöruhúsavirkjaðar aðgerðir kleift að taka frá tilteknar runur fyrir sölupantanir viðskiptavina, jafnvel þótt frátekningastigveldið sem tengist afurðunum leyfi ekki frátekningu á tilteknum runum.
author: perlynne
ms.date: 08/09/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9335706"
---
# <a name="flexible-warehouse-level-dimension-reservation-policy"></a>Sveigjanleg frátektarregla á vídd vöruhúsastigs

[!include [banner](../includes/banner.md)]

Þegar frátekningarstigveldi birgða af gerðinni *Runa fyrir neðan\[staðsetningu\]* tengist afurðum, geta fyrirtæki, sem selja runuraktar afurðir og keyra vörustjórnun sína sem aðgerðir sem eru virkjaðar fyrir vöruhúsakerfið (WMS), ekki tekið frá tilteknar runur þeirra afurða fyrir sölupantanir viðskiptavina.
...
Þessi grein lýsir frátekningarreglu birgða sem gerir þessum fyrirtækjum kleift að taka frá ákveðnar runur eða númeraplötur, jafnvel þegar afurðirnar eru tengdar frátekningarstigveldi *Runa fyrir neðan\[staðsetningu\]*“.
...
### <a name="turn-flexible-license-plate-reservation-on-or-off"></a>Kveikja eða slökkva á sveigjanlegri frátekningu á númeraplötu
...
1. *Sveigjanleg frátekt á vídd vöruhúsastigs*<br>(Frá og með útgáfu 10.0.29 af Supply Chain Management er þessi eiginleiki skylda og ekki er hægt að slökkva á honum.)
1. *Sveigjanleg frátekt á númeraplötu ráðstafaðrar pöntunar*<br>(Frá og með útgáfu 10.0.29 af Supply Chain Management er þessi eiginleiki skylda og ekki er hægt að slökkva á honum.)
