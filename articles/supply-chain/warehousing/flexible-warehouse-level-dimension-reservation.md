...
- <span data-ttu-id="749de-130">Hægt er að skrá lotunúmer og panta þegar pöntunin er tekin af söluaðilanum og ekki er hægt að breyta því við vörugeymslu og / eða taka af öðrum kröfum.</span><span class="sxs-lookup"><span data-stu-id="749de-130">A batch number can be recorded and reserved when the order is taken by the sales processor, and it can't be changed during warehouse operations and/or taken by other demands.</span></span> <span data-ttu-id="749de-131">Þessi hegðun hjálpar til við að tryggja að lotunúmerið sem var pantað er sent til viðskiptavinarins.</span><span class="sxs-lookup"><span data-stu-id="749de-131">This behavior helps guarantee that the batch number that was ordered is shipped to the customer.</span></span>
...
<span data-ttu-id="749de-163">Eftirfarandi dæmi sýnir flæði frá enda til enda.</span><span class="sxs-lookup"><span data-stu-id="749de-163">The following example shows the end-to-end flow.</span></span>
...
1. <span data-ttu-id="749de-177">Stilltu þrjár aðalgagnabreytur vörunnar með því að nota þessi gildi:</span><span class="sxs-lookup"><span data-stu-id="749de-177">Set the product's three master data parameters by using these values:</span></span>
...
9. <span data-ttu-id="749de-250">Veldu á sölupöntunarhaus **Vöruhús** \> **Aðgerðir** \> **Losa í vöruhús**.</span><span class="sxs-lookup"><span data-stu-id="749de-250">On the sales order header, select **Warehouse** \> **Actions** \> **Release to warehouse**.</span></span> <span data-ttu-id="749de-251">Pöntunarlínan hefur verið sett í bylgju og álag og vinna búin til.</span><span class="sxs-lookup"><span data-stu-id="749de-251">The order line is now waved, and a load and work are created.</span></span>
...
1. <span data-ttu-id="749de-253">Á flýtiflipanum **Sölupöntunarlínur**, veldu **Vöruhús** \> **Upplýsingar um vinnu**.</span><span class="sxs-lookup"><span data-stu-id="749de-253">On the **Sales order lines** FastTab, select **Warehouse** \> **Work details**.</span></span>
    ...
    - <span data-ttu-id="749de-262">Eftir að vinna er búin til, birgðir hlutarins þar sem **Tilvísun** reiturinn er stilltur á **Pöntunarbundin frátekt** er fjarlægður.</span><span class="sxs-lookup"><span data-stu-id="749de-262">After work is created, the item's inventory transaction where the **Reference** field is set to **Order-committed reservation** is removed.</span></span> <span data-ttu-id="749de-263">Birgðafærslan þar sem **Tilvísun** reiturinn er stilltur á **Vinna** geymir nú líkamlegan fyrirvara á öllum birgðastærðum magnsins.</span><span class="sxs-lookup"><span data-stu-id="749de-263">The inventory transaction where the **Reference** field is set to **Work** now holds the physical reservation on all the quantity's inventory dimensions.</span></span>
...
### <a name="business-scenario"></a><span data-ttu-id="749de-274">Sviðsmynd fyrirtækis</span><span class="sxs-lookup"><span data-stu-id="749de-274">Business scenario</span></span>
...
1. <span data-ttu-id="749de-286">**Heiti eiginleika:** *Sveigjanleg frátekt á vídd vöruhúsastigs*</span><span class="sxs-lookup"><span data-stu-id="749de-286">**Feature name:** *Flexible warehouse-level dimension reservation*</span></span>
...
- <span data-ttu-id="749de-298">Tilvísun (eingöngu gildið *Sölupöntun* er stutt.)</span><span class="sxs-lookup"><span data-stu-id="749de-298">Reference (Only the *Sales order* value is supported.)</span></span>
...
## <a name="example-scenario-set-up-and-process-an-order-committed-license-plate-reservation"></a><span data-ttu-id="749de-312">Dæmi: Setja upp og vinna úr frátekt á númeraplötu ráðstafaðrar pöntunar</span><span class="sxs-lookup"><span data-stu-id="749de-312">Example scenario: Set up and process an order-committed license plate reservation</span></span>
...
1. <span data-ttu-id="749de-328">Veljið **Vista**.</span><span class="sxs-lookup"><span data-stu-id="749de-328">Select **Save**.</span></span>
...
1. <span data-ttu-id="749de-383">Bæta við annarri sölupöntunarlínu sem er með eftirfarandi stillingar:</span><span class="sxs-lookup"><span data-stu-id="749de-383">Add a second sales order line that has the following settings:</span></span>
    ...
    - <span data-ttu-id="749de-384">**Vörunúmer:** *Item2*</span><span class="sxs-lookup"><span data-stu-id="749de-384">**Item number:** *Item2*</span></span>
...
1. <span data-ttu-id="749de-396">Til að taka frá vöru á tiltekinni númeraplötu, í Excel-innbótinni, skal velja **Ný** til að bæta við frátektarlínu og stilla síðan eftirfarandi gildi:</span><span class="sxs-lookup"><span data-stu-id="749de-396">To reserve an item on a specific license plate, in the Excel add-in, select **New** to add a reservation line, and then set the following values:</span></span>
    ...
    - <span data-ttu-id="749de-397">**Lotukenni:** Færið inn gildið fyrir **Lotukenni** sem fannst sölupöntunarlínuna fyrir *Item1*.</span><span class="sxs-lookup"><span data-stu-id="749de-397">**Lot ID:** Enter the **Lot ID** value that you found for the sales order line for *Item1*.</span></span>
...
1. <span data-ttu-id="749de-400">Veljið **Ný** til að bæta við annarri frátektarlínu og stillið eftirfarandi gildi:</span><span class="sxs-lookup"><span data-stu-id="749de-400">Select **New** to add another reservation line, and set the following values:</span></span>
    ...
    - <span data-ttu-id="749de-401">**Lotukenni:** Færið inn gildið fyrir **Lotukenni** sem fannst sölupöntunarlínuna fyrir *Item2*.</span><span class="sxs-lookup"><span data-stu-id="749de-401">**Lot ID:** Enter the **Lot ID** value you found for the sales order line for *Item2*.</span></span>
    - <span data-ttu-id="749de-402">**Númeraplata:** *LP02*</span><span class="sxs-lookup"><span data-stu-id="749de-402">**License plate:** *LP02*</span></span>
    - <span data-ttu-id="749de-403">**ReservedInventoryQuantity:** *5*</span><span class="sxs-lookup"><span data-stu-id="749de-403">**ReservedInventoryQuantity:** *5*</span></span>

1. <span data-ttu-id="749de-404">Í Excel-innbótinni skal velja **Birta** til að senda gögnin aftur í Supply Chain Management.</span><span class="sxs-lookup"><span data-stu-id="749de-404">In the Excel add-in, select **Publish** to send the data back to Supply Chain Management.</span></span>

    > [!NOTE]
    > <span data-ttu-id="749de-405">Frátektarlínan birtist aðeins í kerfinu ef birtingu er lokið án villna.</span><span class="sxs-lookup"><span data-stu-id="749de-405">The reservation line will appear in the system only if publishing is completed without errors.</span></span>

1. <span data-ttu-id="749de-406">Farið aftur í Supply Chain Management.</span><span class="sxs-lookup"><span data-stu-id="749de-406">Go back to Supply Chain Management.</span></span> 
1. <span data-ttu-id="749de-407">Til að yfirfara frátekningu vörunnar, í flýtiflipanum **Sölupöntunarlínur**, í valmyndinni **Birgðir**, skal velja **Vinna með \> Frátekning**.</span><span class="sxs-lookup"><span data-stu-id="749de-407">To review the item's reservation, on the **Sales order lines** FastTab, on the **Inventory** menu, select **Maintain \> Reservation**.</span></span> <span data-ttu-id="749de-408">Athugið að fyrir sölupöntunarlínuna fyrir *Item1* eru birgðir upp á *10* teknar frá og fyrir sölupöntunarlínuna fyrir *Item2*, eru birgðir upp á *5* teknar frá.</span><span class="sxs-lookup"><span data-stu-id="749de-408">Notice that, for the sales order line for *Item1*, inventory of *10* is reserved, and for the sales order line for *Item2*, inventory of *5* is reserved.</span></span>
1. <span data-ttu-id="749de-409">Til að fara yfir birgðafærslur sem tengjast frátekningu sölupöntunarlínu, í flýtiflipanum **Sölupöntunarlínur**, í valmyndinni **Birgðir**, skal velja **Skoða \> Færslur**.</span><span class="sxs-lookup"><span data-stu-id="749de-409">To review inventory transactions that are related to the sales order line reservation, on the **Sales order lines** FastTab, on the **Inventory** menu, select **View \> Transactions**.</span></span> <span data-ttu-id="749de-410">Athugið að tvær færslur eru tengdar frátekningunni: ein þar sem reiturinn **Tilvísun** er stilltur á *Sölupöntun* og ein þar sem reiturinn **Tilvísun** er stilltur á *Frátekning á ráðstafaðri pöntun*.</span><span class="sxs-lookup"><span data-stu-id="749de-410">Notice that there are two transactions that are related to the reservation: one where the **Reference** field is set to *Sales order* and one where the **Reference** field is set to *Order-committed reservation*.</span></span>

    > [!NOTE]
    > <span data-ttu-id="749de-411">Færsla þar sem reiturinn **Tilvísun** er stilltur á *Sölupöntun* sýnir frátekningu pöntunarlínu fyrir birgðavíddir sem eru fyrir ofan stigið **Staðsetning** (svæði, vöruhús og birgðastaða).</span><span class="sxs-lookup"><span data-stu-id="749de-411">A transaction where the **Reference** field is set to *Sales order* represents the order line reservation for inventory dimensions that are above the **Location** level (site, warehouse, and inventory status).</span></span> <span data-ttu-id="749de-412">Færsla þar sem reiturinn **Tilvísun** er stilltur á *Frátekning á ráðstafaðri pöntun* sýnir frátekningu pöntunarlínu fyrir tiltekna númeraplötu og staðsetningu.</span><span class="sxs-lookup"><span data-stu-id="749de-412">A transaction where the **Reference** field is set to *Order-committed reservation* represents the order line reservation for the specific license plate and location.</span></span>

1. <span data-ttu-id="749de-413">Til að losa sölupöntunina, á aðgerðasvæðinu, í flipanum **Vöruhús**, í flokknum **Aðgerðir**, skal velja **Losa í vöruhús**.</span><span class="sxs-lookup"><span data-stu-id="749de-413">To release the sales order, on the Action Pane, on the **Warehouse** tab, in the **Actions** group, select **Release to warehouse**.</span></span>

### <a name="review-and-process-warehouse-work-with-order-committed-license-plates-assigned"></a><span data-ttu-id="749de-414">Yfirfara og vinna úr vöruhúsavinnu með úthlutaðar númeraplötur ráðstafaðrar pöntunar</span><span class="sxs-lookup"><span data-stu-id="749de-414">Review and process warehouse work with order-committed license plates assigned</span></span>

1. <span data-ttu-id="749de-415">Í flýtiflipanum **Sölupöntunarlínur**, í valmyndinni **Vöruhús**, skal velja **Upplýsingar um vinnu**.</span><span class="sxs-lookup"><span data-stu-id="749de-415">On the **Sales order lines** FastTab, on the **Warehouse** menu, select **Work details**.</span></span>

    <span data-ttu-id="749de-416">Þar sem frátekning er gerð fyrir tiltekna runu, notar kerfið ekki staðsetningarleiðbeiningar þegar það stofnar vinnu fyrir sölupöntunina sem notar frátekningu númeraplötu.</span><span class="sxs-lookup"><span data-stu-id="749de-416">As when reservation is done for a specific batch, the system doesn't use location directives when it creates the work for the sales order that uses license plate reservation.</span></span> <span data-ttu-id="749de-417">Vegna þess að frátekning ráðstafaðrar pöntunar tilgreinir allar birgðavíddir, þ.á.m. staðsetningu, þarf ekki að nota staðsetningarleiðbeiningar vegna þess að birgðavíddir eru aðeins færðar inn í vinnuna.</span><span class="sxs-lookup"><span data-stu-id="749de-417">Because the order-committed reservation specifies all the inventory dimensions, including the location, location directives don't have to be used, because those inventory dimensions are just entered in the work.</span></span> <span data-ttu-id="749de-418">Þær eru sýndar í hlutanum **Úr birgðavíddum** á síðunni **Birgðafærslur vinnu**.</span><span class="sxs-lookup"><span data-stu-id="749de-418">They are shown in the **From inventory dimensions** section on the **Work inventory transactions** page.</span></span>

    > [!NOTE]
    > <span data-ttu-id="749de-419">Þegar búið er að stofna vinnu, er birgðafærsla vörunnar þar sem reiturinn **Tilvísun** er stilltur á *Frátekning á ráðstafaðri pöntun* fjarlægð.</span><span class="sxs-lookup"><span data-stu-id="749de-419">After the work is created, the item's inventory transaction where the **Reference** field is set to *Order-committed reservation* is removed.</span></span> <span data-ttu-id="749de-420">Birgðafærslan þar sem reiturinn **Tilvísun** er stilltur á *Vinna* inniheldur nú efnislega frátekningu fyrir allar birgðavíddir magns.</span><span class="sxs-lookup"><span data-stu-id="749de-420">The inventory transaction where the **Reference** field is set to *Work* now holds the physical reservation for all the quantity's inventory dimensions.</span></span>

1. <span data-ttu-id="749de-421">Í fartækinu skal ljúka tiltekt og frágangi vinnunnar með því að nota valmyndaratriði þar sem gátreiturinn **Meðhöndla eftir númeraplötu** er valið.</span><span class="sxs-lookup"><span data-stu-id="749de-421">On the mobile device, finish picking and putting the work by using a menu item where the **Handle by license plate** check box is selected.</span></span>

    > [!NOTE]
    > <span data-ttu-id="749de-422">Aðgerðin **Meðhöndla eftir númeraplötu** sér um að vinna úr allri númeraplötunni.</span><span class="sxs-lookup"><span data-stu-id="749de-422">The **Handle by license plate** functionality helps you process the whole license plate.</span></span> <span data-ttu-id="749de-423">Ef nauðsynlegt er að vinna úr hluta númeraplötunnar, er ekki hægt að nota þessa aðgerð.</span><span class="sxs-lookup"><span data-stu-id="749de-423">If you must process part of the license plate, you can't use this functionality.</span></span>
    >
    > <span data-ttu-id="749de-424">Mælt er með því að aðskilin vinna sé búin til fyrir hverja númeraplötu.</span><span class="sxs-lookup"><span data-stu-id="749de-424">We recommend that you have separate work generated for each license plate.</span></span> <span data-ttu-id="749de-425">Til að ná þessu fram skal nota eiginleikann **Vinnuhausaskil** á síðunni **Vinnusniðmát**.</span><span class="sxs-lookup"><span data-stu-id="749de-425">To achieve this result, use the **Work header breaks** feature on the **Work template** page.</span></span>

    <span data-ttu-id="749de-426">Númeraplata *LP02* er nú tínd fyrir sölupöntunarlínur og komið fyrir á staðsetningunni *Útskot*.</span><span class="sxs-lookup"><span data-stu-id="749de-426">License plate *LP02* is now picked for sales order lines and put to the *Baydoor* location.</span></span> <span data-ttu-id="749de-427">Á þessu stigi má hlaða og senda hana til viðskiptavinarins.</span><span class="sxs-lookup"><span data-stu-id="749de-427">At this point, it's ready to be loaded and dispatched to the customer.</span></span>

## <a name="exception-handling-of-warehouse-work-that-has-order-committed-batch-numbers"></a><span data-ttu-id="749de-428">Meðhöndlun undantekninga á vöruhúsavinnu sem er með rununúmer ráðstafaðra pantana</span><span class="sxs-lookup"><span data-stu-id="749de-428">Exception handling of warehouse work that has order-committed batch numbers</span></span>

<span data-ttu-id="749de-429">Vörugeymsla til að velja pöntunarbundin lotunúmer er háð sömu stöðluðu meðhöndlun undantekninga vörugeymslu og aðgerðum og venjuleg vinna.</span><span class="sxs-lookup"><span data-stu-id="749de-429">Warehouse work for picking order-committed batch numbers is subject to the same standard warehouse exception handling and actions as regular work.</span></span> <span data-ttu-id="749de-430">Almennt er hægt að hætta við opna verkið eða vinnu línuna, það er hægt að trufla það vegna þess að notendastaður er fullur, það er hægt að velja hann stutt og það er hægt að uppfæra hann vegna hreyfingar.</span><span class="sxs-lookup"><span data-stu-id="749de-430">In general, the open work or work line can be canceled, it can be interrupted because a user location is full, it can be short-picked, and it can be updated because of a movement.</span></span> <span data-ttu-id="749de-431">Sömuleiðis er hægt að draga úr valinni vinnu sem þegar hefur verið lokið eða hægt er að snúa verkinu við.</span><span class="sxs-lookup"><span data-stu-id="749de-431">Likewise, the picked quantity of work that has already been completed can be reduced, or the work can be reversed.</span></span>

<span data-ttu-id="749de-432">Eftirfarandi lykilregla er notuð við allar þessar undantekningarmeðferðaraðgerðir: aldrei er hægt að skipta um lotunúmer sem var frátekið fyrir viðskiptavininn fyrir annað lotunúmer, en hægt er að breyta geymsluvíddum hans (staðsetningu og kennitala) með annað hvort handvirkri uppfærslu af notanda eða sjálfvirka uppfærslu af kerfinu.</span><span class="sxs-lookup"><span data-stu-id="749de-432">The following key rule is applied to all these exception handling actions: the batch number that was reserved for the customer can never be replaced with a different batch number, but its storage dimensions (location and license plate) can be changed through either a manual update by the user or an automatic update by the system.</span></span> <span data-ttu-id="749de-433">Sjálfvirka uppfærslan er byggð á sömu handahófi úthlutun geymsluvíddar og gilti þegar ákveðin lota var sjálfkrafa frátekin en engar geymsluvíddir voru tilgreindar.</span><span class="sxs-lookup"><span data-stu-id="749de-433">The automatic update is based on the same random assignment of storage dimensions that applied when a specific batch was automatically reserved but no storage dimensions were specified.</span></span>

### <a name="example-scenario"></a><span data-ttu-id="749de-434">Dæmi</span><span class="sxs-lookup"><span data-stu-id="749de-434">Example scenario</span></span>

<span data-ttu-id="749de-435">Dæmi um þessa atburðarás er ástand þar sem verið er að velja áður lokið verk með því að nota virknina **Draga úr völdu magni**.</span><span class="sxs-lookup"><span data-stu-id="749de-435">An example of this scenario is a situation where previously completed work is being unpicked by using the **Reduce picked quantity** function.</span></span> <span data-ttu-id="749de-436">Þetta dæmi gerir ráð fyrir því að skrefunum sem lýst er í [Sýniaðstæður: Úthlutun rununúmers](#Example-batch-allocation) sé lokið.</span><span class="sxs-lookup"><span data-stu-id="749de-436">This example assumes that you've already completed the steps that are described in [Example scenario: Batch number allocation](#Example-batch-allocation).</span></span> <span data-ttu-id="749de-437">Það heldur áfram þar sem frá var horfið í því dæmi.</span><span class="sxs-lookup"><span data-stu-id="749de-437">It continues from that example.</span></span>

1. <span data-ttu-id="749de-438">Farðu í **Vöruhúsakerfi** \> **Hleðslur** \> **Virkar hleðslur**.</span><span class="sxs-lookup"><span data-stu-id="749de-438">Go to **Warehouse management** \> **Loads** \> **Active loads**.</span></span>
2. <span data-ttu-id="749de-439">Veldu álag sem var búið til í tengslum við sendingu sölupöntunar þinnar.</span><span class="sxs-lookup"><span data-stu-id="749de-439">Select the load that was created in connection with the shipment of your sales order.</span></span>
3. <span data-ttu-id="749de-440">Af flýtiflipanum **Hlaðið pöntunarlínum**, veldu **Draga úr völdum magni**.</span><span class="sxs-lookup"><span data-stu-id="749de-440">From the **Load order lines** FastTab, select **Reduce picked quantity**.</span></span>
4. <span data-ttu-id="749de-441">Á **Draga úr völdum magni** síðu, í **Færa á staðsetningu** reit, veldu **FL-001**.</span><span class="sxs-lookup"><span data-stu-id="749de-441">On the **Reduce picked quantity** page, in the **Move to location** field, select **FL-001**.</span></span>
5. <span data-ttu-id="749de-442">Í reitnum **Flytja á númeraplötu** velurðu **LP33**.</span><span class="sxs-lookup"><span data-stu-id="749de-442">In the **Move to license plate** field, select **LP33**.</span></span>
6. <span data-ttu-id="749de-443">Í hnitanetinu í reitnum **Magn birgða til að afturkalla tiltekt á** sláðu inn **10**.</span><span class="sxs-lookup"><span data-stu-id="749de-443">In the grid, in the **Inventory quantity to unpick** field, enter **10**.</span></span>
7. <span data-ttu-id="749de-444">Veljið **Í lagi**.</span><span class="sxs-lookup"><span data-stu-id="749de-444">Select **OK**.</span></span>

<span data-ttu-id="749de-445">Hér eru niðurstöður úr aðgerð til að afturkalla tiltekt:</span><span class="sxs-lookup"><span data-stu-id="749de-445">Here are the results of the unpicking action:</span></span>

- <span data-ttu-id="749de-446">Staða fyrri lokaðs verks er stillt á **Hætt við**.</span><span class="sxs-lookup"><span data-stu-id="749de-446">The status of the previously closed work is set to **Canceled**.</span></span>
- <span data-ttu-id="749de-447">Nýtt verk af gerðinni **Birgðahreyfing** er búin til fyrir óvalið magn af **10** fyrir lotunúmer **B11**.</span><span class="sxs-lookup"><span data-stu-id="749de-447">New work of the **Inventory movement** type is created for the unpicked quantity of **10** for batch number **B11**.</span></span> <span data-ttu-id="749de-448">Þessi vinna táknar hreyfingu frá **Afgreiðsluhurð** staðsetningu til númeraplötu **LP33** á staðsetningu **FL-001**.</span><span class="sxs-lookup"><span data-stu-id="749de-448">This work represents the movement from the **Baydoor** location to license plate **LP33** in location **FL-001**.</span></span> <span data-ttu-id="749de-449">Staðan er stillt á **Lokað**.</span><span class="sxs-lookup"><span data-stu-id="749de-449">The status is set to **Closed**.</span></span>
- <span data-ttu-id="749de-450">Kerfið áskilur aftur lotunúmerið sem upphaflega var pantað og úthlutar auðkenni staðsetningar og korts.</span><span class="sxs-lookup"><span data-stu-id="749de-450">The system re-reserves the batch number that was originally ordered, and assigns the location and license plate IDs.</span></span> <span data-ttu-id="749de-451">(Þetta ferli jafngildir því að keyra virknina **Frátektarlína** fyrir pöntunarlínuna fyrir tiltekið lotunúmer).</span><span class="sxs-lookup"><span data-stu-id="749de-451">(This process is equivalent to running the **Reserve line** function for the order line for a given batch number).</span></span> <span data-ttu-id="749de-452">Fyrir vikið, hópur **B11** er sýnt sem framið á flýtiflipanum **Hópatölur skuldbundnar til upprunalínu** af **Runufrátekt** síðu og **Frátekt** reiturinn inniheldur magn af **10** fyrir lotunúmer **B11**.</span><span class="sxs-lookup"><span data-stu-id="749de-452">As a result, batch **B11** is shown as committed on the **Batch numbers committed to source line** FastTab of the **Batch reservation** page, and the **Reservation** field contains a quantity of **10** for batch number **B11**.</span></span> <span data-ttu-id="749de-453">Að auki, er **Staðsetning** reiturinn stilltur á **FL-001**, og **Númeraplata** reiturinn er stilltur á **LP11**.</span><span class="sxs-lookup"><span data-stu-id="749de-453">Additionally, the **Location** field is set to **FL-001**, and the **License plate** field is set to **LP11**.</span></span> <span data-ttu-id="749de-454">(Þú getur bætt þessum reitum við töfluna ef þeir eru ekki sýnilegir.)</span><span class="sxs-lookup"><span data-stu-id="749de-454">(You can add these fields to the grid if they aren't visible.)</span></span>

<span data-ttu-id="749de-455">Eftirfarandi töflur veita yfirlit sem sýnir hvernig kerfið meðhöndlar pöntunarbundna lotu fyrirvara fyrir sérstakar vörugeymsluaðgerðir.</span><span class="sxs-lookup"><span data-stu-id="749de-455">The following tables provide an overview that shows how the system handles order-committed batch reservation for specific warehouse actions.</span></span> <span data-ttu-id="749de-456">Til að túlka innihaldið í töflunum, gerðu ráð fyrir að hver vörugeymslaaðgerð sé keyrð í samhengi við núverandi vörugeymsluverk sem er upprunnin í pöntunarbundinni lotu fyrirvara, eða að framkvæmd hverrar vörugerðaraðgerðar hefur áhrif á vinnu af þeirri gerð.</span><span class="sxs-lookup"><span data-stu-id="749de-456">To interpret the content in the tables, assume that each warehouse action is run in the context of existing warehouse work that originates from an order-committed batch reservation, or that execution of each warehouse action affects work of that type.</span></span>

> [!NOTE]
> <span data-ttu-id="749de-457">Í þessum töflum gefur dálkurinn „Hópmagn er fáanlegt“ til kynna hvort magn af framleiðslulotu er til viðbótar við það magn sem er annað hvort þegar frátekið fyrir núverandi pöntunarbundna fyrirvara eða þegar er frátekið af vörugeymsluverkinu sem kemur frá fyrirvörum af þeirri gerð.</span><span class="sxs-lookup"><span data-stu-id="749de-457">In these tables, the "Batch quantity is available" column indicates whether a batch quantity is available in addition to the quantity that is either already reserved for the current order-committed reservations or already reserved by the warehouse work that originates from reservations of that type.</span></span>

#### <a name="override-the-pick-location-on-the-open-work"></a><span data-ttu-id="749de-458">Yfirskrifa tínslustaðsetningu í opinni vinnu</span><span class="sxs-lookup"><span data-stu-id="749de-458">Override the pick location on the open work</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="749de-459">Færibreyta lykiluppsetningar</span><span class="sxs-lookup"><span data-stu-id="749de-459">Key setup parameter</span></span></th>
<th><span data-ttu-id="749de-460">Runumagn er fáanlegt</span><span class="sxs-lookup"><span data-stu-id="749de-460">Batch quantity is available</span></span></th>
<th><span data-ttu-id="749de-461">Lykilþrep notenda</span><span class="sxs-lookup"><span data-stu-id="749de-461">Key user steps</span></span></th>
<th><span data-ttu-id="749de-462">Vinna vöruhúss</span><span class="sxs-lookup"><span data-stu-id="749de-462">Warehouse work</span></span></th>
<th><span data-ttu-id="749de-463">Pantanaskuldbundin hópapöntun</span><span class="sxs-lookup"><span data-stu-id="749de-463">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="749de-464">Valkosturinn <strong>Leyfa val á staðsetningu staðsetningu</strong> er virkur á starfsmanninum.</span><span class="sxs-lookup"><span data-stu-id="749de-464">The <strong>Allow pick location override</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="749de-465">Já</span><span class="sxs-lookup"><span data-stu-id="749de-465">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-466">Veljið valmyndaratriðið <strong>Yfirskrifa staðsetningu</strong> í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-466">Select the <strong>Override location</strong> menu item on the warehouse app when you start picking work.</span></span></li>
<li><span data-ttu-id="749de-467">Veldu <strong>Stinga upp</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-467">Select <strong>Suggest</strong>.</span></span></li>
<li><span data-ttu-id="749de-468">Staðfestu nýja staðsetninguna sem lagt er til með tilliti til framboðs í fjölda magns.</span><span class="sxs-lookup"><span data-stu-id="749de-468">Confirm the new location that is suggested based on batch quantity availability.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-469">Eftirfarandi aðgerðir eiga sér stað í núverandi vinnu:</span><span class="sxs-lookup"><span data-stu-id="749de-469">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="749de-470">Staðsetningin á velja línunni er uppfærð á nýjan stað.</span><span class="sxs-lookup"><span data-stu-id="749de-470">The location on the pick line is updated to the new location.</span></span> <span data-ttu-id="749de-471">(Ef staðsetningin er stjórnað með leyfismerki er úthlutað af handahófi leyfismerki fyrir vörubirgðafærsluna og starfsmaðurinn getur valið úr hvaða skilti sem er með tiltækt magn.)</span><span class="sxs-lookup"><span data-stu-id="749de-471">(If the location is license plate–controlled, a random license plate is assigned to the work inventory transaction, and the worker can pick from any license plate that has available quantity.)</span></span></li>
<li><span data-ttu-id="749de-472">Ef magnið er að finna á fleiri en einni leyfisplötu á nýjum stað, er upprunalegu vallínunni skipt í margar línur sem passa við hvern kennitala.</span><span class="sxs-lookup"><span data-stu-id="749de-472">If the quantity is found on more than one license plate in the new location, the original pick line is split into multiple lines to match each license plate.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-473">Ekki tiltækt</span><span class="sxs-lookup"><span data-stu-id="749de-473">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-474">Ekkert</span><span class="sxs-lookup"><span data-stu-id="749de-474">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-475">Veljið valmyndaratriðið <strong>Yfirskrifa staðsetningu</strong> í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-475">Select the <strong>Override location</strong> menu item on the warehouse app when you start picking work.</span></span></li>
<li><span data-ttu-id="749de-476">Færa handvirkt inn staðsetningu.</span><span class="sxs-lookup"><span data-stu-id="749de-476">Manually enter a location.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-477">Aðgerðin <strong>Hnekkja staðsetningu</strong> er ekki möguleg.</span><span class="sxs-lookup"><span data-stu-id="749de-477">The <strong>Override location</strong> action isn't possible.</span></span> <span data-ttu-id="749de-478">Það mistekst og villu er hent.</span><span class="sxs-lookup"><span data-stu-id="749de-478">It fails, and an error is thrown.</span></span></td>
<td><span data-ttu-id="749de-479">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-479">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="full-button--split-a-work-line-because-of-overflow-on-the-user-location"></a><span data-ttu-id="749de-480">Fullur hnappur - Skiptu vinnulínu vegna flæða á staðsetningu notandans</span><span class="sxs-lookup"><span data-stu-id="749de-480">Full button – Split a work line because of overflow on the user location</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="749de-481">Færibreyta lykiluppsetningar</span><span class="sxs-lookup"><span data-stu-id="749de-481">Key setup parameter</span></span></th>
<th><span data-ttu-id="749de-482">Runumagn er fáanlegt</span><span class="sxs-lookup"><span data-stu-id="749de-482">Batch quantity is available</span></span></th>
<th><span data-ttu-id="749de-483">Lykilþrep notenda</span><span class="sxs-lookup"><span data-stu-id="749de-483">Key user steps</span></span></th>
<th><span data-ttu-id="749de-484">Vinna vöruhúss</span><span class="sxs-lookup"><span data-stu-id="749de-484">Warehouse work</span></span></th>
<th><span data-ttu-id="749de-485">Pantanaskuldbundin hópapöntun</span><span class="sxs-lookup"><span data-stu-id="749de-485">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="749de-486">Valkosturinn <strong>Leyfa verkaskiptingu</strong> er virkur í valmyndaratriðinu fyrir farsíma.</span><span class="sxs-lookup"><span data-stu-id="749de-486">The <strong>Allow splitting of work</strong> option is enabled on the mobile device menu item.</span></span></td>
<td><span data-ttu-id="749de-487">Ekki tiltækt</span><span class="sxs-lookup"><span data-stu-id="749de-487">Not applicable</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-488">Veljið valmyndaratriðið <strong>Fullt</strong> í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-488">Select the <strong>Full</strong> menu item on the warehouse app when you process picking work.</span></span></li>
<li><span data-ttu-id="749de-489">Í <strong>Veldu fjölda</strong> reitinn, sláðu inn hluta magns af nauðsynlegu valinu til að gefa til kynna fullan afköst.</span><span class="sxs-lookup"><span data-stu-id="749de-489">In the <strong>Pick Qty</strong> field, enter a partial quantity of the required pick to indicate the full capacity.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="749de-490">Í núverandi vinnu er magnið uppfært í það magn sem eftir verður sem þarf að velja.</span><span class="sxs-lookup"><span data-stu-id="749de-490">On the current work, the quantity is updated to the remaining quantity that must be picked.</span></span></li>
<li><span data-ttu-id="749de-491">Ný verk fyrir valið magn er búið til og lokað.</span><span class="sxs-lookup"><span data-stu-id="749de-491">New work for the picked quantity is created and closed.</span></span></li>
</ul></td>
<td><span data-ttu-id="749de-492">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-492">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="reduce-the-picked-quantity-of-completed-work-from-a-load"></a><span data-ttu-id="749de-493">Draga úr valið magn af fullunninni vinnu (úr álagi)</span><span class="sxs-lookup"><span data-stu-id="749de-493">Reduce the picked quantity of completed work (from a load)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="749de-494">Færibreyta lykiluppsetningar</span><span class="sxs-lookup"><span data-stu-id="749de-494">Key setup parameter</span></span></th>
<th><span data-ttu-id="749de-495">Runumagn er fáanlegt</span><span class="sxs-lookup"><span data-stu-id="749de-495">Batch quantity is available</span></span></th>
<th><span data-ttu-id="749de-496">Lykilþrep notenda</span><span class="sxs-lookup"><span data-stu-id="749de-496">Key user steps</span></span></th>
<th><span data-ttu-id="749de-497">Vinna vöruhúss</span><span class="sxs-lookup"><span data-stu-id="749de-497">Warehouse work</span></span></th>
<th><span data-ttu-id="749de-498">Pantanaskuldbundin hópapöntun</span><span class="sxs-lookup"><span data-stu-id="749de-498">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="749de-499">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-499">Not applicable</span></span></td>
<td><span data-ttu-id="749de-500">Já</span><span class="sxs-lookup"><span data-stu-id="749de-500">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-501">Opnaðu <strong>Draga úr völdum magni</strong> síðu frá hleðslulínunni.</span><span class="sxs-lookup"><span data-stu-id="749de-501">Open the <strong>Reduce picked quantity</strong> page from the load line.</span></span></li>
<li><span data-ttu-id="749de-502">Færa skal inn fullt magn til að afturkalla tiltekt á.</span><span class="sxs-lookup"><span data-stu-id="749de-502">Enter the full quantity to unpick.</span></span></li>
<li><span data-ttu-id="749de-503">Veldu „færa til“ staðsetningu / kennitala.</span><span class="sxs-lookup"><span data-stu-id="749de-503">Select a "move to" location/license plate.</span></span></li>
</ol>
</td>
<td>
<ul> 
<li><span data-ttu-id="749de-504">Vinna sem er tengd hleðslulínunni fellur niður.</span><span class="sxs-lookup"><span data-stu-id="749de-504">Work that is associated with the load line is canceled.</span></span></li>
<li><span data-ttu-id="749de-505">Ný verk fyrir birgðahreyfingar er búið til og lokað.</span><span class="sxs-lookup"><span data-stu-id="749de-505">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-506">Magnið er aftur frátekið fyrir sömu lotu.</span><span class="sxs-lookup"><span data-stu-id="749de-506">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="749de-507">Kerfið úthlutar af handahófi staðsetningu og kennitala (ef staðsetningin er stjórnað með skiltum) þar sem magnið er fáanlegt.</span><span class="sxs-lookup"><span data-stu-id="749de-507">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-508">Nr</span><span class="sxs-lookup"><span data-stu-id="749de-508">No</span></span></td>
<td><span data-ttu-id="749de-509">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-509">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-510">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-510">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-511">Magnið er aftur frátekið fyrir sömu framleiðslulotu og fyrir sama stað og skírteini (ef staðsetningin er stjórnað með skiltum) sem var slegið inn við upptöku.</span><span class="sxs-lookup"><span data-stu-id="749de-511">The quantity is re-reserved for the same batch, and for the same location and license plate (if the location is license plate–controlled) that were entered during unpicking.</span></span></td>
</tr>
</tbody>
</table>

#### <a name="move-an-item-within-a-warehouse"></a><span data-ttu-id="749de-512">Færa vöru til innan vöruhúss</span><span class="sxs-lookup"><span data-stu-id="749de-512">Move an item within a warehouse</span></span>

> [!NOTE]
> <span data-ttu-id="749de-513">Þessi vörugeymsla á aðeins við um flutninga á **Vinnusköpunarferli** tegund, ekki til hreyfingar eftir sniðmáti.</span><span class="sxs-lookup"><span data-stu-id="749de-513">This warehouse action is applicable only to movement of the **Work creation process** type, not to movement by template.</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="749de-514">Færibreyta lykiluppsetningar</span><span class="sxs-lookup"><span data-stu-id="749de-514">Key setup parameter</span></span></th>
<th><span data-ttu-id="749de-515">Runumagn er fáanlegt</span><span class="sxs-lookup"><span data-stu-id="749de-515">Batch quantity is available</span></span></th>
<th><span data-ttu-id="749de-516">Lykilþrep notenda</span><span class="sxs-lookup"><span data-stu-id="749de-516">Key user steps</span></span></th>
<th><span data-ttu-id="749de-517">Vinna vöruhúss</span><span class="sxs-lookup"><span data-stu-id="749de-517">Warehouse work</span></span></th>
<th><span data-ttu-id="749de-518">Pantanaskuldbundin hópapöntun</span><span class="sxs-lookup"><span data-stu-id="749de-518">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="749de-519">Valkostur <strong>Leyfa flutning birgða með tilheyrandi vinnu</strong> er virkur á starfsmanninum.</span><span class="sxs-lookup"><span data-stu-id="749de-519">The <strong>Allow movement of inventory with associated work</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="749de-520">Já</span><span class="sxs-lookup"><span data-stu-id="749de-520">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-521">Hefja færslu í vöruhúsaforritinu.</span><span class="sxs-lookup"><span data-stu-id="749de-521">Start a movement on the warehouse app.</span></span></li>
<li><span data-ttu-id="749de-522">Sláið inn staðsetningar „frá” og „til”.</span><span class="sxs-lookup"><span data-stu-id="749de-522">Enter "from" and "to" locations.</span></span></li>
</ol></td>
<td>
<ul>
<li><span data-ttu-id="749de-523">Í allri núverandi vinnu sem hefur áhrif á flutninginn, er staðsetningin valin uppfærð á nýja „til“ staðinn.</span><span class="sxs-lookup"><span data-stu-id="749de-523">On all existing work that is affected by the move, the pick location is updated to the new "to" location.</span></span></li>
<li><span data-ttu-id="749de-524">Ný verk fyrir birgðahreyfingar er búið til og lokað.</span><span class="sxs-lookup"><span data-stu-id="749de-524">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-525">Allir núverandi fyrirvarar sem hafa áhrif á magnhreyfingu frá tilteknum stað eru aftur áskilnir fyrir sömu lotu.</span><span class="sxs-lookup"><span data-stu-id="749de-525">All existing reservations that are affected by the quantity movement from the given location are re-reserved for the same batch.</span></span> <span data-ttu-id="749de-526">Kerfið úthlutar af handahófi staðsetningu og kennitala (ef staðsetningin er stjórnað með skiltum) þar sem magnið er fáanlegt.</span><span class="sxs-lookup"><span data-stu-id="749de-526">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-527">Nr</span><span class="sxs-lookup"><span data-stu-id="749de-527">No</span></span></td>
<td><span data-ttu-id="749de-528">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-528">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-529">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-529">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-530">Allur fyrirliggjandi fyrirvari sem hefur áhrif á magnhreyfingu frá tilteknum stað er aftur áskilinn fyrir sömu framleiðslulotu og fyrir nýja „til“ staðsetningar og kennitala (ef staðsetningin er stjórnað með skiltum).</span><span class="sxs-lookup"><span data-stu-id="749de-530">All existing reservations that are affected by the quantity movement from the given location are re-reserved for the same batch, and for the new "to" location and license plate (if the location is license plate–controlled).</span></span></td>
</tr>
</tbody>
</table>

#### <a name="reverse-the-picked-quantity-of-completed-work-from-a-load-or-a-wave"></a><span data-ttu-id="749de-531">Bakfærðu tiltekið magn af fullunninni vinnu (úr álagi eða bylgju)</span><span class="sxs-lookup"><span data-stu-id="749de-531">Reverse the picked quantity of completed work (from a load or a wave)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="749de-532">Færibreyta lykiluppsetningar</span><span class="sxs-lookup"><span data-stu-id="749de-532">Key setup parameter</span></span></th>
<th><span data-ttu-id="749de-533">Runumagn er fáanlegt</span><span class="sxs-lookup"><span data-stu-id="749de-533">Batch quantity is available</span></span></th>
<th><span data-ttu-id="749de-534">Lykilþrep notenda</span><span class="sxs-lookup"><span data-stu-id="749de-534">Key user steps</span></span></th>
<th><span data-ttu-id="749de-535">Vinna vöruhúss</span><span class="sxs-lookup"><span data-stu-id="749de-535">Warehouse work</span></span></th>
<th><span data-ttu-id="749de-536">Pantanaskuldbundin hópapöntun</span><span class="sxs-lookup"><span data-stu-id="749de-536">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='6'><span data-ttu-id="749de-537">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-537">Not applicable</span></span></td>
<td><span data-ttu-id="749de-538">Já</span><span class="sxs-lookup"><span data-stu-id="749de-538">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-539">Opnaðu <strong>Bakfæra vinnu</strong> síðu.</span><span class="sxs-lookup"><span data-stu-id="749de-539">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="749de-540">Veldu beiðnissíðuna <strong>Skildu hluti eftir núverandi staðsetningu</strong> kostur.</span><span class="sxs-lookup"><span data-stu-id="749de-540">On the request page, select the <strong>Leave items at current location</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-541">Öll vinna sem er tengd hleðslunni fellur niður.</span><span class="sxs-lookup"><span data-stu-id="749de-541">All work that is associated with the load is canceled.</span></span></td>
<td><span data-ttu-id="749de-542">Magnið er aftur frátekið fyrir sömu lotu.</span><span class="sxs-lookup"><span data-stu-id="749de-542">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="749de-543">Kerfið úthlutar af handahófi staðsetningu og kennitala (ef staðsetningin er stjórnað með skiltum) þar sem magnið er fáanlegt.</span><span class="sxs-lookup"><span data-stu-id="749de-543">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-544">Nr</span><span class="sxs-lookup"><span data-stu-id="749de-544">No</span></span></td>
<td><span data-ttu-id="749de-545">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-545">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-546">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-546">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-547">Magnið er frátekið fyrir sömu framleiðslulotu og fyrir staðsetningu og kennitala þar sem magnið var eftir við afturköllun.</span><span class="sxs-lookup"><span data-stu-id="749de-547">The quantity is re-reserved for the same batch, and for the location and license plate where the quantity was left upon reversal.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-548">Já</span><span class="sxs-lookup"><span data-stu-id="749de-548">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-549">Opnaðu <strong>Bakfæra vinnu</strong> síðu.</span><span class="sxs-lookup"><span data-stu-id="749de-549">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="749de-550">Veldu beiðnissíðuna <strong>Úthluta vörum á þessa staðsetningu</strong> kostur.</span><span class="sxs-lookup"><span data-stu-id="749de-550">On the request page, select the <strong>Assign items to this location</strong> option.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="749de-551">Núgildandi vinna er afturkölluð.</span><span class="sxs-lookup"><span data-stu-id="749de-551">The current work is canceled.</span></span></li>
<li><span data-ttu-id="749de-552">Ný verk fyrir birgðahreyfingar er búið til og lokað.</span><span class="sxs-lookup"><span data-stu-id="749de-552">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-553">Magnið er aftur frátekið fyrir sömu lotu.</span><span class="sxs-lookup"><span data-stu-id="749de-553">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="749de-554">Kerfið úthlutar af handahófi staðsetningu og kennitala (ef staðsetningin er stjórnað með skiltum) þar sem magnið er fáanlegt.</span><span class="sxs-lookup"><span data-stu-id="749de-554">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-555">Nr</span><span class="sxs-lookup"><span data-stu-id="749de-555">No</span></span></td>
<td><span data-ttu-id="749de-556">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-556">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-557">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-557">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-558">Magnið er frátekið fyrir sömu framleiðslulotu og fyrir staðsetningu og kennitala þar sem magnið var úthlutað á við bakfærslu.</span><span class="sxs-lookup"><span data-stu-id="749de-558">The quantity is re-reserved for the same batch, and for the location and license plate that the quantity was assigned to upon reversal.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-559">Já/nei</span><span class="sxs-lookup"><span data-stu-id="749de-559">Yes/No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-560">Opnaðu <strong>Bakfæra vinnu</strong> síðu.</span><span class="sxs-lookup"><span data-stu-id="749de-560">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="749de-561">Veldu beiðnissíðuna <strong>Færa vörur á þessa staðsetningu</strong> kostur.</span><span class="sxs-lookup"><span data-stu-id="749de-561">On the request page, select the <strong>Move items to this location</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-562">Bakfærsla er ekki studd.</span><span class="sxs-lookup"><span data-stu-id="749de-562">Reversal isn't supported.</span></span></td>
<td><span data-ttu-id="749de-563">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-563">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-564">Já/nei</span><span class="sxs-lookup"><span data-stu-id="749de-564">Yes/No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-565">Opnaðu <strong>Bakfæra vinnu</strong> síðu.</span><span class="sxs-lookup"><span data-stu-id="749de-565">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="749de-566">Veldu beiðnissíðuna <strong>Færa vörur byggt á staðsetningartilskipunum</strong> kostur.</span><span class="sxs-lookup"><span data-stu-id="749de-566">On the request page, select the <strong>Move items based on location directives</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-567">Bakfærsla er ekki studd.</span><span class="sxs-lookup"><span data-stu-id="749de-567">Reversal isn't supported.</span></span> </td>
<td><span data-ttu-id="749de-568">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-568">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="short-pick-a-quantity--register-the-quantity-as-physically-not-found-at-the-locationlicense-plate-while-you-perform-picking-work"></a><span data-ttu-id="749de-569">Veldu stutt skammt - Skráðu magnið sem ekki finnast líkamlega á staðnum / leyfismerkinu meðan þú framkvæmir tínaverk</span><span class="sxs-lookup"><span data-stu-id="749de-569">Short-pick a quantity – Register the quantity as physically not found at the location/license plate while you perform picking work</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="749de-570">Færibreyta lykiluppsetningar</span><span class="sxs-lookup"><span data-stu-id="749de-570">Key setup parameter</span></span></th>
<th><span data-ttu-id="749de-571">Runumagn er fáanlegt</span><span class="sxs-lookup"><span data-stu-id="749de-571">Batch quantity is available</span></span></th>
<th><span data-ttu-id="749de-572">Lykilþrep notenda</span><span class="sxs-lookup"><span data-stu-id="749de-572">Key user steps</span></span></th>
<th><span data-ttu-id="749de-573">Vinna vöruhúss</span><span class="sxs-lookup"><span data-stu-id="749de-573">Warehouse work</span></span></th>
<th><span data-ttu-id="749de-574">Pantanaskuldbundin hópapöntun</span><span class="sxs-lookup"><span data-stu-id="749de-574">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="749de-575">Vinna undantekning frá <strong>Stutt val</strong> gerð er sett upp, hvar <strong>Endurúthlutun hlutar</strong> = <strong>Enginn</strong>, <strong>Stilla lager</strong> = <strong>Já</strong> og <strong>Fjarlægðu fyrirvara</strong> = <strong>Nei</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-575">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>None</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No</strong>.</span></span></td>
<td><span data-ttu-id="749de-576">Já</span><span class="sxs-lookup"><span data-stu-id="749de-576">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-577">Veljið <strong>Of lítil tiltekt</strong> -valmyndaratriðið í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-577">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="749de-578">Í <strong>Tiltekið magn</strong> reitinn er fært inn <strong>0</strong> (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-578">In the <strong>Pick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="749de-579">Í reitinn <strong>Ástæða</strong> slærðu inn <strong>Engin endurúthlutun</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-579">In the <strong>Reason</strong> field, enter <strong>No reallocation</strong>.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="749de-580">Núverandi verk er lokað og valið magn er 0 (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-580">The current work is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="749de-581">Birgðafærsla <strong>Telja</strong> tegund og <strong>Selt</strong> útgáfutegund er búin til til að tákna aðlögunina.</span><span class="sxs-lookup"><span data-stu-id="749de-581">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-582">Magnið er aftur frátekið fyrir sömu lotu.</span><span class="sxs-lookup"><span data-stu-id="749de-582">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="749de-583">Kerfið úthlutar af handahófi staðsetningu og kennitala (ef staðsetningin er stjórnað með skiltum) þar sem magnið er fáanlegt.</span><span class="sxs-lookup"><span data-stu-id="749de-583">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-584">Nr</span><span class="sxs-lookup"><span data-stu-id="749de-584">No</span></span></td>
<td><span data-ttu-id="749de-585">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-585">See the previous row.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="749de-586">Of lítil tiltekt-aðgerðin mistekst og villu er hent.</span><span class="sxs-lookup"><span data-stu-id="749de-586">The short-picking action fails, and an error is thrown.</span></span></li>
<li><span data-ttu-id="749de-587">Núverandi verk er áfram opið.</span><span class="sxs-lookup"><span data-stu-id="749de-587">The current work remains open.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-588">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-588">Not applicable</span></span></td>
</tr>
<tr>
<td rowspan='2'><span data-ttu-id="749de-589">Vinna undantekning frá <strong>Stutt val</strong> gerð er sett upp, hvar <strong>Endurúthlutun hlutar</strong> = <strong>Enginn</strong>, <strong>Stilla lager</strong> = <strong>Já</strong> og <strong>Fjarlægðu fyrirvara</strong> = <strong>Já</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-589">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>None</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>Yes</strong>.</span></span></td>
<td><span data-ttu-id="749de-590">Já</span><span class="sxs-lookup"><span data-stu-id="749de-590">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-591">Veljið <strong>Of lítil tiltekt</strong> -valmyndaratriðið í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-591">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="749de-592">Í <strong>Tiltekið magn</strong> reitinn er fært inn <strong>0</strong> (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-592">In the <strong>Pick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="749de-593">Í reitinn <strong>Ástæða</strong> slærðu inn <strong>Engin endurúthlutun</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-593">In the <strong>Reason</strong> field, enter <strong>No reallocation</strong>.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="749de-594">Núverandi verk er lokað og valið magn er 0 (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-594">The current work is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="749de-595">Birgðafærsla <strong>Telja</strong> tegund og <strong>Selt</strong> útgáfutegund er búin til til að tákna aðlögunina.</span><span class="sxs-lookup"><span data-stu-id="749de-595">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-596">Allar núverandi frátektir sem hafa áhrif á magnleiðréttingu á staðsetningu þar sem tiltekt er of lítil eru endurfráteknar fyrir sömu lotu.</span><span class="sxs-lookup"><span data-stu-id="749de-596">All existing reservations that are affected by the quantity adjustment in the short-picked location are re-reserved for the same batch.</span></span> <span data-ttu-id="749de-597">Kerfið úthlutar af handahófi staðsetningu og kennitala (ef staðsetningin er stjórnað með skiltum) þar sem magnið er fáanlegt.</span><span class="sxs-lookup"><span data-stu-id="749de-597">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-598">Nr</span><span class="sxs-lookup"><span data-stu-id="749de-598">No</span></span></td>
<td><span data-ttu-id="749de-599">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-599">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-600">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-600">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-601">Allar núverandi frátektir sem hafa áhrif á magnleiðréttingu á staðsetningu þar sem tiltekt er of lítil eru fjarlægðar.</span><span class="sxs-lookup"><span data-stu-id="749de-601">All existing reservations that are affected by the quantity adjustment in the short-picked location are removed.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-602">Vinna undantekning frá <strong>Stutt val</strong> gerð er sett upp, hvar <strong>Endurúthlutun hlutar</strong> = <strong>Handvirkt</strong>, <strong>Stilla lager</strong> = <strong>Já</strong> og <strong>Fjarlægðu fyrirvara</strong> = <strong>Nei/Já</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-602">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No/Yes</strong>.</span></span> <span data-ttu-id="749de-603">Að auki, er <strong>Leyfa endurúthlutun handvirkra atriða</strong> valkostur virkur á starfsmanninum.</span><span class="sxs-lookup"><span data-stu-id="749de-603">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="749de-604">Já</span><span class="sxs-lookup"><span data-stu-id="749de-604">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-605">Veljið <strong>Of lítil tiltekt</strong> -valmyndaratriðið í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-605">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="749de-606">Í <strong>Magn með of litla tiltekt</strong> reitinn er fært inn <strong>0</strong> (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-606">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="749de-607">Í <strong>Ástæða</strong> reit, veldu <strong>Stuttur velja með handvirkri úthlutun</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-607">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
<li><span data-ttu-id="749de-608">Veldu staðsetningu / kennitala á listanum.</span><span class="sxs-lookup"><span data-stu-id="749de-608">Select the location/license plate in the list.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="749de-609">Eftirfarandi aðgerðir eiga sér stað í núverandi vinnu:</span><span class="sxs-lookup"><span data-stu-id="749de-609">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="749de-610">Tínslulínan er lokuð og valið magn er 0 (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-610">The pick line is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="749de-611">Hætt er við að söluréttarlínuna.</span><span class="sxs-lookup"><span data-stu-id="749de-611">The put line is canceled.</span></span></li>
<li><span data-ttu-id="749de-612">Ný tiltektarlína er búin til.</span><span class="sxs-lookup"><span data-stu-id="749de-612">A new pick line is created.</span></span> <span data-ttu-id="749de-613">Það notar staðsetningu / númeraplötu sem notandinn valdi.</span><span class="sxs-lookup"><span data-stu-id="749de-613">It uses the location/license plate that the user selected.</span></span></li>
<li><span data-ttu-id="749de-614">Ný söluréttarlína er búin til.</span><span class="sxs-lookup"><span data-stu-id="749de-614">A new put line is created.</span></span></li>
</ul>
</li>
<li><span data-ttu-id="749de-615">Birgðafærsla <strong>Telja</strong> tegund og <strong>Selt</strong> útgáfutegund er búin til til að tákna aðlögunina.</span><span class="sxs-lookup"><span data-stu-id="749de-615">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-616">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-616">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-617">Vinnuundantekning frá <strong>Stutt val</strong> gerð er sett upp, hvar <strong>Endurúthlutun hlutar</strong> = <strong>Handvirkt</strong>, <strong>Stilla lager</strong> = <strong>Já</strong> og <strong>Fjarlægðu fyrirvara</strong> = <strong>Nei</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-617">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No</strong>.</span></span> <span data-ttu-id="749de-618">Að auki, er <strong>Leyfa endurúthlutun handvirkra atriða</strong> valkostur virkur á starfsmanninum.</span><span class="sxs-lookup"><span data-stu-id="749de-618">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="749de-619">Ekkert</span><span class="sxs-lookup"><span data-stu-id="749de-619">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-620">Veljið <strong>Of lítil tiltekt</strong> -valmyndaratriðið í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-620">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="749de-621">Í <strong>Magn með of litla tiltekt</strong> reitinn er fært inn <strong>0</strong> (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-621">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="749de-622">Í <strong>Ástæða</strong> reit, veldu <strong>Stuttur velja með handvirkri úthlutun</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-622">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-623">Of lítil tiltekt-aðgerðin mistekst og villu er hent.</span><span class="sxs-lookup"><span data-stu-id="749de-623">The short-picking action fails, and an error is thrown.</span></span></td>
<td><span data-ttu-id="749de-624">Á ekki við</span><span class="sxs-lookup"><span data-stu-id="749de-624">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-625">Vinnuundantekning frá <strong>Stutt val</strong> gerð er sett upp, hvar <strong>Endurúthlutun hlutar</strong> = <strong>Handvirkt</strong>, <strong>Stilla lager</strong> = <strong>Já</strong> og <strong>Fjarlægðu fyrirvara</strong> = <strong>Já</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-625">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>Yes</strong>.</span></span> <span data-ttu-id="749de-626">Að auki, er <strong>Leyfa endurúthlutun handvirkra atriða</strong> valkostur virkur á starfsmanninum.</span><span class="sxs-lookup"><span data-stu-id="749de-626">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="749de-627">Ekkert</span><span class="sxs-lookup"><span data-stu-id="749de-627">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-628">Veljið <strong>Of lítil tiltekt</strong> -valmyndaratriðið í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-628">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="749de-629">Í <strong>Magn með of litla tiltekt</strong> reitinn er fært inn <strong>0</strong> (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-629">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="749de-630">Í <strong>Ástæða</strong> reit, veldu <strong>Stuttur velja með handvirkri úthlutun</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-630">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
<li><span data-ttu-id="749de-631">Veldu staðsetningu / kennitala á listanum.</span><span class="sxs-lookup"><span data-stu-id="749de-631">Select the location/license plate in the list.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="749de-632">Eftirfarandi aðgerðir eiga sér stað í núverandi vinnu:</span><span class="sxs-lookup"><span data-stu-id="749de-632">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="749de-633">Tínslulínan er lokuð og valið magn er 0 (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-633">The pick line is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="749de-634">Hætt er við að söluréttarlínuna.</span><span class="sxs-lookup"><span data-stu-id="749de-634">The put line is canceled.</span></span></li>
</ul>
</li>
<li><span data-ttu-id="749de-635">Birgðafærsla <strong>Telja</strong> tegund og <strong>Selt</strong> útgáfutegund er búin til til að tákna aðlögunina.</span><span class="sxs-lookup"><span data-stu-id="749de-635">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="749de-636">Allar núverandi frátektir sem hafa áhrif á magnleiðréttingu á staðsetningu þar sem tiltekt er of lítil/númeraplötu eru fjarlægðar.</span><span class="sxs-lookup"><span data-stu-id="749de-636">All existing reservations that are affected by the quantity adjustment in the short-picked location/license plate are removed.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-637">Vinnuundantekning frá <strong>Stutt val</strong> gerð er sett upp, hvar <strong>Endurúthlutun hlutar</strong> = <strong>Sjálfvirkt</strong>, <strong>Stilla lager</strong> = <strong>Já/Nei</strong> og <strong>Fjarlægðu fyrirvara</strong> = <strong>Já/Nei</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-637">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Automatic</strong>, <strong>Adjust inventory</strong> = <strong>Yes/No</strong>, and <strong>Remove reservations</strong> = <strong>Yes/No</strong>.</span></span></td>
<td><span data-ttu-id="749de-638">Ekki tiltækt</span><span class="sxs-lookup"><span data-stu-id="749de-638">Not applicable</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-639">Veljið <strong>Of lítil tiltekt</strong> -valmyndaratriðið í vöruhúsaforritinu þegar tiltektarverk er hafið.</span><span class="sxs-lookup"><span data-stu-id="749de-639">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="749de-640">Í <strong>Magn með of litla tiltekt</strong> reitinn er fært inn <strong>0</strong> (núll).</span><span class="sxs-lookup"><span data-stu-id="749de-640">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="749de-641">Í <strong>Ástæða</strong> reit, veldu <strong>Stuttur velja með sjálfvirkri endurúthlutun</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-641">In the <strong>Reason</strong> field, select <strong>Short Picking with automatic reallocation</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-642">Ekki er stutt í skammval sem felur í sér sjálfvirka endurúthlutun.</span><span class="sxs-lookup"><span data-stu-id="749de-642">Short-picking that involves automatic reallocation isn't supported.</span></span></td>
<td><span data-ttu-id="749de-643">Ekki er stutt í skammval sem felur í sér sjálfvirka endurúthlutun.</span><span class="sxs-lookup"><span data-stu-id="749de-643">Short-picking that involves automatic reallocation isn't supported.</span></span></td>
</tr>
</tbody>
</table>

#### <a name="change-the-inventory-status"></a><span data-ttu-id="749de-644">Breyta á birgðastöðunni</span><span class="sxs-lookup"><span data-stu-id="749de-644">Change the inventory status</span></span>

> [!NOTE]
> <span data-ttu-id="749de-645">Þessa vörugeymsluaðgerð er hægt að framkvæma frá mörgum inngangspunktum.</span><span class="sxs-lookup"><span data-stu-id="749de-645">This warehouse action can be performed from multiple entry points.</span></span> <span data-ttu-id="749de-646">Dæmið sem sýnt er hér notar **Breyting á birgðum** aðgerð á **Á lager eftir birgðageymslu** síðu.</span><span class="sxs-lookup"><span data-stu-id="749de-646">The example that is shown here uses **Inventory status change** action on the **On-hand by location** page.</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="749de-647">Færibreyta lykiluppsetningar</span><span class="sxs-lookup"><span data-stu-id="749de-647">Key setup parameter</span></span></th>
<th><span data-ttu-id="749de-648">Runumagn er fáanlegt</span><span class="sxs-lookup"><span data-stu-id="749de-648">Batch quantity is available</span></span></th>
<th><span data-ttu-id="749de-649">Lykilþrep notenda</span><span class="sxs-lookup"><span data-stu-id="749de-649">Key user steps</span></span></th>
<th><span data-ttu-id="749de-650">Vinna vöruhúss</span><span class="sxs-lookup"><span data-stu-id="749de-650">Warehouse work</span></span></th>
<th><span data-ttu-id="749de-651">Pantanaskuldbundin hópapöntun</span><span class="sxs-lookup"><span data-stu-id="749de-651">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="749de-652">Á <strong>Vöruhús</strong> flipanum, í <strong>Vöruhús</strong> skrá, er <strong>Fjarlægja frátektir og merkingar</strong> reiturinn stilltur á <strong>Frátektir</strong> eða <strong>Merkingar og fyrirvarar</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-652">On the <strong>Warehouse</strong> tab, in the <strong>Warehouse</strong> record, the <strong>Remove reservations and markings</strong> field is set to <strong>Reservations</strong> or <strong>Markings and reservations</strong>.</span></span></td>
<td><span data-ttu-id="749de-653">Já</span><span class="sxs-lookup"><span data-stu-id="749de-653">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-654">Veldu tiltekna staðsetningu.</span><span class="sxs-lookup"><span data-stu-id="749de-654">Select a specific location.</span></span></li>
<li><span data-ttu-id="749de-655">Veldu línu sem er með tiltekinn hlut, staðsetningu og númeraplötu (ef staðsetningin er stjórnað með skiltum).</span><span class="sxs-lookup"><span data-stu-id="749de-655">Select a line that has a specific item, location, and license plate (if the location is license plate–controlled).</span></span></li>
<li><span data-ttu-id="749de-656">Veldu <strong>Breyting á birgðastöðu</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-656">Select <strong>Inventory status change</strong>.</span></span></li>
<li><span data-ttu-id="749de-657">Stilltu reitinn <strong>Staða birgða</strong> til <strong>Lokun</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-657">Set the <strong>Inventory status</strong> field to <strong>Blocking</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-658">Breytingar á birgðastöðu eru ekki leyfðar fyrir magn sem er frátekið fyrir vinnu.</span><span class="sxs-lookup"><span data-stu-id="749de-658">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="749de-659">Magnið er aftur frátekið fyrir sömu lotu.</span><span class="sxs-lookup"><span data-stu-id="749de-659">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="749de-660">Kerfið úthlutar af handahófi staðsetningu og kennitala (ef staðsetningin er stjórnað með skiltum) þar sem magnið er fáanlegt.</span><span class="sxs-lookup"><span data-stu-id="749de-660">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></li>
<li><span data-ttu-id="749de-661">Tvö birgðafærslur <strong>Breyting á birgðum</strong> gerð eru búin til til að tákna breytinguna á stöðu birgða.</span><span class="sxs-lookup"><span data-stu-id="749de-661">Two inventory transactions of the <strong>Inventory status change</strong> type are created to represent the change in the inventory status dimension.</span></span></li>
<li><span data-ttu-id="749de-662">Birgðafærsla af gerðinni <strong>Stöðvun birgða</strong> og gerð útreyfingar <strong>Frátekið á lager</strong> er búin til til að tákna fyrirvara á lokað magn.</span><span class="sxs-lookup"><span data-stu-id="749de-662">An inventory transaction of the <strong>Inventory blocking</strong> type and the <strong>Reserved physical</strong> issue type is created to represent the reservation of the blocked quantity.</span></span></li>
</ul>
</td>
</tr>
<tr>
<td><span data-ttu-id="749de-663">Nr</span><span class="sxs-lookup"><span data-stu-id="749de-663">No</span></span></td>
<td><span data-ttu-id="749de-664">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-664">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-665">Breytingar á birgðastöðu eru ekki leyfðar fyrir magn sem er frátekið fyrir vinnu.</span><span class="sxs-lookup"><span data-stu-id="749de-665">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="749de-666">Pöntunin er fjarlægð.</span><span class="sxs-lookup"><span data-stu-id="749de-666">The reservation is removed.</span></span></li>
<li><span data-ttu-id="749de-667">Tvö birgðafærslur <strong>Breyting á birgðum</strong> gerð eru búin til til að tákna breytinguna á stöðu birgða.</span><span class="sxs-lookup"><span data-stu-id="749de-667">Two inventory transactions of the <strong>Inventory status change</strong> type are created to represent the change in the inventory status dimension.</span></span></li>
<li><span data-ttu-id="749de-668">Birgðafærsla af gerðinni <strong>Stöðvun birgða</strong> og gerð útreyfingar <strong>Frátekið á lager</strong> er búin til til að tákna fyrirvara á lokað magn.</span><span class="sxs-lookup"><span data-stu-id="749de-668">An inventory transaction of the <strong>Inventory blocking</strong> type and the <strong>Reserved physical</strong> issue type is created to represent the reservation of the blocked quantity.</span></span></li>
</ul>
</td>
</tr>
<tr>
<td rowspan='2'><span data-ttu-id="749de-669">Á flipanum <strong>Vöruhús</strong>, í skránni <strong>Vöruhús</strong>, er reiturinn <strong>Fjarlægja frátektir og merkingar</strong> stilltur á <strong>Ekkert</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-669">On the <strong>Warehouse</strong> tab, in the <strong>Warehouse</strong> record, the <strong>Remove reservations and markings</strong> field is set to <strong>None</strong>.</span></span></td>
<td><span data-ttu-id="749de-670">Já</span><span class="sxs-lookup"><span data-stu-id="749de-670">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="749de-671">Veldu tiltekna staðsetningu.</span><span class="sxs-lookup"><span data-stu-id="749de-671">Select a specific location.</span></span></li>
<li><span data-ttu-id="749de-672">Veldu línu sem er með tiltekinn hlut, staðsetningu og númeraplötu (ef staðsetningin er stjórnað með skiltum).</span><span class="sxs-lookup"><span data-stu-id="749de-672">Select a line that has a specific item, location, and license plate (if the location is license plate–controlled).</span></span></li>
<li><span data-ttu-id="749de-673">Veldu <strong>Breyting á birgðastöðu</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-673">Select <strong>Inventory status change</strong>.</span></span></li>
<li><span data-ttu-id="749de-674">Stilltu reitinn <strong>Staða birgða</strong> til <strong>Lokun</strong>.</span><span class="sxs-lookup"><span data-stu-id="749de-674">Set the <strong>Inventory status</strong> field to <strong>Blocking</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="749de-675">Breytingar á birgðastöðu eru ekki leyfðar fyrir magn sem er frátekið fyrir vinnu.</span><span class="sxs-lookup"><span data-stu-id="749de-675">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td><span data-ttu-id="749de-676">Magnið er aftur frátekið fyrir sömu lotu.</span><span class="sxs-lookup"><span data-stu-id="749de-676">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="749de-677">Kerfið úthlutar af handahófi staðsetningu og kennitala (ef staðsetningin er stjórnað með skiltum) þar sem magnið er fáanlegt.</span><span class="sxs-lookup"><span data-stu-id="749de-677">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="749de-678">Nr</span><span class="sxs-lookup"><span data-stu-id="749de-678">No</span></span></td>
<td><span data-ttu-id="749de-679">Sjá fyrri línuna.</span><span class="sxs-lookup"><span data-stu-id="749de-679">See the previous row.</span></span></td>
<td><span data-ttu-id="749de-680">Breytingar á birgðastöðu eru ekki leyfðar fyrir magn sem er frátekið fyrir vinnu.</span><span class="sxs-lookup"><span data-stu-id="749de-680">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td><span data-ttu-id="749de-681">Breytingar á birgðastöðu eru ekki leyfðar.</span><span class="sxs-lookup"><span data-stu-id="749de-681">Inventory status changes aren't allowed.</span></span></td>
</tr>
</tbody>
</table>

## <a name="limitations"></a><span data-ttu-id="749de-682">Takmarkanir</span><span class="sxs-lookup"><span data-stu-id="749de-682">Limitations</span></span>

- <span data-ttu-id="749de-683">Sveigjanleiki vörugeymsluvíddar pöntunaraðgerða styður ekki eftirfarandi eiginleika:</span><span class="sxs-lookup"><span data-stu-id="749de-683">The flexible warehouse-level dimension reservation functionality doesn't support the following features:</span></span>

    - <span data-ttu-id="749de-684">Stjórnun framleiðsluþyngdar</span><span class="sxs-lookup"><span data-stu-id="749de-684">Catch weight management</span></span>
    - <span data-ttu-id="749de-685">Efnislega neikvæð birgðastaða</span><span class="sxs-lookup"><span data-stu-id="749de-685">Physical negative inventory</span></span>
    - <span data-ttu-id="749de-686">Frátekt gegn pöntuðu framboði</span><span class="sxs-lookup"><span data-stu-id="749de-686">Reservation against ordered supply</span></span>
    - <span data-ttu-id="749de-687">Flytja pantanir og hráefni tína</span><span class="sxs-lookup"><span data-stu-id="749de-687">Transfer orders and raw material picking</span></span>

- <span data-ttu-id="749de-688">Reglugerð um gámasamstæðu fyrir pökkun með tilskipunareiningunni hefur takmarkanir.</span><span class="sxs-lookup"><span data-stu-id="749de-688">The container consolidation rule for packing by directive unit has limitations.</span></span> <span data-ttu-id="749de-689">Fyrir pöntunarbundna fyrirvara mælum við með að þú notir ekki sniðmát fyrir gámagerð þar sem **Pakkning eftir tilskipunareining** reiturinn er virkur.</span><span class="sxs-lookup"><span data-stu-id="749de-689">For order-committed reservations, we recommend that you not use container build templates where the **Pack by directive unit** field is enabled.</span></span> <span data-ttu-id="749de-690">Í núverandi hönnun eru staðsetningartilskipanir ekki notaðar þegar vörugeymsla er búin til.</span><span class="sxs-lookup"><span data-stu-id="749de-690">In the current design, location directives aren't used when warehouse work is created.</span></span> <span data-ttu-id="749de-691">Þess vegna er aðeins lægsta einingin í einingaröðarhópnum (birgðaeiningin) beitt á gámabylgjuskrefinu.</span><span class="sxs-lookup"><span data-stu-id="749de-691">Therefore, only the lowest unit in the unit sequence group (the inventory unit) is applied during the containerization wave step.</span></span>
