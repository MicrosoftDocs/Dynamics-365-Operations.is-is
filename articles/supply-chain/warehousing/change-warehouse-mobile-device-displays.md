...
ms.locfileid: "859760"
---
# <a name="warehouse-mobile-device-display-settings"></a>Skjástillingar fartækis vöruhúss

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Þessi eiginleiki hefur verið úreltur. Sjá [Fjarlægðir eða úreltir eiginleikar](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal) fyrir frekari upplýsingar.
