...
- <span data-ttu-id="a5f6a-124">**Eining:** *Vöruhúsakerfi*</span><span class="sxs-lookup"><span data-stu-id="a5f6a-124">**Module:** *Warehouse management*</span></span>
...
1. <span data-ttu-id="a5f6a-141">Fara í **Vöruhúsakerfi \> Uppsetning \> Vöruhús \> Forstillingar staðsetningar**.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-141">Go to **Warehouse management \> Setup \> Warehouse \> Location profiles**.</span></span>
...
1. <span data-ttu-id="a5f6a-160">Veljið **Vista**.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-160">Select **Save**.</span></span>
...
1. <span data-ttu-id="a5f6a-178">Veljið **Vista**.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-178">Select **Save**.</span></span>
...
1. <span data-ttu-id="a5f6a-183">Stilltu eftirfarandi gildi í haus nýja sniðmátsins:</span><span class="sxs-lookup"><span data-stu-id="a5f6a-183">In the header of the new template, set the following values:</span></span>
    ...
    - <span data-ttu-id="a5f6a-194">**Vöruhús:** *62*</span><span class="sxs-lookup"><span data-stu-id="a5f6a-194">**Warehouse:** *62*</span></span>
...
1. <span data-ttu-id="a5f6a-196">Stilltu eftirfarandi gildi á flýtiflipanum **Almennt**:</span><span class="sxs-lookup"><span data-stu-id="a5f6a-196">On the **General** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="a5f6a-227">**Forstillingarkenni pökkunar:** *Raða*</span><span class="sxs-lookup"><span data-stu-id="a5f6a-227">**Packing profile ID:** *Sort*</span></span>
...
1. <span data-ttu-id="a5f6a-244">Farið í **Vöruhúsakerfi \> Uppsetning \> Bylgjur \> Vinnsluaðferðir bylgju**.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-244">Go to **Warehouse management \> Setup \> Waves \> Wave process methods**.</span></span>
...
1. <span data-ttu-id="a5f6a-261">Veljið **Vista**.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-261">Select **Save**.</span></span>
...
### <a name="location-directives"></a><span data-ttu-id="a5f6a-283">Staðsetningarleiðbeiningar</span><span class="sxs-lookup"><span data-stu-id="a5f6a-283">Location directives</span></span>
...
1. <span data-ttu-id="a5f6a-303">Veldu **Vista** til að gera flýtiflipann **Aðgerðir í staðsetningarleiðbeiningum** tiltækan.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-303">Select **Save** to make the **Location Directive Actions** FastTab available.</span></span>
...
1. <span data-ttu-id="a5f6a-322">Opnaðu **Vöruhúsastjórnun \> Vinna \> Vinnusniðmát**.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-322">Go to **Warehouse management \> Work \> Work templates**.</span></span>
...
1. <span data-ttu-id="a5f6a-341">Veljið aftur **Ný** og stillið síðan eftirfarandi gildi fyrir línu 2:</span><span class="sxs-lookup"><span data-stu-id="a5f6a-341">Select **New** again, and then set the following values for line 2:</span></span>
...
<span data-ttu-id="a5f6a-356">Áður en hægt er að sýna virknina þarf að búa til eftirspurn.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-356">Before the functionality can be demonstrated, you must create some demand.</span></span> <span data-ttu-id="a5f6a-357">Í þessari atburðarás býrðu til þrjár sölupantanir fyrir þrjá mismunandi viðskiptavini til að líkja eftir mismunandi afhendingaraðsetrum.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-357">For this scenario, you will create three sales orders for three different customers to simulate different delivery addresses.</span></span> <span data-ttu-id="a5f6a-358">Þú býrð þar af leiðandi til þrjár aðskildar sendingar.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-358">In this way, you will create three separate shipments.</span></span>
...
1. <span data-ttu-id="a5f6a-373">Veldu **Bæta við línu** til að bæta við annarri línu og stilltu eftirfarandi gildi:</span><span class="sxs-lookup"><span data-stu-id="a5f6a-373">Select **Add line** to add a second line, and set the following values:</span></span>
    ...
    - <span data-ttu-id="a5f6a-374">**Vörunúmer:** *A0002*</span><span class="sxs-lookup"><span data-stu-id="a5f6a-374">**Item number:** *A0002*</span></span>
...
1. <span data-ttu-id="a5f6a-396">Veljið **Ný** til að stofna sölupöntun fyrir pöntun 3.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-396">Select **New** to create a sales order for order 3.</span></span>
...
1. <span data-ttu-id="a5f6a-414">Á aðgerðasvæðinu, í flipanum **Vöruhús**, skal velja **Losa í vöruhús**.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-414">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>
    ...
    <span data-ttu-id="a5f6a-415">Þú færð skilaboð með upplýsingum um bylgjuauðkenni og sendingarkenni sem voru búin til.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-415">You receive an informational message that shows the wave ID and shipment ID that were created.</span></span>
...
1. <span data-ttu-id="a5f6a-448">Staðfestið fyrstu tiltektina.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-448">Confirm the first pick work.</span></span>
...
1. <span data-ttu-id="a5f6a-460">Í valmyndinni **Útleið** skal velja **Raða** til að hefja röðun á vörum.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-460">On the **Outbound** menu, select **Sort** to start to sort the items.</span></span>
1. <span data-ttu-id="a5f6a-461">Í reitinn **NP/GÁM** skal færa inn marknúmeraplötu fyrir sölupöntunarvinnuna sem var tínd.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-461">In the **LP/CON** field, enter the target license plate of the picked sales order work.</span></span>
1. <span data-ttu-id="a5f6a-462">Staðfestu færsluna.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-462">Confirm your entry.</span></span>
1. <span data-ttu-id="a5f6a-463">Sláið inn vörunúmerið sem á fyrst að raða.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-463">Enter the item number to sort first.</span></span>
1. <span data-ttu-id="a5f6a-464">Kerfið ákvarðar fyrsta röðunarstaðinn sem á að sýna.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-464">The system determines the first sort position that should be shown.</span></span> <span data-ttu-id="a5f6a-465">Staðfestið röðunarstaðinn.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-465">Confirm the sort position.</span></span>
1. <span data-ttu-id="a5f6a-466">Beðið er um að númeraplötu verði úthlutað á röðunarstaðinn.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-466">You're prompted to assign a license plate to the sort position.</span></span> <span data-ttu-id="a5f6a-467">Veljið reitinn **NP**, færið inn númer númeraplötu og staðfestið síðan innsláttinn.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-467">Select the **LP** field, enter a license plate number, and then confirm your entry.</span></span>

    <span data-ttu-id="a5f6a-468">Röðunarstaðurinn tengist auðkenni sendingar og því þarf að raða tíndum vörum á númeraplötu sem á við þessa tilteknu sendingu á útleið og sölupöntun.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-468">Because the sort position is related to the shipment ID, you will sort the picked items into a license plate that is specific to the outbound shipment and sales order.</span></span>

    <span data-ttu-id="a5f6a-469">Næsta síðan sýnir vörukennið, magn, staðsetningarkenni röðunar og auðkenni „frá“ (tiltekt) og „til“ (röðun) númeraplatnanna.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-469">The next page shows the item ID, quantity, sort position ID, and the "from" (picking) and "to" (sorting) license plate IDs.</span></span> <span data-ttu-id="a5f6a-470">Upplýsingarnar á þessari síðu segja þér að raða tiltekinni vöru og magni frá númeraplötu tiltektar í númeraplötu röðunar.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-470">The information on this page instructs you to sort the specified item and quantities from the picking license plate into the sorting license plate.</span></span>

1. <span data-ttu-id="a5f6a-471">Staðfestið röðunarstaðinn.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-471">Confirm the sort position.</span></span>
1. <span data-ttu-id="a5f6a-472">Raðið vörunum í fyrstu röðunarstaðsetninguna.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-472">Sort the items in the first sort position.</span></span> <span data-ttu-id="a5f6a-473">Þegar þessu er lokið beinir kerfið þér að næsta röðunarstað.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-473">When you've finished, the system directs you to the next sort position.</span></span>
1. <span data-ttu-id="a5f6a-474">Endurtakið þetta ferli fyrir allar tíndar línur í vinnubeiðninni.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-474">Repeat this process for all picked lines on the work order.</span></span> <span data-ttu-id="a5f6a-475">Einnig ætti að nota þetta ferli þegar margar tiltektarlínur eru með sama vörunúmerið.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-475">You should also use this process when there are multiple pick lines that have the same item number.</span></span>

    <span data-ttu-id="a5f6a-476">Þegar þetta ferli er endurtekið fyrir allar vörurnar, metur kerfið skilyrðið úr næstu skönnuðu vöru (vinnulínu) og ákveður hvaða röðunarstaðsetningu ætti að setja hana í.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-476">As you repeat this process for all items, the system evaluates the criteria from the next scanned item (work line) and determines which sorting position it should be put to.</span></span> <span data-ttu-id="a5f6a-477">Þér er sjálfkrafa sagt að setja vöruna á rétta röðunarstaðsetningu.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-477">You're automatically directed to put the item to the correct sort position.</span></span> <span data-ttu-id="a5f6a-478">Það fer eftir uppsetningu staðfestingar, en þér er einnig sagt að staðfesta þessa aðgerð með því að slá inn númer staðsetningar eða auðkenni númeraplötu.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-478">Depending on the confirmation setup, you're also directed to confirm this action by entering the position number or license plate ID.</span></span>

    > [!NOTE]
    > <span data-ttu-id="a5f6a-479">Ef kveikt er á sjálfvirkri röðun, er handvirk hnekking ekki í boði.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-479">If automatic sorting is turned on, manual override isn't available.</span></span>

1. <span data-ttu-id="a5f6a-480">Þegar þessu er lokið, í Microsoft Dynamics 365 Supply Chain Management, skal opna síðuna **Úthlutanir á röðunarstaðsetningum á útleið** til að fara yfir stöðuna á staðsetningunum.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-480">When you've finished, in Microsoft Dynamics 365 Supply Chain Management, open the **Outbound sorting position assignments** page to review the status of the positions.</span></span>

    - <span data-ttu-id="a5f6a-481">Ef staðsetningum er lokað sjálfkrafa skal velja **Sýna lokaðar** til að sýna lokaðar staðsetningar.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-481">If positions are closed automatically, select **Show closed** to show the closed positions.</span></span>
    - <span data-ttu-id="a5f6a-482">Takið eftir að færslur röðunarstaðsetningar eru sýndar.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-482">Notice that sort position transactions are shown.</span></span> <span data-ttu-id="a5f6a-483">Varan og magnið sem unnið var úr í gegnum staðsetninguna er sýnt.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-483">The item and quantity that were processed through the position are shown.</span></span>

    <span data-ttu-id="a5f6a-484">Þegar flokkunarsniðmát á útleið er sett upp, er valkosturinn **Loka sjálfkrafa röðun staðsetningar** stilltur á *Já*.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-484">When you set up the outbound sorting template, you set the **Auto close sort position** option to *Yes*.</span></span> <span data-ttu-id="a5f6a-485">Þess vegna er staðsetningunni lokað sjálfkrafa þegar síðustu væntanlegu birgðirnar eru settar í hana.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-485">Therefore, the position is automatically closed after the last expected inventory is put to it.</span></span> <span data-ttu-id="a5f6a-486">Röðunarstaðsetningarnar eru í stöðunni **Lokað** og vinna hefur verið búin til að flytja raðaðar birgðir yfir á staðsetninguna *Útskot*.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-486">The sort positions are in **Closed** status, and work has been created to move the sorted inventory to *Baydoor* location.</span></span>

1. <span data-ttu-id="a5f6a-487">Ljúkið tiltekt á röðuðum birgðum til að færa birgðirnar yfir á sendingarstaðinn.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-487">Complete the sorted inventory picking work to move the inventory to the shipping location.</span></span> <span data-ttu-id="a5f6a-488">Þegar birgðir eru tilbúnar skal staðfesta sendingu.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-488">When the inventory is ready, ship-confirm it.</span></span>

> [!NOTE]
> <span data-ttu-id="a5f6a-489">Til að unnið verði rétt úr tiltekt raðaðra birgða, ætti valmyndaratriði fartækis, sem er með vinnuklasakenni þar sem reiturinn **Gerð vinnubeiðni** er stilltur á *Tiltekt raðaðra birgða*, að vera notað fyrir flutnings- og hleðsluferlið.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-489">For sorted inventory picking work to be processed correctly, a mobile device menu item that has a work class ID where the **Work order type** field is set to *Sorted inventory picking* should be used for the movement and loading process.</span></span>

### <a name="manually-close-a-position-optional"></a><span data-ttu-id="a5f6a-490">Loka staðsetningu handvirkt (valfrjálst)</span><span class="sxs-lookup"><span data-stu-id="a5f6a-490">Manually close a position (optional)</span></span>

<span data-ttu-id="a5f6a-491">Ef loka á röðunarstaðsetningum handvirkt, verður valkosturinn **Loka sjálfkrafa röðun staðsetningar** fyrir flokkunarsniðmát á útleið að vera stillt á *Nei* og lokun verður að gera áður en hægt er að færa birgðir yfir á útskotssvæðið.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-491">If sort positions should be closed manually, the **Auto close sort position** option for the outbound sorting template must be set to *No*, and closing must be done before inventory can be moved to the bay door area.</span></span> <span data-ttu-id="a5f6a-492">Hægt er að loka stöðum á ýmsa vegu:</span><span class="sxs-lookup"><span data-stu-id="a5f6a-492">Positions can be closed in various ways:</span></span>

- <span data-ttu-id="a5f6a-493">Í farsímaforriti vöruhúsakerfis:</span><span class="sxs-lookup"><span data-stu-id="a5f6a-493">Via the Warehouse Management mobile app:</span></span>

    - <span data-ttu-id="a5f6a-494">Notandinn getur skannað eina vöruna sem er þegar í staðsetningunni og síðan valið **Loka** til að loka henni.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-494">The user can scan one of the items that are already on the position and then select **Close** to close the position.</span></span>
    - <span data-ttu-id="a5f6a-495">Ef notandi skannar gám sem þegar hefur verið raðað á gám, birtast villuboð.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-495">If the user scans a container that has already been sorted container, an error message is shown.</span></span> <span data-ttu-id="a5f6a-496">Notandinn getur samt haldið áfram að loka staðnum.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-496">However, the user can still continue to close the position.</span></span>

- <span data-ttu-id="a5f6a-497">Af Microsoft Dynamics 365 Supply Chain Management síðunni **Úthlutanir á röðunarstaðsetningu á útleið**:</span><span class="sxs-lookup"><span data-stu-id="a5f6a-497">From the Microsoft Dynamics 365 Supply Chain Management **Outbound sorting position assignments** page:</span></span>

    - <span data-ttu-id="a5f6a-498">Notandinn getur valið færslu röðunarstaðsetningu á útleið og síðan valið **Loka staðsetningu** á aðgerðasvæðinu.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-498">The user can select the outbound sorting position record and then select **Close position** on the Action Pane.</span></span>

## <a name="tips"></a><span data-ttu-id="a5f6a-499">Ábendingar</span><span class="sxs-lookup"><span data-stu-id="a5f6a-499">Tips</span></span>

- <span data-ttu-id="a5f6a-500">Ekki er hægt að færa vörur milli staða þegar búið er að úthluta þeim einni slíkri.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-500">Items can't be moved between positions after they have been assigned to one.</span></span> <span data-ttu-id="a5f6a-501">Kerfið metur hversu mikið af hverri vöru ætti að fara á tiltekin stað.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-501">The system evaluates how many of each item should go to a specific position.</span></span>
- <span data-ttu-id="a5f6a-502">Flokkunarsniðmát er hægt að skilgreina til að búa sjálfkrafa til gáma þegar staðir eru lokaðir.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-502">Sorts template can be configured to automatically create containers when positions are closed.</span></span> <span data-ttu-id="a5f6a-503">Þessi nálgun býr til hefðbundið skipulag gámakennis sem byggir á tiltekinni pökkunarforstillingu.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-503">This approach will create standard container ID structure that is based on the specified packing profile.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="a5f6a-504">Þegar vinna birgðahreyfingar hefur verið búin til í röðunarstaðsetningu, má ekki hætta við vinnuna.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-504">After movement work has been created from the sorting location, you must not cancel the work.</span></span> <span data-ttu-id="a5f6a-505">Annars verður staðnum og gámum hans eytt úr kerfinu og ekki tiltækir fyrir frekari úrvinnslu.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-505">Otherwise, the position and the containers in it will be deleted from the system and unavailable for further processing.</span></span> <span data-ttu-id="a5f6a-506">Birgðir verða einnig fjarlægðar.</span><span class="sxs-lookup"><span data-stu-id="a5f6a-506">The inventory will also be removed.</span></span>
