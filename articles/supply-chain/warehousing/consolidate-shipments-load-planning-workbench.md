...
description: Þessi grein sýnir atburðarás þar sem margar pantanir eru gefnar út í vöruhúsið í sama álagi og eru síðan sjálfkrafa sameinaðar í sendingar.
author: Mirzaab
ms.date: 05/12/2020
ms.topic: article
ms.prod: ''
...
Þessi grein sýnir atburðarás þar sem margar pantanir eru gefnar út í vöruhúsið í sama álagi og eru síðan sjálfkrafa sameinaðar í sendingar.
