...
7.  Sláðu inn heiti fyrir forritið og veldu **Reikningar í þessari skipulagsskrá eingöngu**. Smelltu á **Skráning**.  [![WMA-03-active-directory-add-application](./media/WMA-03-active-directory-add-application.png)](./media/WMA-03-active-directory-add-application.png)
8.  Nýja forritaskráning þín opnast. [![WMA-04-active-directory-configure-app](./media/WMA-04-active-directory-configure-app.png)](./media/WMA-04-active-directory-configure-app.png)
9.  Mundu **kenni forrits**, þú munt þurfa á því að halda síðar. **Kenni forritsins** verður síðar vísað til sem **kenni biðlara**.
10. Smelltu á **Vottorð og leyndarmál** í glugganum **Stjórna**. Smelltu á **Nýtt leyndarmál biðlara**. [![WMA-05-active-directory-create-key](./media/WMA-05-active-directory-create-key.png)](./media/WMA-05-active-directory-create-key.png)
11. Stofnaðu lykil með því að slá inn lyklalýsingu og lengd í **lykilorða** hlutanum. Smelltu á **Bæta við** og afritaðu lykilinn. Seinna verður vísað til þessa lykils sem **Leynilikill biðlara**. [![WMA-06-active-directory-save-key](./media/WMA-06-active-directory-save-key.png)](./media/WMA-06-active-directory-save-key.png)
...
3.  Færi inn eftirfarandi upplýsingar: 
    ...
    + - **Azure Active directory tilföng** - Azure AD skráasafnstilföng tilgreina vefslóð fyrir Supply Chain Management. **Athugið**: Látið þennan reit ekki enda á framvísandi skástriki (/). 
    ...
    + **Fyrirtæki** - Færðu inn þann lögaðila í Supply Chain Management sem þú vilt að tengist forritinu. <br>[![wh-12-app-connection-settings](./media/wh-12-app-connection-settings-169x300.png)](./media/wh-12-app-connection-settings.png)
4.  Veldu hnappinn **Til baka** í efra vinstra horni forritsins Þá tengist forritið þínum Supply Chain Management þjóni og innskráningarskjár fyrir starfsmenn í vöruhúsi birtist. <br>[![wh-13-log-in-screen](./media/wh-13-log-in-screen-180x300.png)](./media/wh-13-log-in-screen.png)

Upplýsingar um hvernig eigi að setja upp vöruhúsaforrit til að skanna strikamerki með myndavél á fartæki er að finna í [Skanna strikamerki með myndavél í Dynamics 365 for Finance and Operations – Warehousing](scan-bar-codes-using-a-camera.md)
