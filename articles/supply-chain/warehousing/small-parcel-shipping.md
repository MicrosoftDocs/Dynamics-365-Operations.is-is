...
### <a name="turn-on-the-sps-feature"></a>Kveikja á SPS-eiginleikanum

Áður en hægt er að nota SPS-eiginleikann verður að vera kveikt á honum í kerfinu. Stjórnendur geta notað vinnusvæðið [Eiginleikastjórnun](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) til að athuga stöðu eiginleikans og kveikja á honum ef þörf krefur. Þar er eiginleikinn sýndur á eftirfarandi hátt:

- **Eining:** *Flutningsstjórnun*
- **Heiti eiginleika:** *Sending lítilla pakka*
...
- [Setja upp flutningsstjórnunarvélar](https://docs.microsoft.com/dynamicsax-2012/appuser-itpro/set-up-transportation-management-engines)
