...
## <a name="how-to-set-up-mixed-license-plate-receiving"></a>Uppsetning á móttöku blandaðrar númeraplötu
Móttaka á blandaðri númeraplötu er sett upp sem valmyndaratriði á fartæki.

Stofna þarf nýtt valmyndaratriði með vinnuham sem notast ekki við fyrirliggjandi vinnu og notast við eina af eftirtöldum aðferðum:
