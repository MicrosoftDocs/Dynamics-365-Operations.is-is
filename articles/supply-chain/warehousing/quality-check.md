---
title: Gæðaskoðun
description: Þessi grein veitir upplýsingar um eiginleika gæðastjórnunar. Þessi eiginleiki gerir starfsmönnum vöruhúss kleift að gera stuttar skoðanir á staðnum á meðan þeir taka á móti vörum á svæði innhliðs.
author: Mirzaab
ms.date: 07/16/2020
ms.topic: article
ms.prod: ''
...
## <a name="turn-the-quality-check-feature-on-or-off"></a>Kveikja eða slökkva á eiginleika gæðaskoðunar

Til að nota virkni sem lýst er í þessari verður að vera kveikt á eiginleikanum *Gæðaskoðun* fyrir kerfið þitt. Frá og með útgáfu 10.0.25 af Supply Chain Management er þessi eiginleiki skylda og ekki er hægt að slökkva á henni. Ef þú ert að keyra útgáfu sem er eldri en 10.0.25, þá geta stjórnendur kveikt eða slökkt á þessum eiginleika með því að leita að eiginleikanum *Gæðaskoðun* á vinnusvæðinu [Eiginleikastjórnun](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).

## <a name="set-up-the-feature-for-the-example-scenario"></a>Setja upp eiginleikann fyrir þetta sýnidæmi

Í þessum hluta eru leiðbeiningar og dæmi sem sýna hvernig á að setja upp eiginleikann *Gæðaskoðun* og undirbúa sýnigögn fyrir sýnidæmið sem kemur fyrir seinna í þessari grein.
...
Þegar búið er að gera öll sýnigögnin hér á undan tiltæk og setja þau upp, er hægt að fara í gegnum þetta sýnidæmi til að prófa eiginleikann *Gæðaskoðun*. Gildin sem eru sýnd í þessu sýnidæmi gera ráð fyrir því að verið sé að vinna með stöðluð sýnigögn, að lögaðilinn **USMF** hafi verið valinn og að sýniskrárnar sem lýst var fyrr í þessari grein hafi verið undirbúnar. Þetta sýnidæmi er einnig dæmi um hvernig hægt er að nota eiginleikann í framleiðsluumhverfi.
...
Nú er hægt að vinna úr prófun gæðapöntunar. Ekki er fjallað um gæðaprófun í þessari grein.
