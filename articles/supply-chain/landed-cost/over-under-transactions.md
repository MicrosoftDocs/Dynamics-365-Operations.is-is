...
description: Þessi grein veitir upplýsingar sem hjálpa þér að setja upp upplýsingar um stefnur fyrir yfir-/undirfærslur, svo að kerfið geti ákvarðað hvernig eigi að stjórna of- og vanvinnslu á vörum við móttöku.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
