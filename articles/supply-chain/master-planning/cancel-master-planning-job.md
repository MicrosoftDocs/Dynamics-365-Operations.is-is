---
title: Hætta við verk sem var stofnað með úreltu aðalskipulagsvélinni
description: Þessi grein útskýrir hvernig á að hætta við virka áætlunarvinnu sem notar úrelta aðalskipulagsvél.
author: t-benebo
ms.date: 05/14/2020
ms.topic: article
ms.prod: ''
...
---
# <a name="cancel-a-job-that-was-created-using-the-deprecated-master-planning-engine"></a>Hætta við verk sem var stofnað með úreltu aðalskipulagsvélinni

[!include [banner](../includes/banner.md)]

Það eru margir möguleikar til að hætta við verk sem var stofnað með úreltu aðalskipulagsvélinni. Til dæmis gætirðu viljað hætta við aðaláætlunarverk ef það var hafið fyrir mistök eða keyrir lengur en áætlað var og þú vilt slíta því.
...
### <a name="cancel-master-planning-job-from-the-unfinished-planning-processes-page"></a>Hætta við aðalskipulagsvinnu af síðunni Ólokið skipulagsferli
...
3. Opnaðu runuvinnsluna. Veldu **Starfskenni** fyrir hópvinnuna með verkefnum sem þú vilt ljúka.
4. Í **Runuverk** velurðu verkin sem á að ljúka.
5. Veldu **Breyta stöðu**, velja **Hætta við** og smelltu **Allt í lagi**.
