...
Þetta efni útskýrir hinar ýmsu valkosti sem geta hjálpað þér að bæta árangur aðaláætlunargerðar og úrræðaleita vandamál. Það felur í sér upplýsingar um færibreytur og stillingar og um ráðlagðar skilgreiningar og aðgerðir. Það felur einnig í sér samantekt á öllum mikilvægum færibreytum sem þú ættir að íhuga þegar þú ert með tímafrekar aðaláætlunargerðarvinnslur.
...
## <a name="parameters-that-are-related-to-master-planning-performance"></a>Færibreytur sem tengjast frammistöðu aðaláætlanagerðar
...
Færibreytan **Fjöldi þráða** gerir þér kleift að breyta röðunarferlinu til að auðvelda frammistöðu þess í tilteknu gagnasafni. Hún tilgreinir heildarfjölda þráða sem verða notaðir til að keyra aðaláætlanagerð. Hún veldur samhliðun keyrslu aðaláætlunargerðar og þessi samhliðun lækknar keyrslutímann. 
...
> [!NOTE]
> Stilling á **0** (núll) fyrir færibreytuna **Fjöldi þráða** eykur keyrslutíma aðaláætlanagerðar. Þess vegna mælum við með að þú stillir alltaf gildi sem er hærra en 0.
...
Almennt mælum við með að þú aukir fjölda verka þegar fjöldi varanna er mjög stór (í hundruðum þúsunda). Annars ættirðu að draga úr fjölda verka. Í eftirfarandi tilteknum atvinnugreinum skaltu íhuga þessi atriði:
...
Þegar þú skoðar lotukladdann skaltu skoða eftirfarandi atriði:

- **Uppfærsla** ætti ekki að taka langan tíma (almennt ætti hún að taka allt að 30 mínútur). Hins vegar er hún einþráða.
