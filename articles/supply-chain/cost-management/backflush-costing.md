...
description: Þessi grein kynnir til sögunnar hugtakið bakfærslukostnaðaraðferð sem er notað fyrir lean-framleiðslu.
author: JennySong-SH
ms.date: 04/10/2017
ms.topic: article
ms.prod: ''
...
VÍV-líkan fyrir lean-framleiðslu gerir kleift að nota stöðu efnismeðhöndlunareiningar kanbans til að stýra hráefni, hálfkláruðum afurðum og tilbúnum afurðum sem eru hluti af VÍV.
