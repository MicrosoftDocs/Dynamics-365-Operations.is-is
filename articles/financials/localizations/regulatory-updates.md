...
Regluuppfærslur eru eiginleikar sem eru innleiddir til að styðja nýjar eða breyttar landsbundnar reglugerðir. Til að fræðast um aðrar fyrirhugaðar og útgefnar landsbundnar eiginleika skal skoða eftirfarandi tilföng:
...
Í tilfellum þar sem tilkynning berst seint, upplýsingar um kröfur berast seint eða sannprófunartól, eða einstaklega stórar og flóknar breytingar, er hugsanlega ekki hægt að bjóða upp á uppfærslu á reglu fyrir almennu dagsetninguna á mánaðarlegri uppfærslu. Í slíkum tilfellum verður uppfærsla á reglum send sem bráðabætur fyrir nokkrar tiltækar mánaðarlegar uppfærslur.
