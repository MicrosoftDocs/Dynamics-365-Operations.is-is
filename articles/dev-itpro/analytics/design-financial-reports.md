...
4. Veldu **Skrá**, síðan **Vista sem** og gefðu skýrslunni heitið Ítarlegur prófjöfnuður með eigindum.
    ...
    > [!NOTE]
    > Í hvert skipti sem ný skýrsla er stofnuð í skýrsluhönnun er listi yfir fjárhagsskýrslur uppfærður í Finance and Operations.
...
[Skoðun fjárhagsskýrslna](../../financials/general-ledger/view-financial-reports.md)
