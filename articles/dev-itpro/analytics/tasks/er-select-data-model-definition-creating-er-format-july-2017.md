...
---
# <a name="select-data-model-definition-while-creating-format-for-electronic-reporting-er"></a>Velja skilgreiningu gagnalíkans þegar snið er búið til fyrir rafræna skýrslugerð (ER)
