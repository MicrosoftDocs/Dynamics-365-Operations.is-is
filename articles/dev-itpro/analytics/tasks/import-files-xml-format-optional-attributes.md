...
9. Í trénu skaltu stækka **snið\root: XML Element(root)**.
10. Í trénu skaltu velja **format\root: XML Element(root)\document: XML Element 1.* (fylgiskjal)**.
11. Smelltu á **Binda**.
12. Í trénu skaltu stækka **format\root: XML Element(root)\document: XML Element 1.* (fylgiskjal)**.
13. Í trénu skaltu velja **format\root: XML Element(root)\document: XML Element 1.* (fylgiskjal)\kenni**.
