...
---
# <a name="run-electronic-reporting-er-formats-to-do-counting-and-summing"></a>Keyra snið fyrir rafræna skýrslugerð (ER) til að framkvæma talningu og samlagningu
