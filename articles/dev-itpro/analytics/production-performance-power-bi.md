...
Ef þú notar Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition (júlí 2017) er **Framleiðsluafköst** Power BI efni sýnt á **Framleiðsluafköst** síðunni (**Framleiðslustýring** > **Fyrirspurnir og skýrslur** > **Greining á framleiðsluafköstum** > **Framleiðsluafköst**). 
