...
5. Í listanum skal finna og velja þá skráningu sem óskað er eftir.
    * Veljið fyrstu skyldu sem er stýrt af reglunni.  
6. Í listanum skal smella á tengilinn í valinni línu.
7. Í reitnum Önnur skylda skal smella á fellilistahnappinn til að opna leitina.
8. Í listanum skal finna og velja þá skráningu sem óskað er eftir.
    * Veljið aðra skyldu sem er stýrt af reglunni.  
9. Í listanum skal smella á tengilinn í valinni línu.
10. Í reitnum Villustig skal velja valkost.
    * Veljið villustig áhættu sem gerist þegar sama notandi eða hlutverk framkvæmir báðar skyldur.  
11. Í reitinn Öryggishætta skal slá inn gildi.
    * Færið inn lýsingu á áhættu.  
12. Í reitinn Mótvægisaðgerðir öryggis skal slá inn gildi.
    * Færið inn lýsingu á aðgerðum sem eru teknar til að minnka þá áhættu. Til dæmis er hægt að draga úr hættunni með framkvæmd ítarlegri yfirferða á ferlinu, með framkvæmd á mánaðarlegri rekstraryfirferð eða með því að samnýta tilföng með öðrum deildum.  
13. Smellið á „Vista“.
