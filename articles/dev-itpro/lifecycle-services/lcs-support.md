...
# <a name="find-support-for-microsoft-dynamics-365-for-finance-and-operations-enterprise-edition-and-dynamics-lifecycle-services"></a>Finna aðstoð fyrir Microsoft Dynamics 365 for Finance and Operations, Enterprise edition og Dynamics Lifecycle Services

[!include[banner](../includes/banner.md)]


Í þessari grein er útskýrt hvernig skal fá hjálp varðandi Finance and Operations eða Microsoft Dynamics Lifecycle Services (LCS). 

<a name="contact-support"></a>Hafa samband við notendaþjónustu
---------------

Notið upplýsingarnar í þessari grein til að hafa samband við Microsoft ef tæknilegar spurningar um Finance and Operations vakna, eða ef þörf er á hjálp við að komast inn í Microsoft Dynamics Lifecycle Services (LCS).

### <a name="finance-and-operations-support"></a>Notendaþjónusta Finance and Operations

Til að fá aðstoð fyrir Finance and Operations eða LCS skal nota úrræðin í eftirfarandi lista. Þessum úrræðum er raðað á listann í þeirri röð sem ráðlagt er nota þau í, þegar þú ert í úrræðaleit.
