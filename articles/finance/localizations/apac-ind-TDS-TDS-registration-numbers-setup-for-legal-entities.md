...
ms.locfileid: "8407406"
---
# <a name="set-up-tds-registration-numbers-for-legal-entities"></a>Setja upp TDS-skráningarnúmer fyrir lögaðila

[!include [banner](../includes/banner.md)]

Í þessu efnisatriði er útskýrt hvernig á að setja upp skráningarnúmer lögaðila fyrir skatt sem er dreginn frá upprunalegri greiðslu (TDS).
...
4. Í reitinn **Deildarnúmer** er fært inn deildarnúmer TDS-yfirvalds.
5. Í reitnum **Matsmaður** eru færðar inn upplýsingar um matsfulltrúa TDS-yfirvalds.
6. Í svæðinu **Gerð frádráttar** skal velja gerð frádráttar fyrir lögaðilann.
