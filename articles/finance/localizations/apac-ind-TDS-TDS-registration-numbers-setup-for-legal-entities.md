...
description: Þessi grein útskýrir hvernig á að setja upp Tax Deducted at Source (TDS) skráningarnúmer fyrir lögaðila.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8859738"
---
# <a name="set-up-tds-registration-numbers-for-legal-entities"></a>Setja upp TDS-skráningarnúmer fyrir lögaðila

[!include [banner](../includes/banner.md)]

Þessi grein útskýrir hvernig á að setja upp Tax Deducted at Source (TDS) skráningarnúmer fyrir lögaðila.
