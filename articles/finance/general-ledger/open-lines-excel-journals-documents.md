...
description: Þessi grein útskýrir hvernig á að slá inn og birta línur fyrir almenn tímarit frá Microsoft Excel. Það felur í sér upplýsingar um mismunandi sniðmát sem nota má, eftir gerð þeirra færslna sem verið er að færa inn.
author: kweekley
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Þessi grein útskýrir hvernig á að slá inn og birta línur fyrir almenn tímarit frá Microsoft Excel. Það felur í sér upplýsingar um mismunandi sniðmát sem nota má, eftir gerð þeirra færslna sem verið er að færa inn.
...
Þegar línur eru birtar eru þær villuleitaðar til að tryggja að þær samræmist reglum sem eru settar upp í fjárhagsbækur. Eftir að línurnar hafa verið birtar geta notendur breytt eða póstað fylgiskjölunum frá Dynamics 365 Finance. 
