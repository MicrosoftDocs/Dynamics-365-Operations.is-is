...
description: Þessi grein veitir yfirlit yfir eftirfarandi fyrir endurmatsferlið fjárhagsgjaldeyris - uppsetningu, keyrslu ferlið, útreikning fyrir ferlið og hvernig á að bakfæra endurmatsfærslurnar, ef þörf krefur.
author: kweekley
ms.date: 11/15/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9779989"
---
# <a name="foreign-currency-revaluation-for-general-ledger"></a>endurmat á erlendum gjaldmiðli fyrir fjárhag

[!include [banner](../includes/banner.md)]

Þessi grein veitir yfirlit yfir eftirfarandi fyrir endurmatsferlið fjárhagsgjaldeyris - uppsetningu, keyrslu ferlið, útreikning fyrir ferlið og hvernig á að bakfæra endurmatsfærslurnar, ef þörf krefur. 
...
Í **Frá dagsetningu** og **Til Dagsetningu** gildi skilgreina dagsetningabil til að reikna út stöðu erlendum gjaldmiðli sem verður endurmeta. Þegar þú endurmetur hagnaðar og taplykla, fjárhæð allar færslur sem eiga sér stað á dagsetningabili eru endurmetni. Þegar þú endurmetur efnahagsreikninga, **Frá dags** er hunsuð. Þess í stað er staðan sem á að endurmeta ákvörðuð með því að fara frá upphafi reikningsárs til þess **Til dagsins í dag**. 
...
Velja hvaða aðallykla til að endurmeta: Allt, efnahagsreikningur eða hagnaður og tap. Aðeins aðalreikningar merktir til endurmats (á **Aðalreikningur** síðu) verður endurmetið. Ef þú vilt takmarka frekar úrval aðalreikninga skaltu nota **Skrár til að hafa með** flipa til að skilgreina úrval aðalreikninga, eða einstaka aðalreikninga. 
