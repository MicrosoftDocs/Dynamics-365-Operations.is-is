...
- Setjið upp færslubókarheitið (**Fjárhagur** \> **Uppsetning færslubókar** \> **Færslubókarheiti**) þannig að reiturinn **Nýtt fylgiskjal** sé stilltur á **Aðeins eitt fylgiskjalsnúmer**. Sérhverri línu sem bætt er við færslubókina er nú að finna í sama fylgiskjalinu. Því er hægt að færa inn fylgiskjalið sem marglínu fylgiskjal, sem lykil/mótlykil í sömu línunni eða sem samsetningu.
    ...
    > [!IMPORTANT]
    > Skilgreiningu á Einu fylgiskjali nær **ekki** yfir tilvik þar sem færslubókarheiti eru sett upp eins og **Eitt fylgiskjalsnúmer eingöngu**, en notandinn færir þá inn fylgiskjal sem inniheldur aðeins fjárhagslyklagerðir. Í þessari grein þýðir Eitt fylgiskjal að það sé Eitt fylgiskjal sem inniheldur fleiri en einn seljanda, viðskiptavin, banka, eign eða verk.
...
- **Vorútgáfa 2018** - Sjálfgefið var slökkt á virkninni í gegnum færibreytuna **Leyfa margar færslur í einu fylgiskjali** færibreytunni í flipanum **Almennt** á síðunni **Færibreytur fjárhags**. Hins vegar geturðu kveikt aftur á því ef fyrirtækið hefur atburðarás sem heyrir undir viðskiptagloppur sem eru skráðar seinna í þessari grein.

    - Ef viðskiptaaðstæðurnar krefjast ekki eins fylgiskjals er mælt með því að slökkt sé á virkninni. Ef hún er notuð jafnvel þótt önnur lausn sé til staðar, mun Microsoft ekki laga „villur“ á svæðum sem ekki er minnst á í þessari grein.
...
Úrelding eins fylgiskjals er umtalsverð breyting sem verður tilkynnt víðsvegar. Sem hluti af þeim samskiptum mun Microsoft uppfæra þessari grein, birta bloggfærslu á bloggsvæði Microsoft Dynamics 365 Finance, uppfæra greinina  „Fjarlægðir eða úreltir eiginleikar“, láta vita af breytingunni á viðeigandi ráðstefnum Microsoft o.s.frv.
...
Með útgáfu 10.0.21 og síðari verða eignafærslur fyrir „vinna upp“ afskriftir, eignaskiptingu og útreikning afskriftar fyrir losun eignar stofnaðar með því að nota mismunandi fylgiskjalsnúmer.
