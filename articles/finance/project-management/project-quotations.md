...
Getan til að fylgjast með, endurskoða og hafa stjórn á keðju verktilboða og pantana er mikilvægur þáttur verkstjórnunar. Ýmis tæki létta slíka stjórnun. Tæki eins og réttar skilgreiningar tilvísunargagna (tilboðsgerðir, uppruni tilboða, spár og líkindi) hjálpa til við að greina keðjuna. Hægt er að nota þessi tæki til að flokka ástæður þess að verktilboð bar árangur eða ekki og hvað tilboðið var hugsanlega mikils virði. 
