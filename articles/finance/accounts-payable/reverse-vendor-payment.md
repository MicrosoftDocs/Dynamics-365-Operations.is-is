...
description: Þetta efni lýsir muninum á því að bakfæra, eyða, ógilda og hafna greiðslu. Einnig útskýrir hún aðferðirnar tvær við að bakfæra ávísun lánardrottins.
author: abruer
ms.date: 08/22/2017
ms.topic: article
ms.prod: ''
