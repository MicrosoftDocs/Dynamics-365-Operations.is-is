...
---
# <a name="expense-management-workflow"></a>Verkflæði kostnaðarstýringar

[!include [banner](../includes/banner.md)]

Hægt er að nota verkflæðiskerfi til að setja upp endurskoðunarferli fyrir kostnaðarskýrslur í Kostnaðarstýringu. Hægt er að setja upp verkflæði sem notar eftirfarandi viðmiðanir til að ákvarða hver samþykkir kostnaðarskýrslur:
