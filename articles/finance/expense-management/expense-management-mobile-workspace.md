...
Þetta fartækjavinnusvæði er ætlað til að nota með Dynamics 365 fyrir fartækjaforritið Unified Ops.
...
- Taka mynd af kvittun og hlaða inn á Dynamics 365 Finance. Þú getur svo tengt myndina við kostnaðarskýrslu seinna.
...
Þú getur líka notað þessa eiginleika:
...
Skilyrðin eru mismunandi, byggt á útgáfu sem hefur verið sett upp fyrir fyrirtækið þitt.

### <a name="prerequisites-if-you-use-dynamics-365-finance"></a>Skilyrði ef þú notar Dynamics 365 Finance 
Ef Finance hefur verið innleitt í fyrirtækinu verður kerfisstjóri að birta fartækjavinnusvæðið **Útgjaldastýring**. Leiðbeiningar er að finna í [Fartækjavinnusvæði birt](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
...
Sæktu og settu upp fartækjaforritið Dynamics 365 for Unified Ops:
...
19. Veldu **Sundurliða** ef reglur fyrirtækisins gera kröfu um að kostnaður sé sundurliðaður, og fylgdu svo eftirfarandi skrefum:
    ...
    3. Veldu undirflokk fyrir sundurliðun kostnaðarins. Þá sérðu lista yfir undirflokka kostnaðar sem er hlaðið upp í forritið til notkunar utan nets. 50 atriðum er hlaðið sjálfgefið en þeirri tölu má breyta. Til að fá frekari upplýsingar ættu þróunaraðilar að skoða [Fartækjaverkvangur](../../dev-itpro/mobile-apps/platform/mobile-platform-home-page.md). Veldu **Leit** til að leita á netinu ef undirflokkurinn þinn er ekki á listanum. Leita eftir heiti undirflokks kostnaðar.
