...
description: Þessi grein útskýrir hvernig á að nota verkflæði til að samþykkja eignaleigur og hvernig á að rekja stöðu og feril verkflæðanna.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
