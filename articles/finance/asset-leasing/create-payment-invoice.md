...
description: Þessi grein útskýrir hvernig á að búa til mánaðarlega leigureikninga. Hægt er að stofna reikninga fyrir tiltekna leigusamninga eða nota runuvinnslu til að stofna reikninga fyrir marga leigusamninga.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
