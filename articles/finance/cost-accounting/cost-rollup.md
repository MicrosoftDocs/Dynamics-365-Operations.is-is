...
description: Þessi grein veitir upplýsingar um hvernig á að ákvarða rétt stig aukakostnaðareininga og stofna reglur fyrir samantekt kostnaðar sem hæfa skýrslugerð fyrirtækis og rekjanleika kostnaðar.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
