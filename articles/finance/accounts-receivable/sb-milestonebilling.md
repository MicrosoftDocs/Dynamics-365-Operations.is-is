...
ms.locfileid: "8686492"
---
# <a name="milestone-billing"></a>Útskrift samkvæmt þáttaskilum

[!include [banner](../includes/banner.md)]

Þetta efnisatriði útskýrir hvernig á að skilgreina sniðmát fyrir áfangareikningsvirkni í áskriftarinnheimtu. Fyrir hverja línu í áfangasniðmátinu er hægt að skilgreina úthlutunarprósentu eða upphæð. Þú getur síðan úthlutað áfangasniðmátinu til greiðsluáætlunarliða sem nota áfangareikningavirknina.
