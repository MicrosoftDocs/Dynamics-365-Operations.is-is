...
5. Ef **Fyrirkomulag margfeldisþátta** reiturinn er stilltur á **Margfeldi**, veldu línurnar sem þú vilt og veldu síðan **Sækja um valið**.
6. Veldu **Vista**.

Ef þú notar frestun tekna og kostnaðar er frestunaráætlunin sjálfkrafa búin til. Þú getur skoðað það á **Allar frestunaráætlanir** síðu.
