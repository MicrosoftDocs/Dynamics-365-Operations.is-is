---
title: "Yfirlit yfir framleiðslu"
description: "Þessi skrá gefur yfirlit yfir framleiðsluferlinu. Það lýsir mismunandi stigum framleiðslupantanir runupantanir og kanbön úr stofnun pöntunar til að loka fjárhagslegar tímabilsins."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="production-process-overview"></a>Yfirlit yfir framleiðslu

Þessi skrá gefur yfirlit yfir framleiðsluferlinu. Það lýsir mismunandi stigum framleiðslupantanir runupantanir og kanbön úr stofnun pöntunar til að loka fjárhagslegar tímabilsins. 
...
Í **framleiðslustýringar** kerfiseiningu er tengd við aðrar kerfiseiningar, eins og **upplýsingar afurðastjórnun**, **Birgðastjórnun**, **fjárhags**, **Vöruhúsakerfi**, **verkbókhald**, og **fyrirtækisstjórnun**. Þessi samþætting styður upplýsingaflæðið sem er krafist til að klára framleiðslu afurðar.  

Framleiðsluferlið verður vanalega fyrir áhrifum af kostnaðarbókhalds- og birgðamatsaðferðum sem eru valdar fyrir tiltekið framleiðsluferli. Dynamics 365 aðgerða styður bæði raunverulegan kostnað (fyrst inn, fyrst út \[FIFO\]; síðast inn, fyrst út \[LIFO\]; flytja meðaltal; og reglubundin vegið meðaltal) og aðferðir staðalkostnaðar. Lean-framleiðsla er innleidd byggt á reglu bakfærslukostnaðaraðgerðarar.  
...
Mismunandi afurðir og grannfræði framleiðslu krefjast beitingar á mismunandi pöntunargerðum. Dynamics 365 fyrir Aðgerðir sem hægt að nota ýmsar gerðir pantana blandaðar ham. Með öðrum orðum geta allar gerðir pantana átt sér stað á meðan vinnslum frá upphafi til enda í framleiðslu einnar endanlegrar afurðar.
...
2.  **Áætlað** - Hægt er að reikna áætlað efni og tilfanganotkun. Áætlunin myndar birgðafærslur fyrir hráefni sem hafa stöðuna **Í pöntun**. Kvittanir fyrir aðallykil afurðir aukaafurðir og hliðarafurðir eru mynda þegar framleiðslupantanir eða runupantanir eru áætlaðar. Ef Uppskrift inniheldur línur sem **Fest framboð** inn innkaupapantanir fyrir efni eða þjónustu fyrir úthýsta aðgerð er mynduð og fest við framleiðslupöntun eða runupöntun. Vörur eða pantanir eru teknar frá samkvæmt frátektarstefnu framleiðslupöntunar og verð fullbúnu vörunnar reiknað út á grundvelli stillinga færibreyta.
...
5.  **Undirbúið**/**Tiltekið** – Þegar efni og tilföng hafa verið stig á staðsetningunni framleiðslu, sem línur í Framleiðsluuppskrift eða kanban-línur eru uppfærð í stöðuna **Tiltekið**. Föstum birgðapöntunum og tengdri vöruhúsavinnu er yfirleitt lokið á þessu stigi. Kanban-spjöldum eða vinnsluspjöldum sem nauðsynleg eru fyrir skýrslu framleiðslugangur ætti að vera úthlutað og prentað.
