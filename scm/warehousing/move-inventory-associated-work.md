...
### <a name="set-up-the-permission-to-move-reserved-inventory-for-individual-workers"></a>Uppsetning heimildar til að flytja fráteknar birgðir fyrir einstaka starfsmenn
