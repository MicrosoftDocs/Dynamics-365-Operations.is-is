---
title: "Stjórna vöruhúsavinnu með því að nota vinnusniðmát og staðsetningarleiðbeiningar"
...
# <a name="control-warehouse-work-by-using-work-templates-and-location-directives"></a>Stjórna vöruhúsavinnu með því að nota vinnusniðmát og staðsetningarleiðbeiningar
...
Staðsetningarleiðbeiningar hafa eina viðbótar upplýsingastig: *aðgerðir í staðsetningarleiðbeiningum*. Hægt er að skilgreina margar aðgerðir í staðsetningarleiðbeiningum fyrir hverja línu. Aftur, með númeraröð er notuð til að ákvarða pöntun sem aðgerðir eru metnar í. Á þessu stigi er hægt að setja upp fyrirspurn til að skilgreina hvernig á að finna bestu staðsetning í vöruhúsi. Einnig er hægt að nota forskilgreint **Stjórnunarstefnu **stillingar til að finna bestu staðsetningu.
