...
Ef verið er að nota Dynamics 365 til Fjármála og Aðgerðir Enterprise edition Júlí 2017 uppfærslu fyrir fyrirtækið, kerfisstjóri verður að birta á **sölupantanir** farsímaforrit vinnusvæðisins. Leiðbeiningar er að finna í [Fartækjavinnusvæði birt](/dynamics365/unified-operations/dev-itpro/mobile-apps/publish-mobile-workspace).

### <a name="prerequisites-if-you-use-dynamics-365-for-operations-version-1611-with-platform-update-3-or-later"></a>Ef nota Dynamics 365 for Operations útgáfu 1611 svæðis uppfærslu 3 eða síðar með forkröfur
Ef verið er að nota Dynamics 365 for Operations útgáfu 1611 svæðis uppfærslu 3 eða síðar með fyrir þitt fyrirtæki, verður kerfisstjórinn að ljúka eftirfarandi forsendur. 
...
-   [Fyrir Android símar](https://go.microsoft.com/fwlink/?linkid=850662)
-   [Fyrir iPhones](https://go.microsoft.com/fwlink/?linkid=850663)
