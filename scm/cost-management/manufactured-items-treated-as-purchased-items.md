---
title: "Setja upp afurðir sem hægt er að framleiða eða keypt"
description: "Afurðir hægt sourced á mismunandi hátt - hægt er að framleiða (framleiddar) þær eða keypt (keyptar). Þessi grein lýsir nokkrum dæmigerðum atriðum til að hafa í huga þegar vörur eru skilgreindar til að styðja fjöl-uppruna."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>Setja upp afurðir sem hægt er að framleiða eða keypt

Afurðir hægt sourced á mismunandi hátt - hægt er að framleiða (framleiddar) þær eða keypt (keyptar). Þessi grein lýsir nokkrum dæmigerðum atriðum til að hafa í huga þegar vörur eru skilgreindar til að styðja fjöl-uppruna. 
