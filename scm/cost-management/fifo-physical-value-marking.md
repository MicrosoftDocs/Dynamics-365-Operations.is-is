...
Ef á **Taka efnislegt virði** gátreitur er valinn fyrir vöru í við **vörulíkanaflokki** síðu, notar kerfið bæði efnislegar og fjárhagslegar innhreyfingarfærslur til að reikna út hlaupandi meðaltal kostnaðarverðs. Kerfið gerir líka breytingar á uppfærðum úthreyfingafærslum, þar sem við á. Þegar gátreiturinn **taka efnislegt virði með** er hreinsaður munu birgðalokin með FIFO-birgðalíkanið aðeins gera uppgjör í þeim færslum sem hafa verið fjárhagslega uppfærðar. Eftirfarandi skýringarmynd sýnir þessar færslur:
