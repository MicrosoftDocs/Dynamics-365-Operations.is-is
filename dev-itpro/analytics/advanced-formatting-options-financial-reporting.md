...
**Ábending:** Í mörgum tilvikum þarf að skilgreina skýrsluskilgreiningu þannig að útreikningar eru framkvæmdir fyrir línuútreikninga. Fylgið eftirfarandi skrefum til að ljúka þessum skilgreiningum.
...
|                              | Lista fyrir   | B    | K        | D      | E      | F    |
|------------------------------|-----|------|----------|--------|--------|------|
| Haus 1                     |     |      |          |        |        |      |
| Fyrirsögn 2                     | Lista fyrir   | B    | K        | D      | E      | F    |
| Fyrirsögn 3                     |     |      |          |        |        |      |
| Gerð dálks                  | ROW | DESC | FD       | FD     | FD     | CALC |
...
|                              | Lista fyrir   | B    | K      | D            | E     | F            |
|------------------------------|-----|------|--------|--------------|-------|--------------|
| Haus 1                     | Lista fyrir   | B    | K      | D            | E     | F            |
| Fyrirsögn 2                     | -   | -    | ÁÁ    | Árleg sala | Starfsfólk | $ eftir einstaklingum |
| Fyrirsögn 3                     |     |      |        |              |       |              |
...
2.  Þá er tvísmellt á viðkomandi hólf fyrir **Tengdar formúlur/línur/einingar**.
3.  Í spjallglugga fyrir **Einingaval skipurits** í hólfinu **Skipurit**, skal velja tréð sem hefur verið úthlutað í skilgreiningu skýrslunnar.
...
Í þessu dæmi þýðir reikniformúlan **E=C.340** að útreikningurinn í hólfinu í dálki C, línu 340, er aðeins framkvæmdur í dálkinum E. **Ábending:** Þegar vísað er í dálk í reikniformúla er á-merki (@) óþarfi.
