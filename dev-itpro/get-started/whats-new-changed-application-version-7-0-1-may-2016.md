...
## <a name="pos--microsoft-dynamics-ax-retail"></a>Retail POS – Microsoft Dynamics AX
|                                |                                                                                                                                                                                         |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Hvað hægt er að gera?**           | **Hví er þetta mikilvægt?**                                                                                                                                                              |
...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Hvað hægt er að gera?**                                                | **Hví er þetta mikilvægt?**                                                                                                                                                                                                                                                                                         |
| Endurbyggja Fjárhagslegar skýrslugerðar gögn torg.                          | Þegar færa Dynamics AX gagnagrunnum milli umhverfi eða gera aðrar breytingar á invasive umhverfið Fjárhagslegar skýrslugagnagrunns gæti þurft að að aukauppskriftir. Windows PowerShell forskrift er nú veitt til að endurbyggja gagnagrunninum fyrir er.                                                                |
| Ekki lengur hægt að velja skýrsluhönnun valkostina sem ekki eru gilda. | Nokkrar skýrsluhönnun valkostina sem voru notaðir í útgáfur markaðinn í Management reporter ekki nota í þessari útgáfu Dynamics AX. Þessir valkostir voru tengdar fjárhagslegar skýrsluhönnun úttak og tengingu. Þessir valkostir hafa verið fjarlægð úr fjárhagsskýrslu hönnuð til að koma í veg fyrir að notandinn villur. |
...
[Nýjar eða uppfærðar verkefni leiðbeiningar (Maí 2016)](new-updated-task-guides-available-may-2016.md)
