...
| Lestu meira um stuðning við vörusendingar í Dynamics 365 for Operations                                                                                                         | Frekari upplýsingar um stuðning við ferli vörusendingar er að finna í [Vörusendingu](/dynamics365/operations/scm/inventory/consignment), [Uppsetningu vörusendingar](/dynamics365/operations/scm/inventory/set-up-consignment), [Stofna áfyllingarpöntun vörusendingar (Verkefnaleiðbeiningar)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) og [Skipta um eignarhald á vörusendingabirgðum byggð á framleiðslueftirspurn (Verkefnaleiðbeiningar)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
