...
<td>Ef ekki er hægt að samnýta aðallykla milli lögaðila vegna lögboðinna reikningsskilakrafna, er hægt að varpa þeim þegar þær hafa verið fluttar inn í kostnaðarbókhald til að fá heildrænt yfirlit þvert á fyrirtækið.</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td>Stofna skýrslur með því að nota Excel. <strong>Athugasemd:</strong> Það verður að keyra Microsoft Excel 2016.</td>
...
| Setja upp staðfestingu á baráttu við spillingu fyrir útgjöld.                            | Sumir starfsmenn fyrirtækja gætu átt viðskipti við opinbera starfsmenn og sum útgjöld sem stofnað er til sem hluta af viðskiptum gætu verið álitin vera mútur. Í Útgjaldastýringu er nú hægt að setja upp staðfestingu á baráttu við spillingu, sem er birt fyrir valdar kostnaðartegundir eins og máltíðir og gjafir. Starfsmenn verða að velja hvort útgjöld sem sett eru upp fyrir staðfestingu á baráttu við spillingu uppfylli skilyrðin sem eru skilgreind með reglum fyrirtækisins.                                                                                                                                                                                     |
...
| Stofna ítarlegri markmið.                                                                    | Þú hefur meiri stjórn yfir efni þeirra markmiða sem þú setur. Hægt að stofna mælingar fyrir markmiðin, tengja frammistöðubókarfærslur við mælingarnar og tengja og skoða skjöl. Hægt er að geyma markmið sem sniðmát og endurnýta þau fyrir flýtiuppsetningu.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Stofna ítarlegra frammistöðumat.                                                      | Frammistöðumat, sem formlega þekkt sem umfjöllun, er nú orðið nógu sveigjanlegt til að styðja bæði áframhaldandi svörun og enn formlegri yfirferðir. Hægt er að sækja virk markmið og bóka athugasemdir um þau og bæta við hluta til að yfirfara hæfni þína. Viðbótarhlutar eru veittir, þar sem hægt er að bæta við eða skoða mælingar, færslur í frammistöðubók, fylgiskjöl og samþykktir sem tengjast yfirferð.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Tengja stigveldi stöðu viðbótar við verkflæði.                                      | Hægt er að tengja verkflæði við stigveldi stöðu. Einnig er hægt að breyta verkflæðisskrefum til að bæta samþykktarferli þannig að það hentar fyrirtæki ykkar. Þess vegna er hægt að skilgreina virkt samþykktarskipulag sem hentar mismunandi skýrslugerðarvenslum sem fyrirtækið notar.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Verkflæðisstuðningur til að færa inn persónuleg kennisnúmer (PIN-númer) á sjálfsafgreiðslusíðum Starfsmanna. | Verkflæðisgeta mannauðs (Mannauður) hefur verið útvíkkuð og inniheldur nú þjónustudeild fyrir PIN-númer. Starfsmenn geta bætt við og breytt PIN-númerum sínum til að bæta skilvirkni. Hins vegar geta MA-starfsmenn yfirfarið þessar upplýsingar fyrir nákvæmni og heilleika áður en þeim bætt við færslu starfsmanns.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Stofna markmiðssnið og nota þau til að bæta við nýjum markmiðum.                                          | Hægt er að stofna markmiðssnið fyrir markmið sem eru samnýtt af mörgum starfsmönnum í fyrirtækinu. Starfsmenn bæta við sínum markmiðum úr sniðmáti, stjórnendur geta bætt við markmiðum fyrir sín teymi úr sniðmáti og teymismeðlimir MA geta bætt við markmiðum fyrir starfsmenn þvert á fyrirtækið.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Stofna markmiðahópa nota þá til að bæta við nýjum markmiðum.                                             | Hægt er að bæta við markmiðssniðum við hóp og nota hann til að stofna eitt eða fleiri markmið fyrir starfsmann, teymi, stöðu, deild eða fyrirtæki.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Hafa meiri stjórn yfir endurskoðunarferlinu.                                                     | Hægt er að nota verkflæði til að stýra endurskoðunarferlinu. Hægt er að stofna sniðmát fyrir yfirferð og nota þau til að stofna yfirferðir. Einnig er hægt að bæta við einkunnum til að skoða.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Nota endurskoðunartímabil til að skilgreina tímaramma fyrir yfirferð.                                    | Hægt er að skilgreina tímabil fyrir frammistöðumat og upphafs- og lokadagsetningar yfirferðar eru sjálfkrafa færðar inn. Hins vegar er hægt að breyta þessum sjálfgefnu dagsetningum eftir þörfum.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Opna fimm nýja Power BI innihaldi pakka fyrir mannauð                                     | Virkja nýja innihaldi pakka mannauður fyrirtæki og mannauður stjórnendur til að greina eftirfarandi: Vinnuafls mælikvörðum • Demographic breakdowns eftir aldur, kyn og hjúskaparstöðu • Bera attrition taxta ári til árs og sjá lista yfir ástæður starfsmenn hafa verið veitt til þess að Skoða lista yfir opnar stöður auk samanburð á opið til lokaða stöður Laun og fríðindi • Bera tímagjald fyrirtækis • og • salaried starfsmönnum að Skoða fjölda starfsmanna sem eru skráðir í fríðindi tiltæk • Skoða starfsmenn eftir atvinnu gerð Ráðning • Greina byggt á fjölda umsækjendur, þar sem þær verið koma úr, og hvað þær verið notar fyrir Fyrirtækis þjálfun • námskeiðsskráningu eftir staðsetningu • Couse viðveru með stöðu • Starfsmannalistann stöður skráð fyrir námskeið Starfsmanna hæfni og þróun • Lista yfir hæfni umsækjendur ráðnir starfsmenn • Sundurliðun hæfnisgerða með teymismeðlimur |
...
Eftirfarandi lönd krefjast einnig staðfærslu Smásölu. Staðfærslu smásölu fyrir þessi lönd hefur ekki verið lokið og er áætluð aðeins fyrir H1 CY2017:
<ul>
<li>Brasilía</li>
<li>Tékkland</li>
<li>Eistland</li>
...
<tr class="odd">
<td>Evrópa – Skilgreina bókargerðir virðisaukaskattsins (VSK) fyrir aðsetur aðila með skráningarramma auðkenna.</td>
<td>Hægt er að skilgreina vsk-númer fyrir aðsetur aðila með því að nota skráningarramma auðkenna og nýjan skráningarflokk <strong>VSK-númers</strong>.</td>
</tr>
<tr class="even">
...
<td>Ýmis gjöld LC banka Snið Úthlutun gjalda fyrir Sádi-Arabíu</td>
</tr>
<tr class="odd">
...
| Stofnaðu nýjar ER-skýrslur sem byggja á tiltekinni útgáfu ER-líkans.                                                                                                                                                                                                                          | Áður, þegar ný ER-snið var stofnað var aðeins hægt að nota allra nýjustu útgáfu af völdu ER-líkani sem gagnalindarstaðsetningu sniðs. Núna er hægt að velja allar tiltækar útgáfur valins ER-líkans. Þessi eiginleiki gerir kleift að vinna með ER-skýrslur núverandi árs og hanna nýja útgáfu ER-líkans fyrir næsta ár samhliða.                                                                                                                                                                                          |
...
<td>Þegar sölu- eða innkaupalína er stofnuð er hægt að leita að afurðum með því að nota afurðavíddir og öll afurðarnúmer nema altæk viðskiptanúmer (GTINs) og strikamerki. Leit að þessu er leit í öllum textanum sem kemur í stað fyrirliggjandi leitarinnar „Byrjar á“ sem er notuð í sölu- og innkaupauppflettilistanum. Þessi eiginleiki gerir kleift að finna afurðaflokka sem hafa svipaða eiginleika eða eina afurð sem hefur einkvæm einkenni. Til að kveikja á þessari aðgerð velurðu færibreytuna <strong>Kveikja á uppflettingu fyrir afurðaleit</strong> á síðunni <strong>Leitarfæribreytur</strong>.</td>
</tr>
<tr class="even">
...
<td>Þessi eiginleiki er endurbót á framleiðni. <strong>Dæmi</strong> Að selja vöru sem nefnist Polo T-shirt. Þessi afurð er til í tveimur litum: Bláum og grænum. Hún er einnig er til í tveimur stærðum: Lítið og miðstærð. Litur og Stærð eru virkar afurðarvíddir fyrir pólóskyrtuna. Þegar færð er inn sölulína fyrir pólóskyrtu sem er í grænum lit og af stærðinni Lítil þarf ekki að færa inn gögn í reitina <strong>Vörunúmer</strong>, <strong>Lit</strong> og <strong>Stærð</strong>. Hægt er að stofna línu með því að fylgja einu af eftirfarandi skrefum:
<ul>
...
### <a name="personalized-product-recommendations"></a>Leiðbeiningar sérsniðinn afurðar

| Það sem hægt er að gera                                                                                                                                                                                                                                                                        | Hvers vegna er þetta mikilvægt?                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Skoða leiðbeiningar sérsniðinn afurðar á mörgum touchpoints á sölustað (POS) til að ákvarða hvaða viðskiptavinur gæti verið áhuga á á grundvelli þeirra sögu innkaupapantanir vara á óskalista þeirra og vörur sem keyptar annarra viðskiptavina netinu og í stað og mortar verslanir | Smásala með stórum vörulista, sérsniðinn ráðleggingar hjálp viðskiptavinar með discovery afurð og virkið gerir tengir verslun með intelligent clienteling. Eftir showcasing afurðir ætlaðar áhugamál viðskiptavinarins og veitta habits afurð ráðleggingar létta smásala upsell og hægt að auka varðveisla viðskiptavinar. Í Dynamics 365 aðgerða - Smásölu, afurð ráðleggingar eru rafhlöðu cognitive services og Microsoft Azure vél nám. |
...
-   Köll Real-time Service eru ekki studd ef engin tenging er við Internetið.
...
| Lestu meira um stuðning við vörusendingar í Dynamics 365 for Operations                                                                                                         | Sjá frekari upplýsingar um stuðning fyrir ferli vörusendingar [Vörusendingar](/dynamics365/operations/scm/inventory/consignment), [Uppsetningu vörusendingar](/dynamics365/operations/scm/inventory/set-up-consignment), [vörusendingar áfyllingarpöntun (leiðarvísi fyrir Verk) Stofna](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), og [Breyta eignarhaldi á sendingar birgðir á grundvelli eftirspurn framleiðslu (leiðarvísi fyrir Verk)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Fræðast nánar um stuðning við samstarf lánardrottna í Dynamics 365 for Operations. | Nánari upplýsingar um samstarf lánardrottna er að finna á [Samvinnusvæði lánardrottins við ytri lánardrottna](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors), [Samvinnusvæði lánardrottins við viðskiptavini](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Stjórna notendum samvinnusvæðis lánardrottins](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users), [Setja upp og viðhalda samvinnusvæði lánardrottins](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration) og [Reikningsfærsluvinnusvæði lánardrottins](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
...
<tbody>
<tr class="odd">
<td>Skilgreindu beint í sölupöntunarlínum, hvaðan eftirspurnin ætti að koma og hvernig uppruni hennar á að vera. <strong>Dæmi</strong> sölupöntunarlína er Stofnuð og tilgreina beinnar afhendingar sem gerð afhendingar. Aðallánardrottni er bætt við sölupöntunarlínu sem tímapunkti uppruna.</td>
...
<tr class="even">
<td>Stofna pöntunarloforð beint úr sölupöntunarlínum. <strong>Dæmi</strong> Stofna sölupöntunarlínuna sem er sourced frá lánardrottni í samstæðu. Farðu úr línunni. Afhendingardagsetningar eru reiknaðar út eftir tiltæki í upprunafyrirtækinu.</td>
