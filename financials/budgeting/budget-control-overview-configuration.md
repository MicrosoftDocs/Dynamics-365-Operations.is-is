---
title: "Yfirlit áætlunar fjárhagsáætlunarstýringar"
description: "Þessi skrá inniheldur fjárhagsáætlunarstýringu og veitir upplýsingar um hjálp við að skilgreina fjárhagsáætlunarstýringu í Microsoft Dynamics 365 aðgerða þannig að hægt er að stjórna fjárhagslegum tilföng."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="budget-control-overview"></a>Yfirlit áætlunar fjárhagsáætlunarstýringar

Þessi skrá inniheldur fjárhagsáætlunarstýringu og veitir upplýsingar um hjálp við að skilgreina fjárhagsáætlunarstýringu í Microsoft Dynamics 365 aðgerða þannig að hægt er að stjórna fjárhagslegum tilföng.

<a name="overview"></a>Yfirlit
--------

Fjárhagsáætlunarstýringu í Microsoft Dynamics 365 aðgerða styður umsjón fyrirtækis þíns fjárhagslegar tilfanga gegnum fyrir bókhaldslykil, verkflæði, notendaflokka, upprunaskjöl og færslubækur, skilgreinanleg útreikning tiltækt fjármagn fjárhagsáætlunarferli og þröskulda fyrir. Þegar stýringar eru á sínum stað, getur fyrirtæki áætlað, mæla, stjórna og spá fyrir um hennar fjárhagslegar tilföng gegnum fjárhagsársins. 

Eftir að hafa verið samþykktar áætlanir í Dynamics 365 fyrir Aðgerðir, hægt er að nota fjárhagsáætlunargerðir til að mynda færslur í fjárhagsáætlunarskrá til að skrá útgjöld fjárhagsáætlunar fyrir fyrirtæki. Einnig er hægt að stofna eða flytja inn færslur í fjárhagsáætlunarskrá frá þriðja aðila forritið í stað með því að nota virkni fjárhagsáætlunargerðar fjárhagsáætlunar. 
...
Hægt er að skilgreina fjárhagsáætlunarstýringar samkvæmt nokkurra þátta:
...
-   **Upprunaskjöl** -Hvað þarf að meta upprunaskjöl fjárhagsáætlunarstýringar? Eiga skjöl að meta hverja línu eða fyrir hvert skjal
...
Fjárhagsáætlunarstýring er fyllilega samþætt Dynamics 365 aðgerða. Þess vegna er hægt að meta tiltæka fjárhagsáætlun fyrir bæði áætluð innkaup og raunverulega innkaup. Fyrirspurnir og skýrslur um fjárhag eru tiltækar. Því geta noendur metið Fjárhagsáætlun samhliða ferli fjárhagsáætlunar og gert leiðréttingar sem þarf, í mynd endurskoðunar fjárhagsáætlunar eða flutninga. Fjárhagsáætlunarstjóri getur einnig flytja fjárhagsáætlunar og raunupphæðir í Microsoft Excel til að greina og spá betur eftir þörfum.
...
Næsta skref í skilgreiningu er lokið á mismunandi flipum á í **skilgreiningu fjárhagsáætlunarstýringar** síðu.
...
> [!NOTE] 
> Ef útreikningur er breytt við ferli fjárhagsáætlunar, breytingarnar ekki áhrif á skjöl sem áður var send athuganir á áætlun fjárhagsáætlunarstýringar og sem voru bókaðar eða lokið.
...
> [!Important]
> Fjárhagsáætlunarstýringu verður virkur fyrir allar aðallykils sem **Rekstur**, **Kostnaðarskýrslu**, **Tekjur, efnahagsreikningur, Skuld, eigin Fjár** eða **Eign** gerð. Ef þessi flipi inniheldur reglu sem hefur autt skilyrði , verður fjárhagsáætlunarstýring virk fyrir **allar ** samsetningar fjárhagsvídda sem innihalda aðallykla þessara gerða. Þess vegna er mikilvægt að búa til reglur fjárhagsáætlunarstýringar og skilgreina svið samsetningar fjárhagsvídda þar sem mikilvægt er að kveikt er á fjárhagsáætlunarstýringu.  
...
Úr þessari síðu notendur hægt er að kafa í á **talnagögn fjárhagsáætlunarstýringar eftir tímabili** síðu til að skoða upplýsingar um framboð fjárhagsáætlunar og frátekningar fyrir víddarsamsetninguna stýringu valda áætlun. Notendur geta einnig kafa í **talnagögn fjárhagsáætlunarstýringar ** síðu til að skoða framboð á fjárhagsáætlun fyrir allar samsetningar fjárhagsvídda sem eru notaðar í fjárhagsáætlunarstýringu. 
