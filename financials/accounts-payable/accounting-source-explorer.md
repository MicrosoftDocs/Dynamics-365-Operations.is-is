...
Skoðun uppruna bókhalds er ný síða sem sýnir upplýsingar um uppruna. Hægt er að nota Bókhald explorer uppruna annaðhvort sem standa einir verkfæri eða til að greina upplýsingar aftan bókhaldsfærslur fjárhagsins. Til dæmis er hægt að nota Bókhald uppruna explorer til að fá nákvæmari upplýsingar um uppruna fyrir stöðu á stöðu Slóð eða fylgiskjal færslu. Hægt er að nota eiginleikann Flytja yfir í MS Excel til frekari skoðunar á upplýsingunum í Microsoft Excel (til dæmis í PivotTable eða PivotTable-skýrslu).
...
Fyrir öll skjöl sem er notuð í upprunaskjalsrammanum Bókhald uppruna explorer sýnir viðbótarupplýsingar, byggt á fjárhagsupphæð og, ef við á, verk dreifingu á fjárhagsupphæð. Þessar upplýsingar eru gerðar af peningaupphæð, verk, verkþátt, tegund og línueiginleika. Hér eru nokkur°dæmi um greiningu sem hægt er að gera:
