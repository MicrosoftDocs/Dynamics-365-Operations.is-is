...
Fyrirspurn um greiðslutillögu inniheldur mismunandi flipa, sem hver um sig hefur mismunandi valkosti til að velja reikninga til greiðslu. Í **Færibreyta** flipanum inniheldur valkosti sem meirihluti fyrirtækis oftast notuð. Á við **Færslur að hafa með** FastTab, er hægt að tilgreina hvaða reikninga eða lánardrottna sem taka á með til greiðslu með því að skilgreina afmarkanir fyrir mismunandi einkenni. Til dæmis, ef óskað er eftir að greiða einungis ákveðinn fjölda lánardrottna hægt er að skilgreina síu bil lánardrottins. Þessi virkni er oft notað til að velja á reikninga fyrir tiltekinn greiðslumáta. Til dæmis, ef um er að skilgreina síu þar sem **Greiðsluaðferð** = **Athuga**, aðeins þá reikninga sem hafa þann greiðslumáta eru valdar fyrir greiðslu, svo lengi sem þær einnig uppfyllir önnur skilyrði sem eru tilgreindir í fyrirspurn. **Ítarlegar færibreytur** flipi inniheldur viðbótarvalkosti,°sumir sem hugsanlega ekki eiga við fyrirtækið. Til dæmis inniheldur þessi flipi valkosti fyrir greiðslu reikninga fyrir miðstýrðar greiðslur..

## <a name="parameters"></a>Færibreytur
-   **Velja reikninga eftir** – Reikninga innan tímabilsins sem er tilgreindur með í **Frá dagsetningu** og **Dagsetningu** hægt er að velja svæði eftir gjalddaga, staðgreiðsluafsláttardagsetningu eða bæði. Ef dagsetning staðgreiðsluafsláttar er fyrst sölutilboðslínu leitar kerfið reikninga sem hafa dagsetningu staðgreiðsluafsláttar milli á til og frá dagsetningu. Kerfið þá ákveður hvort reikningurinn er hæfur°fyrir staðgreiðsluafslátt með því að nota lotudagsetninguna til að ganga úr skugga um að dagsetning staðgreiðsluafsláttar sé ekki liðin.
...
-   **Dagsetning lágmarksgreiðslu** – færið Inn dagsetning lágmarksgreiðslu.. Til dæmis í **Frá dagsetningu** og **Dagsetningu** tilgreind á bilinu 1. September til 10. September og dagsetning lágmarksgreiðslu er 5. September. Í þessu tilfelli alla reikninga með gjalddaga frá 1. September til 5. September með 5. September greiðsludagsetning. Hins vegar hafa alla reikninga með gjalddaga úr September 5 til 10. September greiðsludagsetningu sem er sú sama og gjalddagi fyrir hvern reikning.
-   **Upphæðarmörk** – færið Inn hámarksheildarupphæð fyrir allar greiðslur.
-   **Stofna greiðslur án forskoðunar á reikningi** – Ef þessi valkostur er stilltur á **Já**, verður að stofna greiðslur strax í á **lánardrottnagreiðslur** síðu. Í **greiðslutillögu** síðu verður sleppt. Þess vegna greiðslur verða stofnaðar fljótlegri hátt. Enn er hægt að breyta greiðslur frá **lánardrottnagreiðslur** síðu. Einnig er hægt að fara til baka á **greiðslutillögu** síðu með því að nota **Breyta reikningum fyrir valda greiðslu** hnappinn.

## <a name="advanced-options"></a>Ítarlegir valkostir
-   **Athuga stöðu lánardrottins** – Ef þessi valkostur er stilltur á **Já**, staðfestir kerfið að lánardrottinn er ekki með debet-staða áður en neinn reikningur er greiddur. Ef lánardrottinn hefur verið með debet-stöðu, engin greiðsla er stofnuð. Til dæmis gæti lánardrottins hafa kreditreikningar eða greiðslur sem hafa verið bókaðar en ekki enn verið jöfnuð. Í þessum tilfellum ætti ekki að greiða lánardrottni. Þess í stað ætti að jafna kreditreikningar eða greiðslur á móti útistandandi reikningum.
...
-   **Greiðslugjaldmiðill** – þeim gjaldmiðli sem allar greiðslur eru stofnaðar í Þetta svæði tilgreinir. Ef gjaldmiðill er ekki skilgreind, hvern reikning greitt í gjaldmiðli reikningsins.
...
-   **Gerð mótlykils** og **Mótlykill** -Stilla þessum svæðum til að skilgreina gerð lykils (eins og **Fjárhag** eða **Banka**) og mótlykill (til dæmis tiltekins bankareiknings). Greiðsluhátt fyrir reikninginn skilgreinir sjálfgefna gerð mótlykils og mótlykil, en hægt er að nota svæðin til að hnekkja sjálfgefnum gildum.
-   **Viðbótar síur** – á í **Færslur að hafa með** FastTab, er hægt að skilgreina afmarkanir frekari skilyrði. Til dæmis, ef óskað er eftir að greiða aðeins afmörkun lánardrottna, hægt er að skilgreina síu bil lánardrottins. Þessi virkni er oft notað til að velja á reikninga fyrir tiltekinn greiðslumáta. Til dæmis, ef um er að skilgreina síu þar sem **Greiðsluaðferð** = **Athuga**, aðeins þá reikninga sem hafa þann greiðslumáta eru valdar fyrir greiðslu, svo lengi sem þær einnig uppfyllir önnur skilyrði sem eru tilgreindir í fyrirspurn.
...
Arnie velur°**staðgreiðsluafsláttur** sem gerð reikningstillögu. Hann færir inn dagsetning afmörkun á Júní 26 til 10. Júlí. Eftirfarandi reikningar eru teknir með í tillögunni:
...
Arnie velur **Gjalddagi** sem gerð reikningstillögu. Hann færir inn dagsetning afmörkun á Júní 26 til 10. Júlí. Eftirfarandi reikningar eru teknir með í tillögunni:
...
Arnie velur **Gjalddagi og staðgreiðsluafsláttur** sem gerð reikningstillögu. Hann færir inn dagsetning afmörkun á Júní 26 til 10. Júlí. Eftirfarandi reikningar eru teknir með í tillögunni:
...
-   **Víddarstýring** svæðið er virkjað og frekari víddir eru virkjaðar. Nú skilgreinirðu hvernig víddir verða afritaðar í færslubókina. Til dæmis: • ganga Veljið sem **BusinessUnit** gátreit til að stofna greiðslutillögu á einingu viðskiptaferli fyrir greiðslu, Veljið • á **CostCenter** gátreit til að stofna greiðslutillögu sem greiðsluhátt fyrir hvern kostnaðarstað
