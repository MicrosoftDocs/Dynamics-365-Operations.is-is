...
| **Reitur**                             | **Lýsing**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Lágmarksklukkustundir fyrir dagpeninga**           | Færðu inn lágmarksfjölda stunda sem starfsmaður þarf að vinna á dag til að uppfylla skilyrði til að fá dagpeninga vegna ferðatengds kostnaðar.                                                                                      |
