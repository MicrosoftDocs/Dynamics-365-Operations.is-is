...
description: "Þessi skrá veitir upplýsingar og dæmi um reikningsfærslu innan samstæðu fyrir verk í Microsoft Dynamics 365 fyrir Aðgerðir."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Þessi skrá veitir upplýsingar og dæmi um reikningsfærslu innan samstæðu fyrir verk í Microsoft Dynamics 365 fyrir Aðgerðir.

Fyrirtæki þitt gætu haft margar deildir, dótturfyrirtæki og annarra lögaðila sem flytja afurðir og þjónustu milli sín fyrir verk. Lögaðilinn sem veitir þjónustu eða vöru kallast á *lán lögaðila*, og kallast lögaðilann sem fær þjónustu eða vöru á *lögaðili sem fær lánað*. 
...
Markmiðið er að gera kostnaðarstýringu tekjuskráning, skatta og flutningsverð samstæðu verkfærslur sveigjanlega og öflug. Þar að auki er eftirfarandi geta í boði:
...
1.  Setja upp FRSI sem viðskiptavin í USSI lögaðila, og setja upp USSI sem lánardrottinn í FRSI-lögaðila. Það eru þrír komustaðir fyrir skref sem þarf fyrir þetta verk.
    ...
    |------|-----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Lista fyrir    | Í USSI, smellið á **Viðskiptakröfur**&gt;**Viðskiptavini**&gt;**Allir viðskiptavinir**. | Búa til nýja færslu viðskiptavinar fyrir FRSI og veljið viðskiptavinaflokkur.                                                                                                                                                                                                                           |
    | B    | Í FRSI, smellið á **Viðskiptaskuldir**&gt;**Lánardrottna**&gt;**Allir lánardrottnar**.        | Búa til nýja færslu lánardrottins fyrir USSI, og veljið svo lánardrottnaflokkur                                                                                                                                                                                                                               |
...
2.  Smellið á **verkefnastjórnun Og bókhald**&gt;**Uppsetningu**&gt;**umsjón bókhalds færibreytur Verks**, og smellið á **Samstæðu** flipanum. Aðferðin sem þú notar til að setja upp færibreytur fer eftir því hvort þú ert lögaðili sem fær lánað eða lögaðili sem lánar.
...
3.  Smellið á **verkefnastjórnun Og bókhald**&gt;**Uppsetningu**&gt;**Verð**&gt;**flutningsverð**.
...
5.  Smellið á **fjárhags**&gt;**Bókunaruppsetning**&gt;**samstæðubókhald**, og setja upp vensl fyrir USSI og FRSI.
...
| Skref | Aðgangsstaður                                                                       | lýsing                                                                                                                                                                                       |
|------|-----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Lista fyrir    | **Verkefnastjórnun og bókhald**&gt;**Tímablöð**&gt;**Öll tímablöð** | Stofna nýtt vinnukort Í línu vinnukorts í á **lögaðila** svæðinu, veljið **FRSI**. Í því **Verkkenni** svæðinu, veljið verkið í FRSI . Færið inn vinnustundir fyrir hvern dag vikunnar |
...
|------|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Lista fyrir    | **Viðskiptaskuldir**&gt;**Reikninga**&gt;**Opna lánardrottnareikninga**&gt;**Nýjan reikning lánardrottins** | Stofna nýjan reikning lánardrottins og færa inn þjónustu sem voru keypt fyrir hönd verkefnis á vegum FRSI.                                                                                                                                                                                  |
...
| Skref | Aðgangsstaður                                                                                             | lýsing                                                                                                                                      |
|------|---------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| Lista fyrir    | **Verkefnastjórnun og bókhald**&gt;**Verkreikninga**&gt;**Samstæðureikning viðskiptavinar**  | Smellið á **Nýtt** til að opna í **Stofna samstæðureikning** síðu.                                                                                  |
| B    | **Verkefnastjórnun og bókhald**&gt;**Verkreikninga**&gt;**Samstæðu reikninga viðskiptavina** | Á við **Stofna samstæðureikning** síðunni skal færa inn lögaðila, tilgreina færsluna sem á að taka með og smellið síðan á **Leit**. |
| K    | **Verkefnastjórnun og bókhald**&gt;**Verkreikninga**&gt;**Samstæðu reikninga viðskiptavina** | Velja færslur til að reikningsfæra eða smellið á **Velja allt** til að reikningsfæra allar færslur í listanum og smellið síðan á **í lagi**.                  |
...
| Þrep | Aðgangsstaður                                                                                        | lýsing                                                                                                             |
|------|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| Lista fyrir    | **Viðskiptaskuldir**&gt;**Reikninga**&gt;**Biðreikninga lánardrottins**                            | Skoða reikning til að staðfesta að gildi vinnukorts eru teknar með og bóka síðan reikning lánardrottins.                  |
| B    | **Verkefnastjórnun og bókhald**&gt;**Verkreikninga**&gt;**reikningstillögur Verks** | Búa til nýja verkreikning fyrir verkið, og staðfesta að tímafærslur sem voru bókaðar birtast.            |
