...
Fylgið eftirfarandi skrefum til að undirbúa fyrir vinnslu greiðslna í einu lögaðila fyrir hönd annarra lögaðila í þínu fyrirtæki. Áður en hafist er handa þarf að ljúka eftirfarandi uppsetningu:
...
Þegar greiðsla er stofnuð fyrir einn lögaðila sem jafnar reikninga fyrir aðra lögaðila verður kenni bókunarreglu að vera hið sama fyrir báða lögaðila. Svo tryggt sé að greiðslur séu rétt stofnaðar þarf að setja upp bókunarreglu fyrir hvern reikning lögaðila sem samsvarar bókunarreglum í notkun hjá lögaðila greiðslunnar. Skiptið yfir í fyrsta lögaðili reikningsins og síðan, á við **bókunarreglur Lánardrottna** síðu er hægt að stofna nýja bókunarreglu eða breyta fyrirliggjandi bókunarreglu. Er valið fyrir bókunarregluna í reitnum lögaðili reikningsins vinnukortaheimild ekki til í samræmi við uppsetningu bókunarreglna í reitnum lögaðili greiðslunnar.
