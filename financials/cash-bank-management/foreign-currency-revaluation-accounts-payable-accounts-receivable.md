...
Nota skal **endurmat á Erlendum gjaldmiðli** síðuna undir **Reglubundin verkefni** að endurmeta opnar færslur. Hægt er að keyra ferlið í rauntíma eða raða til þess að keyra með því að nota runuvinnslu. Skilgreina stillingar fyrir endurmat ferli að vera viss um að sannreyna hvort eigi að prenta skýrslu um niðurstöður. Ekki er hægt að reprinted endurmat skýrsluna eftir ferlinu er lokið. Ef þú myndar skýrslu um endurmat á erlendum gjaldmiðli sýnir hún mismunandi stöður í stigi viðskiptavinar/lánardrottins og á stigi gjaldmiðils:
...
Skrá er haldin yfir hvert skipti sem endurmat á erlendum gjaldmiðli er keyrð. Úr færslunni á **mat á Erlendum gjaldmiðli** síðu, skal velja **Færslur** til að skoða nákvæman lista yfir færslur sem voru stofnaðar vegna endurmatsins. Hverja færslu í fylgiskjali stendur fyrir opna færslu sem var endurmetni. Ef opinni færslu var endurmetni oftar en einu sinni, sjást tvær færslur sem nota sama fylgiskjal. Ein færsla verður til bakfærslu fyrri óinnleystur hagnaður eða tap og önnur færsla verður óinnleystur hagnaður eða tap. Til að keyra endurmatsferlið , smellið á **endurmat á Erlendum gjaldmiðli** hnappinn. Skilgreina viðeigandi stillingar fyrir eftirfarandi færibreytur:
