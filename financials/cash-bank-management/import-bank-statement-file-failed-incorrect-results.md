...
# <a name="bank-statement-file-import-troubleshooting"></a>Banka uppgjör skrá inn úrræðaleit
...
Bera saman banka útlit skilgreining skrá í Microsoft Dynamics 365 fyrir innflutningsskrár Aðgerðir og athugið neinn mismunur á svæðum og einingar. Bera saman bankayfirlitsskránni að tengdum sýnishorn Dynamics 365 fyrir Aðgerðir í skrá. Skrárnar ISO20022 neinn mismunur á að vera í erfitt að sjá.
...
8.  Á valmyndinni er smellt á **XML**&gt;**Ræsa XSLT Kembingu**.
...
Stilla umbreytingu til að fá viðeigandi svæði eða einingu í bankayfirlitsskránni. Síðan varpa sem svæði eða einingu við Dynamics 365 fyrir Aðgerðir.
...
Hér að neðan eru dæmi um skilgreiningar tæknilegs útlits fyrir innflutningsskrár ítarlegrar bankaafstemmingar og þriggja tengdum skrám bankayfirlits: Hægt er að sækja dæmi skrár og tæknilegar útlit hér: https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/how-to-articles/exofbankstfotechlayouts  
