---
title: "Orðalisti fyrir kostnaðarbókhald"
...
# <a name="cost-accounting-terminology"></a>Orðalisti fyrir kostnaðarbókhald
...
Kostnaður einingar eru notaðar sem aðgerð til að rekja og flokka þar sem kostnaður streyma til. Til eru tvær gerðir kostnaðareiningar: aðalkostnaður og aukakostnaður. **Aðalkostnaður** aðal kostnaðareiningar tákna flæði kostnað úr fjárhagsbókhald í kostnaðarbókhald. Skipulag kostnað einingu samsvarar lykilskipulag rekstur í fjárhaginn, þar sem kostnaður einingu hægt samsvara aðallykil. Ekki öll aðallykla þarf sýndar sem kostnaðareiningar eftir viðskiptaþarfir. Hér eru nokkur dæmi um einingar aðalkostnaður:
...
- **Fastur kostnaður** -fastur kostnaður er kostnaður sem ekki mismunandi skammtíma, óháð því hvaða breytingar í stigi verkþáttar. Fastur kostnaður getur t.d. verið grunnur rekstrarkostnaður viðskiptatengsla, eins og leiga sem ekki fyrir áhrifum, jafnvel þótt verkþáttar hækkar eða lækkar.

- **Breytilegur kostnaður** -breytilegs kostnaðar breytist í samræmi við breytingar í stigi verkþáttar. Til dæmis kostnaðinn tiltekinni beint efni er tengt við hverja vöru sem er seld. Fleiri afurðir sem eru seld, kostnaður fleiri bein efni, eru.

- **Breytileg hálfs árs kostnaður** -hálfs árs breytileg kostnaður er kostnaður hluta föst og breytileg hluta. T.d. gjald aðgang að Internet felur í sér staðlaða mánaðarleg aðgang þóknun og broadband notkun þóknun. Stöðluð mánaðarleg aðgang gjaldið er fasts kostnaðar en þóknun broadband notkun er breytilegs kostnaðar.
