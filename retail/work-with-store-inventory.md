...
description: "Þessi skrá lýsir gerðir skjala sem hægt er að nota til að stýra birgðum."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Þessi skrá lýsir gerðir skjala sem hægt er að nota til að stýra birgðum.
...
Birgðatalningar geta verið annaðhvort áætlaðar eða óskipulagðar. Áætluð birgðatalning – Þessar birgðatalningar eru gerðar að frumkvæði aðalskrifstofunnar og það er hún sem ákveður hvaða vörur á að telja. Aðalskrifstofa útbýr talningarskjal sem hægt er að taka frá verslun þar sem magn raunkostnað hámarkslagerbirgðir sveiflast eru færðar inn í MPOS eða POS Skýinu. Óraðaðar birgðatalningu í verslun kallar og magn raunkostnað hámarkslagerbirgðir sveiflast eru uppfærðar í MPOS eða POS Skýinu. Ólíkt röðun birgðatalningar óundirbúnar birgðatalningar hefur ekki fyrirfram skilgreindum lista af vörum. Þegar birgðatalningu af annarri hvorri gerð er lokið er henni ráðstafað og send til aðalskrifstofu. Á aðalskrifstofu er talningin villuleituð og bókuð.
