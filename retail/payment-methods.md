...
description: "Hver greiðslugerð sem smásali samþykkir verður að vera skilgreind í Smásala og viðskipti í Microsoft Dynamics 365 for Operations þegar kerfið er sett upp. Þetta grein lýsir þær gerðir greiðslna sem hægt er að setja upp og lýsir ferlinu við uppsetninguna."
author: MargoC
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Hver greiðslugerð sem smásali samþykkir verður að vera skilgreind í Smásala og viðskipti í Microsoft Dynamics 365 for Operations þegar kerfið er sett upp. Þetta grein lýsir þær gerðir greiðslna sem hægt er að setja upp og lýsir ferlinu við uppsetninguna.

Smásalar geta tekið við ýmsum gerðum af greiðslu í staðinn fyrir afurðir og þjónustu sem þeir selja. Þótt reiðufé er algengasta greiðsluform smásala getur hann einnig þurft að taka við greiðslu í formi ávísana, korta, fylgiskjala og svo framvegis. Hver greiðslugerð sem smásali samþykkir verður að vera skilgreind í Dynamics 365 for Operations - Retail þegar kerfið er sett upp. Eftirfarandi listi lýsir hverja greiðslugerð sem hægt er að setja upp í Smásala og viðskipti í Dynamics 365 for Operations - Retail:
