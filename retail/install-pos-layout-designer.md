...
-   Þegar smellt er á **Hönnuður**, birtist ekki kvaðningin sækja (eða keyra) uppsetningarforrits eða gildandi öryggisstillingar leyfa þér ekki að sækja skrána. **Lausnir**
    ...
    -   Í Internet Explorer, bæta við vefslóð Dynamics 365 for Operations á lista yfir trausta vefsvæðin. Smellið á **Stillingar** &gt; **Valkostir** &gt; **Öryggi** &gt; **Traust svæði** &gt; **Svæði** &gt; **Bæta við**.
-   Forritið ræsist ekki og sagt er að hafa samband við lánardrottinn. **Laustn:** Í Internet Explorer, bæta við vefslóð Dynamics 365 for Operations á lista yfir trausta vefsvæðin. Smellið á **Stillingar** &gt; **Valkostir** &gt; **Öryggi** &gt; **Traust svæði** &gt; **Svæði** &gt; **Bæta við**.
